...
\medskip\textbf{Lentezza}\index{Incantesimi - Lentezza}\\\label{Lentezza:Lentezza}
\textbf{Scuola}: Trasmutazione\\
\textbf{Difficoltà}:  15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
...
Questo incantesimo contrasta ed e' contrastato da Lentezza\ref{Lentezza:Lentezza}{Lentezza}.\\
