...
\item 
Ogni volta che il mago acquisisce un punto in Competenza Magica sceglie due incantesimi dalla lista. Questi possono avere Difficolta' massima pari a 10+CM*2.
\item 
...
La prova si effettua con 3d6+CM+Intelligenza o Saggezza (una volta fatta la scelta lanciato il primo incantesimo non si cambia più) ed eventuali punteggi di Abilita' e dati dal Patrono.
\item 
