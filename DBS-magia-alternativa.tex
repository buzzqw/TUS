...
\item 
Ogni volta che il mago acquisisce un punto in Competenza Magica sceglie due incantesimi dalla lista. Questi possono avere Difficoltà massima pari a 12+CM.
\item
...
\item 
Un incantatore può formulare nel giorno un numero di magie pari a (CM/2)+Intelligenza o Saggezza. Questo numero viene anche chiamato slot incantesimo.
\item 
...
\subsubsection{Definizioni dei possibili obiettivi degli incantesimi}\index{Obiettivi degli incantesimi}
...
%1	\textbf{Scuola}: \textbf{Difficoltà}:  10\\
%2	\textbf{Scuola}: \textbf{Difficoltà}:  13\\
%3	\textbf{Scuola}: \textbf{Difficoltà}:  15\\
%4	\textbf{Scuola}: \textbf{Difficoltà}:  18\\
%5	\textbf{Scuola}: \textbf{Difficoltà}:  20\\
%6	\textbf{Scuola}: \textbf{Difficoltà}:  23\\
%7	\textbf{Scuola}: \textbf{Difficoltà}:  25\\
%8	\textbf{Scuola}: \textbf{Difficoltà}:  28\\
%9	\textbf{Scuola}: \textbf{Difficoltà}:  30\\
...
\textbf{Scuola}: Invocazione\\\textbf{Difficoltà}:  10\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
\textbf{Componenti}: V, S\\
\textbf{Durata}: 1 round\\
...
\textbf{Scuola}: Universale\\\textbf{Difficoltà}:  9\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
\textbf{Componenti}: V\\
