...
\textbf{Per ogni Tratto in comune con la creatura curata questa recupera in piu' il valore di modificatore di caratteristica da incantatore del mago in PF}\\
...
\begin{tabular}{ll}
	\toprule
\textbf{Connessione} & \textbf{Mod. al TS}\\
