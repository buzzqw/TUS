...
Se sei Seguace utilizzare una Energia diversa da quella del Patrono fa si che il danno si riduca di un dado oppure di 4 se il danno e' fisso o di un solo dado.
\end{itemize}
