...
Queste Caratteristiche sono Corpo \index{Corpo}, Mente \index{Mente} e Volontà \index{Volontà}.
...
Se il valore sommato di una Caratteristica è inferiore a 4 segnerà 4 nella Caratteristica. Se il valore sommato di una Caratteristica è superiore a 12 segnerà comunque 12 nella Caratteristica.

\subsubsection{I modificatori alla prove}\index{Modificatori alla prove}

Il modificatore alla prove di Competenza è pari al punteggio di Caratteristica -10, se il valore è superiore a 10.

\end{multicols}

\pagebreak

\section{Le Competenze e le Prova}\index{Competenze}\index{Prove}
...
\toprule
Acrobatica				& Incantamento				& Artigianato			\\	
Arrampicarsi			& Arcana					& Cavalcare				\\
Artista della fuga		& Conoscenza *				& Diplomazia			\\
Armi piccole 			& Intrattenere				& \textit{Consapevolezza}	\\
Armi medie 				& Ingannare					& Mani di fata\\
Armi a due mani			& Disattivare congegni		& Gestire animali\\
Intimidire		 		& Tradizioni locali			& Muoversi silenziosamente\\
Nuotare					& Natura					& Orientamento\\
Rissa					& Nascondersi				&Percepire Emozioni \\ 
Saltare 		 		& Erboristeria				& Seguire tracce\\
Usare corda				& Falsificare				& Sopravvivenza\\
						& Valutare					&\\
					 	& Pronto soccorso			&\\
\end{tabular}
