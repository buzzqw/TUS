...
L'indicazione che potete trovare nella descrizione delle creature è xPA:zm, ovvero il numero (x) di PA per percorrere (z) metri.
...
%Nome Creatura
%Tipo: Umano, Risorto, Demone, Angelo
%Mod. Corpo: 
%Mod. Mente:
%Mod. Volontà:
%Vigore: 
...
Vigore: 
Consapevolezza:
Comp Armi: Armi medie 8, Rissa 6
Comp.: Intimidire, Cavalcare, Atletica, Usare Corda, Orientamento
