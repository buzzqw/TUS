...
La \textbf{Prova d'Armi}\index{Prova d'Armi} per difendersi viene anche accorciata in PDA. Come per la altre Prove si effettua somma del valore di Competenza con il bonus di Caratteristica (solitamente Corpo) e al risultato si sottrae quello del tiro di 2d10.
