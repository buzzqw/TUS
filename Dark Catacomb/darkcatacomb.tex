...
Ogni qual volta una creatura \textbf{vuole difendersi} deve effettuare una Prova d'Arma di difesa (PDAD), ovvero somma il suo valore di Competenza d'Armi, nell'arma che sta usando per difendersi, con il modificatore di Corpo e sottrae la somma di 2d10. La differenza è il Margine di Successo (MS) ottenuto.\index{Difesa}\index{Difendersi}. Se non ha armi in mano usa il valore di Rissa.\index{Difendersi senza armi}
...
%\textit{Difficoltà}: vigore/6 + abilita' speciali, e' la difficoltà di incontro
...
\textit{Movimento}: 1PAx1.5m\\
\textit{Sensi speciali}: -\\
\textit{Linguaggi}: Lingua Franca\\
\textit{Difficoltà}: 5\\
\textit{Azioni Tipiche}: Attacco con arma\\
\textit{Attacco con arma e danno}: Spada Lunga +11, 1d8+3\\
\textit{Abilità speciali}: -\\
