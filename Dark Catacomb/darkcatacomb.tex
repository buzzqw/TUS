...
Si definisce \textbf{Margine di Successo}\index{Margine di Successo} (MS) il valore di differenza tra quanto tirato con i dadi ed il valore della Competenza.\index{Margine di Successo}\index{MS} Il Margine di Successo può essere negativo quando la prova riesce e positivo quando la prova fallisce.

La \textbf{Prova d'Armi}\index{Prova d'Armi} per difendersi viene anche accorciata in PDA.
