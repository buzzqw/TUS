...
Ogni personaggio ha 2 punti da distribuire sulle 3 caratteristiche.
...
Quando il Demiurgo stabilisce che la verifica di una situazione è necessaria, perché non è semplice ne immediata rifarla chiede di fare una Prova.
...
\toprule
Atletica				& \textbf{Armi moderne}		& Artigianato	\\	
Arrampicarsi			& Conoscenza *				& Cavalcare		\\
Artista della fuga		& Erboristeria				& Diplomazia	\\
\textbf{Armi piccole}	& Disattivare congegni		& Consapevolezza	\\
\textbf{Armi medie} 	& Falsificare				& \textbf{Armi da Tiro}\\
\textbf{Armi grandi}	& \textbf{Incantamento}		& Gestire animali\\
Intimidire		 		& Ingannare					& Furtività\\
Nuotare					& Intrattenere				& Percepire Emozioni\\
\textbf{Rissa}			& Mani di fata				& Sopravvivenza \\ 
Usare corda		 		& Pronto soccorso			& Natura\\
...
Per ogni punto di Caratteristica e punto di Competenza sommo al 1d6 iniziale quell'ammontare di dadi. Se ho Mente 1 e Erboristeria 2 eseguirò una prova tirando 4 dadi a 6, ovvero 4d6.

La difficoltà nelle prove viene indicata dal numero di dadi uguali tirati.

\begin{tabular}{ll}
	\textbf{Difficoltà} & \textbf{Numero dadi uguali}	\\
	Facile				& 1						\\
	Normale				& 2						\\
	Difficile			& 3						\\
	Molto Difficile		& 4						\\
...
%	\item [1,1,2,2,3]: conto tre dadi uguali
%	\item [1,1,2,2,2]: conto quattro dadi uguali
%	\item [1,3,2,2,2,2]: conto quattro dadi uguali
%	\item [1,1,2,2,2,2]: conto cinque dadi uguali
%	\item [1,1,2,2,3,3]: conto quattro dadi uguali
%\end{description}

%Ci sono poi delle combinazioni particolari come espresse negli esempi che permettono di contare dadi uguali in più.


\subsubsection{Bonus e Penalità}

Un Bonus sarà un valore positivo da applicare al Punteggio di Competenza.\index{Applicare il Bonus}.

Una Penalità è un valore negativo da applicare al Punteggio dei Competenza. \index{Applicare Penalità}
...
Qualora i Bonus o Penalità alla Prova superino i 3 farò la Prova non ha modificatori applicati ma si considera che abbia un successo o un insuccesso automatico prima di effettuare la prova stessa.\index{Molti modificatori}

\subsection{Prove di Caratteristica - Prove semplici}

Quando viene chiesta una Prova di Caratteristica se non viene specificato nulla allora è sufficiente tirare i 1d6 + 1d6 per punteggio di Caratteristica.
...
Tups in Armi da tiro ha 2 ed in Volontà 1, Lucia in Armi da Tiro ha 3 ed in Volontà 3. Tups è però un passo più vicino all'obbiettivo e questo gli concede 1 Bonus. Lucia invece ha accettato ti tirare le freccette con la mano opposta, e prende una Penalità di 2.

Tups tira 5d6 (1d6 + 2 (Armi da Tiro) +1 Volontà +1 Bonus) e tira 1,2,3,3,5 Lucia tira 5d6 (1d6 +3 (Armi da Tiro) +3 Volontà -2 (mano sbagliata)) e fa 1,4,6,4,1. Lucia pur avendo fatto due coppie conta come 2 soli numeri uguali, e quindi il primo turno di freccette finisce in pareggio.

\subsection{Prove senza Competenza}\index{Prove senza Competenza}

Se una Prova richiesta è relativa ad una Competenza non posseduta si effettuerà il tiro basandosi solo sul valore della caratteristica (aggiungendo il 1d6 di base) ed eventuali modificatori presenti.
...
Ogni qual volta vi effettua una Prova su una Competenza e questa mostra tutti i dadi con lo stesso valore si mette un segno vicino alla Competenza. Si possono avere fino a cinque segni vicino ad una singola Competenza.

Quando il personaggio ha tempo di riflettere su quanto accaduto, sulle prove che ha fatto e come queste sono riuscite o fallite allora quel punteggio aumenta di 1.

Una volta fatta questa tiro si cancellano i segni dalla Competenza.	
