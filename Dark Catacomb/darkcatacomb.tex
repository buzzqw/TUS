...
\textbf{Lanciare un Incantesimo1*}: a seconda del potere dell'Incantesimo sono necessari più PA. Nella descrizione dell'incantesimo è indicato il numero di PA necessari. 
...
\subsection{Sfortuna nella prova d'Armi per difenderti}

Se una dei contendenti è \textbf{sorpreso} ovvero non si aspetta l'attacco la prova di Arma sarà fatta con Svantaggio.
...
Vengono indicati solo i bonus e penalità che ha la prova d'Armi per difendersi.
