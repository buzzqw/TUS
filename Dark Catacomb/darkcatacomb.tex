...
\makeindex[columns=3, name=Spells, title=Spells List, intoc=true]
\makeindex[columns=3, name=Monsters, title=Monsters List, intoc=true]
\makeindex[columns=3, name=MagicItem, title=Magic Item List, intoc=true]
