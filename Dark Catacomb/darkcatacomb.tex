...
pdftitle={Dark Catacombs - DKC},pdfauthor={Andres Zanzani},
...
{\Huge \begin{center} Dark Catacombs\end{center}}
...
\begin{flushleft}\textbf{Condizioni d'uso}: Dark Catakombs, DKC, è un marchio registrato di Andres Zanzani (azanzani@gmail.com).
\end{flushleft}
