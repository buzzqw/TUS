...
\begin{tabular}{lXllllllll}
%\begin{tabularx}{0.95\textwidth}{lXXXXXXXXX}
	\toprule
	\textbf{Armatura} & \textbf{Costo (mo)} & \textbf{Difesa} & \textbf{Protezione* } & \textbf{Resist.*} & \textbf{Prove Agilità} & \textbf{Prove CM} & \textbf{Tipo} & \textbf{Mov.} & \textbf{Ingombro}\\
