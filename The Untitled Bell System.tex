...
\newcommand{\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit}[1]{%
	\setbox0=\hbox{#1}%
...
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{Si può scoprire di più su una persona in un'ora di gioco che in un anno di conversazione". (Platone)}}\end{tcolorbox}\medskip
...
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{Non basta avere gli occhi per vedere (anonimo)}}\medskip
...
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{Vivere non è respirare: è agire, è fare uso degli organi, dei sensi, delle facoltà, di tutte quelle parti di noi stessi per cui abbiamo il sentimento di esistere. (Jean-Jacques Rousseau)
}}\medskip
...
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{Chi non stima la vita, non la merita. (Leonardo da Vinci)
}}\medskip
...
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{Se il destino è contro di noi, peggio per lui. (motto del 1º Reggimento Carabinieri Paracadutisti "Tuscania")
}}\medskip
...
\label{tratti}
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{
...
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{c'è solo un modo per allenarsi: quello giusto. (Carl Lewis)\\\\
Wang Chi: Sei pronto?\\
...
\label{vita-e-morte}
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{Chi non conosce la morte, non conosce la vita. (Grand Hotel, film 1932)
}}\medskip
...
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{Applica sempre la giusta forza, mai troppa mai troppo poca. (Kano Jigoro)
}}\medskip
...
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{La forza non risiede in una Spada, ma nelle braccia di un valoroso. (The Legend of Zelda: Twilight Princess)
}}\medskip
...
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{\textit{Corre meno pericoli colui che, anche se è al sicuro, sta in guardia. (Publilio Siro)
}}\medskip
