...
\begin{tabularx}{1\textwidth}{lllXXXXXXX}
	\toprule
	\textbf{Armatura} & \textbf{Costo} & \textbf{Difesa} & \textbf{Protezione {*}} & \textbf{Resistenza {*}} & \textbf{Prove Agilità} & \textbf{Prove CM} & \textbf{Tipo} & \textbf{Mov.} & \textbf{Ing.}\\
