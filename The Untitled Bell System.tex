...
Le Armi hanno tutte segnato una \textbf{tipologia di danno}\index{tipologia di danno}, ovvero T/B/P.
...
\begin{tabularx}{0.95\textwidth}{lllllXXlll}
	\toprule
	\textbf{Armatura} & \textbf{Costo} & \textbf{Difesa} & \textbf{Protezione* } & \textbf{Resist.*} & \textbf{Prove Agilità} & \textbf{Prove CM} & \textbf{Tipo} & \textbf{Mov.} & \textbf{Ingombro}\\
...
\textbf{{*} Opzionale}: il Narratore può decidere di non fare tenere traccia dei danni subiti dall'armatura o quanto assorbe dei colpi.
