...
\begin{tabular}{L{3cm} L{13cm}}
\toprule
\textbf{Livello di Potere} & \textbf{Luce(P), Energia Positiva(P), Fuoco(-) Elettricità(-), Suono(-), Energia Negativa(N), Vuoto(N)}\tabularnewline
...
Elettricità & Freddo & Vuoto\tabularnewline
& Suono & \tabularnewline
\end{tabular}
\bigskip
