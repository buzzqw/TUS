...
\pagestyle{plain}
\textit{\ovalbox{"Si può scoprire di più su una persona in un'ora di gioco che in un anno di conversazione". (Platone)}}\medskip
...
\textit{\ovalbox{Non basta avere gli occhi per vedere (anonimo)}}
...
\textit{\ovalbox{Vivere non è respirare: è agire, è fare uso degli organi, dei sensi, delle facoltà, di tutte quelle parti di noi stessi per cui abbiamo il sentimento di esistere. (Jean-Jacques Rousseau)
}}\medskip
...
\textit{\ovalbox{Chi non stima la vita, non la merita. (Leonardo da Vinci)
}}\medskip
...
\textit{\ovalbox{Se il destino è contro di noi, peggio per lui. (motto del 1º Reggimento Carabinieri Paracadutisti "Tuscania")
}}\medskip
...
\textit{\ovalbox{c'è solo un modo per allenarsi: quello giusto. (Carl Lewis)\\\\
Wang Chi: Sei pronto?\\
...
\textit{\ovalbox{"Un mobile più lento non può essere raggiunto da uno più rapido; giacché quello che segue deve arrivare al punto che occupava quello che è seguito e dove questo non è più (quando il secondo arriva); in tal modo il primo conserva sempre un vantaggio sul secondo" , Paradosso di Zenone
}}\medskip
...
\label{vita-e-morte}
\textit{\ovalbox{Chi non conosce la morte, non conosce la vita. (Grand Hotel, film 1932)
}}\medskip
...
\textit{\ovalbox{Applica sempre la giusta forza, mai troppa mai troppo poca. (Kano Jigoro)
}}\medskip
...
\textit{\ovalbox{La forza non risiede in una Spada, ma nelle braccia di un valoroso. (The Legend of Zelda: Twilight Princess)
}}\medskip
...
\label{la-magia}
\textit{\ovalbox{
"Le parole sono, nella mia NON modesta opinione, la nostra massima ed inesauribile fonte di magia.\\
In grado sia di infliggere dolore che di alleviarlo" (Albus Silente)\\\\
...
\textit{\ovalbox{Corre meno pericoli colui che, anche se è al sicuro, sta in guardia. (Publilio Siro)
}}\medskip
