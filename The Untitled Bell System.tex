...
\begin{figure}[h]
	\centering
	\includegraphics[width=18cm]{Dragon_by_Henry_Justice_Ford.jpg}
\end{figure}
...
\begin{figure}[h]
	\includegraphics[decodearray={.1 .5 .5 .5 .5 .5}][width=18cm]{dungeons-and-dragons-dungeons-dragons-d-d-dice-game-d20}
\end{figure}
