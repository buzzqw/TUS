...
\textbf{Ingombrato} (entro Potenza): Hai movimento dimezzato

\medskip

\begin{tabular}{lll}
	\hline
	Ingombro &  Penalita' Movimento&  Penalita' Prova Agilita'\\
	Entro Potenza&  Movimento pieno& Nessuna penalita' \\
	Entro Potenza +5&  Movimento dimezzato & -3 \\
	Entro Potenza +10&  1 metro a round & -6 \\
\end{tabular}

\subsubsection{Valore di Ingombro}
...
Nel caso in cui l'Ingombro sia inferiore a Potenza il personaggio avra' movimento pieno.

Se e' pari a Potenza ma non superiore a Potenza +5 il movimento e' dimezzato.

Se e' superiore a Potenza +5 ed inferiore a Potenza +10, puo' spostarlo di 1 metro a round.

Se e' superiore a Potenza +10 non puoi sposare o spingere.
