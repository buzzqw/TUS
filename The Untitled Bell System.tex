...
\pagestyle{plain}
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt]\textit{Si può scoprire di più su una persona in un'ora di gioco che in un anno di conversazione. (Platone)}\end{tcolorbox}\medskip
