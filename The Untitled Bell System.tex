...
\pagestyle{plain}
\begin{quote}\textit{Si può scoprire di più su una persona in un'ora di gioco che in un anno di conversazione". (Platone)}\end{quote}
...
\begin{quote}\textit{Non basta avere gli occhi per vedere (anonimo)}\end{quote}
