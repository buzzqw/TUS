...
\begin{quote}\textit{
Occorre che la legge sia breve, perché piu' facilmente i mal pratici
la ricordino. (Seneca)}
\end{quote}
...
\\
& - Comunichi con una creatura non piu'’ di 144\\
...
Gli svantaggi si dividono in due categorie, Svantaggi di Ruolo e Svantaggi psico/fisici. Gli Svantaggi di Ruolo sono dei piccoli difetti, tic, problemi grandi e piccoli che servono a dare uno spessore piu' ``umano'' al personaggio. Hanno una descrizione volutamente ambigua e scherzosa, sceglili con attenzione e discuti con il Narratore come intendi interpretare questo svantaggio.
...
Gli svantaggi psico/fisici sono invece piu' impattanti nel gioco, nella quotidianita' dando concreti svantaggi. Questi svantaggi forniscono i punti con i quali ``pagare'' i vantaggi. In fondo trovate un elenco di Fobie
...
3.0.1 aggiunta possibilita' di cambiare una Abilita' scelta, cambiato font, specificato che la specializzazione magica si usa anche nelle prove di concentrazione
}
