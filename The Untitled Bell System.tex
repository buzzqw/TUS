...
Una creatura che ha una distanza di mischia (portata) pari o superiore ai 2 metri si considera che abbia un bonus di \textbf{+4 all'iniziativa} per il primo round, ovvero come se usasse un'arma lunga. Il round successivo la sua iniziativa in corpo a corpo non avrà questo vantaggio a meno che abbia mantenuto la distanza non facendosi raggiungere.
...
Si conta solo CA e Potenza/Agilita' e bonus dati da Abilita' ma nessun non bonus magico dell'arma per capire quanti attacchi e' possibile fare.
...
3.0.4 il minimo di punteggio preso nelle competenze al passaggio di livello passa a +1 da 0
}
