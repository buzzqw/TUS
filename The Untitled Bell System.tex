...
Esempio: un personaggio di quarto livello distribuisce le competenze attive in questa maniera:

\begin{Esempio distribuzione Punti Competenze}
...
\end{Esempio distribuzione Punti Competenze}
...
\begin{tcolorbox}[title = Prove Opposte - Sulle Caratteristiche] 
