...
Morto, ricostruito, distrutto, riassemblato, annichilito, ricomposto un innumerevole volte del suo essere originario non rimase nulla, solo lucida follia.
...
Il Patrono, forse una divita' per quel mondo, si dimostro' un avversario facile e si diverti' a scarificare il corpo di quella debole creatura.

Ormai giunto al colpo finale il Patrono aprì un portale sotto di e si lascio cadere dentro chiudendolo immediatamente.

Ta'hil comprese subito le potenzialita' del mondo come la sua magia fosse ancora piu' efficace.
Apri centinaia di portale richiamando in quel mondo ogni abominio avesse mai immaginato e.. draghi, tanti, migliaia, tutti i draghi oscuri che potesse mai immaginare.

L'invasione di Yeru era iniziata. Immediatamente Ta'hil ribadi' il suo potere e la sua leadership uccidendo in un solo giorno oltre 60 draghi, 10 per ogni colore (ross, verde, blu, bianco, nero e viola).
Tutti gli altri draghi su sottomisero al suo volere, rimanendo incatenati alla volonta' di Ta'hil.
...
La storia e' nota, come tutti i potenti fanno strinsero alleanze capendo che conveniva, almeno in quel momento, fare finta di stare insieme che combattere.

Calicante privo di un po' della follia Ta'hil, ma non tutta, amava il chaos e la distruzione che in tanti modi riusciva a portare.
...
Fino a quel momento l'unico, solo, drago dimostratosi sinceramente buono era Deynos, che per puro caso, se non errore aveva usato un portale creato da Ta'hil prima che questo si chiudesse.
...
Ta'hil è diventato un jolly, un arma di pura morte buttata nel mondo, perché alzi il livello di caos, vendetta, violenza di Yeru.
...
E' una lotta impari per i poveri yeruiti, ogni volta che con estremo sacrificio umano un drago muore altri due arrivano. La tana di Ta'hil sia è celata da Calicante e neanche Ljust è riuscita a carpire.

La speranza e' che prima o poi un leggendario gruppo di eroi possa scovare la sua tana ed uccidere il maggior nemico di Yeru.

\subsection{I Colori dei Draghi}

Ogni Drago ha sue caratteristiche tipiche e peculiari.
Tutti i draghi su Yeru obbediscono a Ta'hil, ciecamente e senza resistenza.
