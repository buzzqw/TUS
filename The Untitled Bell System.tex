...
Questo Tiro per Colpire e' contro la Difesa a Tocco se l'Essenza viene consegnata tramite Tocco (ovvero la distanza e' mischia).
Se la Distanza e' invece superiore a mischia e' necessario un TC contro la regolare Difesa dell'avversario.
...
Quando l'Area di Effetto e' ad area non e' necessario effettuare un TC se non per difficili e specificate aree.
