...
\begin{quote}\textit{C'e' solo un modo per allenarsi: quello giusto. (Carl Lewis)\linebreak\linebreak
...
\begin{longtable}{L{3cm} k{11.5cm}}
\toprule
...
\begin{tabular}{L{2.5cm} L{3.5cm} L{3cm} L{7cm}}
\toprule
...
\begin{tabular}{L{5cm} L{5cm} L{6.5cm}}
\toprule
...
\begin{longtable}{L{1cm}| L{3.5cm}|L{3.5cm}|L{4cm}|L{3.5cm}}
\toprule
...
\begin{longtable}{L{2cm}| L{1cm}|L{1cm}|L{1cm}|L{2cm}|L{1cm}|L{2.5cm}|L{1cm}|L{2cm}}
\toprule
