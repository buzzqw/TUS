...
\pagestyle{plain}
\textit{\begin{shadedbox}{Si può scoprire di più su una persona in un'ora di gioco che in un anno di conversazione". (Platone)}\end{shadedbox}}
...
\textit{\begin{shadedbox}{Non basta avere gli occhi per vedere (anonimo)}\end{shadedbox}}
...
\textit{\begin{shadedbox}{Vivere non è respirare: è agire, è fare uso degli organi, dei sensi, delle facoltà, di tutte quelle parti di noi stessi per cui abbiamo il sentimento di esistere. (Jean-Jacques Rousseau)
}\end{shadedbox}}
...
\textit{\begin{shadedbox}{Chi non stima la vita, non la merita. (Leonardo da Vinci)
}\end{shadedbox}}
...
\textit{\begin{shadedbox}{Se il destino è contro di noi, peggio per lui. (motto del 1º Reggimento Carabinieri Paracadutisti "Tuscania")
}\end{shadedbox}}
...
Est Sularus Oth Mithas. (“Il mio onore è la mia vita”, Giuramento dei Cavalieri di Solamnia.)}\end{shadedbox}}
...
Non hai veramente capito qualcosa fino a quando non sei in grado di spiegarlo a tua nonna. Albert Einstein}\end{shadedbox}}
...
\textbf{Criminalita'} (Agilità):\index{Criminalita} travestirsi, disattivare congegni, artista della fuga, mani di fata
...
\textit{\begin{shadedbox}{c'è solo un modo per allenarsi: quello giusto. (Carl Lewis)\\\\
Wang Chi: Sei pronto?\\
...
\textbf{Criminalità} (Agilità):\index{Criminalita}
...
\textit{\begin{shadedbox}{
"L'esitazione è la morte del vantaggio" (Magic, V.E. Schwab)}\end{shadedbox}}
...
\textit{\begin{shadedbox}{"Un mobile più lento non può essere raggiunto da uno più rapido; giacché quello che segue deve arrivare al punto che occupava quello che è seguito e dove questo non è più (quando il secondo arriva); in tal modo il primo conserva sempre un vantaggio sul secondo" , Paradosso di Zenone
}\end{shadedbox}}
...
\label{vita-e-morte}
\textit{\begin{shadedbox}{Chi non conosce la morte, non conosce la vita. (Grand Hotel, film 1932)
}\end{shadedbox}}
...
\textit{\begin{shadedbox}{Applica sempre la giusta forza, mai troppa mai troppo poca. (Kano Jigoro)
}\end{shadedbox}}
...
\textit{\begin{shadedbox}{La forza non risiede in una Spada, ma nelle braccia di un valoroso. (The Legend of Zelda: Twilight Princess)
}\end{shadedbox}}
...
\subsection{Essenza Movimento -- Agilità}\index{Essenza Movimento}
...
\label{svantaggi}
\textit{\begin{shadedbox}{
Se devi essere storpio, meglio essere uno storpio ricco. (Tyrion Lannister)}\end{shadedbox}}
...
Infatti, come il corpo senza lo spirito è morto, così anche la fede senza le opere è morta. (Giacomo Il Giusto 2, 26. NdA Riferendosi ai punteggi dei Tratti collegati al Patrono...)}\end{shadedbox}}
...
Le Armi hanno tutte segnato una \textbf{tipologia di danno}\index{tipologia di danno}, ovvero T/B/P. 	Queste lettere stanno ad indicare se il danno è di tipo Taglio, Botta 	o da Penetrazione. Questa caratteristica può essere importante perché 	determinate creature possono essere immuni o subire meno danno da 	un particolare tipo di ferita (es uno scheletro contro un'arma da 	punta o un cubo gelatinoso contro un arma da penetrazione..)
...
\textit{\begin{shadedbox}{Corre meno pericoli colui che, anche se è al sicuro, sta in guardia. (Publilio Siro)
}\end{shadedbox}}
...
\subsubsection{Draghi Verdi}

I Draghi verdi amano le foreste e la natura incontaminata dove si reputano i padroni e re indiscussi.

I potenti draghi verdi 

Green dragons are lawful evil, breathe acid-breath, live in temperate forests, and have a connection with both nature and the forest. Known to speak Elven and Sylvan, green dragons can often be swayed by diplomacy, anathema to many of their fellow chromatic dragons.[1]
...
Habitat
Green dragons dwell by preference in forests and woodlands, and are known to inhabit environments ranging from arctic forests to tropical jungles.[3] If possible, they make their home within natural caves (or humanoid-made burial mounds) with an easily-concealed entrance. Green dragons sculpt their lair using their acidic spittle to further excavate their homes. When such caves are unavailable, green dragons will lair atop cliffs or even high hills, some (usually younger, smaller dragons) even roost amongst the highest canopy of particularly huge trees. Over time, the dragon will sculpt lairs supported by dozens of massive trees and capable of bearing even the weight of a fully-grown dragon and their treasure hoard. Green dragons normally like to have at least one nearby tree capable of supporting their weight from which they can observe their domain.[4] Whereas most chromatic dragons destroy, green dragons actually work to improve their surroundings. They feel a desire to improve their homes somewhat akin to their innate desire to improve themselves. Over time, their natural command of plans (and using lesser beings coerced into assisting them) results in the area around their lair being more verdant, healthy, and beautiful than the surrounding forest.[5]
...
White dragons tend to overhunt their territories, and often deplete their stocks of game to below the numbers necessary to sustain the dragon. When this happens, whites typically enter extended hibernation periods as they wait for their prey to breed back into numbers.[3]
...
Arma a soffio (Sop): Soffio a cono di 12 m, 12d8 danni da acido (Gas corrosivo), Rifl CD 24 dimezza. Azione standard, può farne uso 1 volta ogni 1d4 rnd. La CD del TS è basata sulla Cos.
...
Incantesimi: Come uno Stregone di 5° livello. P.A.M. 43. Tiro salvezza CD 14 + livello dell'incantesimo. Può anche lanciare incantesimi da chierico e quelli dei domini di Inganno, Male e Terra come incantesimi arcani.

\subsubsection{Draghi Rossi}


Il Drago Rosso è conosciuto come il re dei Draghi Cromatici, e poche creature possono abbinare la sua avarizia e la sua crudeltà.
...
4	Esempi Noti
Aspetto
I Draghi Rossi sono quasi la specie più grande Drago, rivaleggiando e occasionalmente superando la dimensione gigantesca del Drago d'Oro. Alcune dozzine di Draghi Rossi, tutti i membri di un singolo clan di sangue puro, sono cresciuti oltre i più grandi Draghi d'Oro per dimensioni e forza. Ma anche un cucciolo di Drago si sviluppa da un uovo di dimensioni di un cavallo.

Il corpo lungo del Drago Rosso è coperto di scaglie spesse con il colore della roccia fusa, con corna grandi e crudeli che sovrastano la testa. Un piccolo corno spunta giusto dietro le estremità del suo muso smussato. Alcune delle sue scaglie crescono con estremità taglienti che sporgono lungo il suo viso, crescendo sempre più in giù per la schiena e persino sulle creste delle sue potenti ali, dando al Drago Rosso il suo inconfondibile aspetto puntuto.

Abilità
Tutti i Draghi Rossi possono respirare il fuoco e, mentre invecchiano, ottengono un controllo crescente sulle fiamme. Il calore che irradia da un corpo di un Drago Rosso adulto può danneggiare chiunque abbastanza stupido da stare troppo vicino. Gli incendi interni del Drago Rosso gli consentono di digerire quasi tutte le sostanze non velenose. Un Drago Rosso di età avanzata può sciogliere la pietra o trasformare istantaneamente le creature in cenere con il suo fiato ardente. La coda potente di un Drago Rosso può schiantare un muro di pietra e le sue mascelle sono abbastanza forti da divelgere delle sbarre di ferro.

Durante il combattimento fisico, il Drago Rosso usa praticamente tutto il suo corpo come arma, per mordere, artigliare, attaccare con la sua coda potente, schiacciare i nemici con le ali mostruose mentre vola, o anche volare o saltare a breve distanza per schiacciare i nemici sotto la sua immensa massa. Con il crescere dell'età, le sue scaglie crescono sempre più resistenti alle lesioni fisiche di qualsiasi tipo, anche se tutta la sua fisionomia diventa meno sensibile a tutti gli effetti magici, anche a quelli più potenti.

I Draghi Rossi iniziano ad apprendere gli Incantesimi Arcani in età precoce. Un Drago Rosso di età sufficientemente avanzata può potenzialmente diventare esperto nella Magia come tutti i più grandi Maghi Umani. Inoltre, i Draghi Rossi possiedono Abilità innate che mimano la Magia: i Draghi molto giovani possono sentire la presenza e le caratteristiche dei Dweomer magici, mentre gli adulti possono influenzare le azioni di altre creature con un semplice discorso. Tale è l'affinità del Drago Rosso con il fuoco che un vecchio Drago Rosso è addirittura in grado di prendere il controllo di un fuoco nemico di un incantatore e usarlo contro di lui.

Ecologia
I Draghi Rossi fanno le loro case all'interno di regioni montuose calde. Ogni volta che è possibile, un Drago Rosso si ripara all'interno di un vulcano attivo. Con l'età un Drago Rosso, tende a viaggiare sempre più lontano dalla sua tana in cerca di insediamenti umani da terrorizzare.

Nel 2351 CA la città di Parnthford fu completamente distrutta da uno o più Draghi Rossi in quello che si crede essere una vendetta per l'uccisione di un altro Drago


Drago Nero: vive nelle paludi e ha il respiro acido.
Drago Blu: vive tra le nubi tempestose e ha il respiro elettrico.
Drago Verde: vive nelle foreste temperate e respira veleno.
Drago Rosso: vive in montagne calde e respira fuoco.
Drago Bianco: vive in montagne fredde e respira ghiaccio.
Drago Viola: vive nelle caverne del sottosuolo e respira suono
...
3.0.2c riformattato i quotebox
...
draghi: quanti, dove, cosa fanno, perche' malvagi solo, uso portali
geografia
