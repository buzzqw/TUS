...
{\footnotesize
    ...
    3.1.0 aggiunta dell'opzione magica basata su incantesimi di DnD 5e, tolta durata concentrazione da Insibilita', dai Muri, dalle Nubi, Oscurità, passare senza traccia, paura, pelle di corteccia, resistenze, volare, invisibilta'.. e tanti altri incantesimi, aggiunta vulnerabilita' al danno, aggiunto chiarimento punti ferita temporanei, aggiunto chiarimenti per afferrato, cambiata licenza lasciato solo OGL 5.1,
}
