...
\subsubsection{Spingere un avversario*} \index{Spingere un avversario}è una prova contrapposta di Potenza (TS contrapposti).
...
\subsubsection{Afferrare un avversario*}\index{Afferrare un avversario} è una prova contrapposta di Potenza (TS). Chi ha una taglia maggiore guadagna un bonus di +2 per taglia di differenza.
