\documentclass[a4,twocolumn,openany]{dndbook}
...
\pagestyle{plain} 
\begin{commentbox}\textit{Si puo' scoprire di piu' su una persona in un'ora di gioco che in un anno di conversazione. (Platone)}
\end{commentbox}
...
\begin{commentbox}\textit{Il vero viaggio di scoperta non consiste nel trovare nuovi territori, ma nel possedere altri occhi, vedere l'universo attraverso gli occhi di un altro, di centinaia d'altri: di osservare il centinaio di universi che ciascuno di loro osserva, che ciascuno di loro e'. (Marcel Proust)}
\end{commentbox}

\begin{commentbox}\textit{Nessuna specie e' un'isola. (Mary Midgley)}
\end{commentbox}
...
\begin{commentbox}\textit{Non basta avere gli occhi per vedere (anonimo)}
\end{commentbox}
...
\begin{commentbox}\textit{Vivere non e' respirare: e' agire, e' fare uso degli organi, dei sensi, delle facolta', di tutte quelle parti di noi stessi per cui abbiamo il sentimento di esistere. (Jean-Jacques Rousseau)}
\end{commentbox}
...
\begin{commentbox}\textit{Chi non stima la vita, non la merita. (Leonardo da Vinci)}
\end{commentbox}
...
\begin{commentbox}\textit{Se il destino e' contro di noi, peggio per lui. (motto del 1º Reggimento Carabinieri Paracadutisti "Tuscania")}
\end{commentbox}
...
\label{tratti}
\begin{commentbox}\textit{
Chi dunque sa fare il bene e non lo compie, commette peccato. (Giacomo il Giusto 4.17, Lettera di Giacomo)}\end{commentbox}

\begin{commentbox}\textit{e' un diritto naturale saziarsi l'anima con la vendetta. (Attila)}\end{commentbox}

\begin{commentbox}\textit{Est Sularus Oth Mithas. (“Il mio onore e' la mia vita”, Giuramento dei Cavalieri di Solamnia.)}\end{commentbox}
...
\label{competenze}
\begin{commentbox}\textit{
``Chi dice che una cosa e' impossibile, non dovrebbe disturbare chi la sta facendo.''}\end{commentbox}
\begin{commentbox}\textit{``Non hai veramente capito qualcosa fino a quando non sei in grado di spiegarlo a tua nonna.''
\smallskip
Albert Einstein}\end{commentbox}
...
\begin{commentbox}\textit{C'e' solo un modo per allenarsi: quello giusto. (Carl Lewis)}\end{commentbox}
\begin{commentbox}\textit{
Wang Chi: Sei pronto?\\
...
\begin{commentbox}\textit{``Un mobile piu' lento non puo' essere raggiunto da uno piu' rapido; giacché quello che segue deve arrivare al punto che occupava quello che e' seguito e dove questo non e' piu' (quando il secondo arriva); in tal modo il primo conserva sempre un vantaggio sul secondo'' , Paradosso di Zenone}
\end{commentbox}
...
\label{vita-e-morte}
\begin{commentbox}\textit{Chi non conosce la morte, non conosce la vita. (Grand Hotel, film 1932)}
\end{commentbox}
...
\begin{commentbox}\textit{Applica sempre la giusta forza, mai troppa mai troppo poca. (Kano Jigoro)}
\end{commentbox}
...
\begin{commentbox}\textit{La forza non risiede in una Spada, ma nelle braccia di un valoroso. (The Legend of Zelda: Twilight Princess)}
\end{commentbox}
...
\label{svantaggi}
\begin{commentbox}\textit{
Se devi essere storpio, meglio essere uno storpio ricco. (Tyrion Lannister)}\end{commentbox}
...
\end{commentbox}
\begin{commentbox}
Tu credi che c'e' un Dio solo? Fai bene; anche i demoni lo credono e tremano! (Giacomo Il Giusto 2, 19. NdA Riferendosi al proprio Patrono...)
\end{commentbox}
...
\begin{multicols}{1} 
\begin{supertabular}{|L{3.5cm} |k{1cm} |k{1.5cm}| k{1cm} |L{4.5cm} |k{3cm}|}
...
\chapter{Equipaggiamento - Armature e Scudi}\index{Armature}\index{Scudi}
...
\chapter{Merci e Servizi}\index{Merci}\index{Servizi}
...
\begin{commentbox}\textit{Corre meno pericoli colui che, anche se e' al sicuro, sta in guardia. (Publilio Siro)}
\end{commentbox}
...
Bersaglio: bersagli multipli (quattro bersagli, possono trovarsi ad una distanza superiore ai 12m l’uno dall’altro)\\
...
\chapter{Veleni e Pozioni}\index{Veleni}\index{Pozioni}
...
%%\begin{supertabular}{cXXXXXk{4cm} |k{1cm} |k{1.5cm}| k{1.5cm} |k{5.5cm} |k{1.5cm}|}
\begin{table*}[]%
\begin{supertabular}[k{4cm} |k{1cm} |k{1.5cm}| k{1.5cm} |k{5.5cm} |k{1.5cm}|]
...
\chapter{Pozioni naturali}\index{Pozioni}
...
\begin{table*}[]%
\begin{supertabular}{|L{3.2cm} |k{0.7cm} |k{1.7cm}| D{1cm} |L{5cm} |k{1.5cm} |k{1cm}|}
