...
\begin{document}
	...
	\begin{textblock*}{19 cm}(1cm,1cm) % larghezza box, coord X, coord Y
		...
		\begin{multicols}{2}
			...
			\textbf{Invisibile}:\index{Invisibile} Le creature invisibili non sono percepibili dalla vista, ricevono bonus +1d6 al Tiro per Colpire contro avversari visibili, godono di +4 alla Difesa anche se individuati.
	...
	\begin{textblock*}{3.5cm}(5cm,1cm) % larghezza box, coord X, coord Y
		{\textbf{Punti Fato}\\
			\footnotesize 
			(20-Livello)/5}
	\end{textblock*}	
	
	\begin{textblock*}{3.5cm}(5cm,2cm) % larghezza box, coord X, coord Y
		{\textbf{Morte}\\
			\footnotesize 
			PF=-10-(COS*3)}
	\end{textblock*}	
	
	\begin{textblock*}{11.5cm}(8.5cm,1cm) % larghezza box, coord X, coord Y
		\textbf{Golen Rules}\\
	...
	\begin{textblock*}{15cm}(5cm,3cm) % larghezza box, coord X, coord Y
		\footnotesize 	
		\begin{tabular}{lll}
...
\begin{textblock*}{11cm}(5cm,7cm) % larghezza box, coord X, coord Y
...
\begin{textblock*}{6.9cm}(9.1cm,22.4cm) % larghezza box, coord X, coord Y
\textbf{Azione di Scatto}\\
x2 Movimento. -1d6 nel Tiro per Colpire, -4 Difesa, Distratto
\end{textblock*}

\begin{textblock*}{6.9cm}(9.1cm,23.9cm) % larghezza box, coord X, coord Y
