...
\textbf{Aboleth}\index{Mostri - Aboleth}\\
...
\subsubsection{Angeli}\index{Mostri - Angeli}

\medskip\textbf{Angelo Deva}\index{Mostri - Angelo Deva}\\
...
\textbf{Resistenze ai Danni} da Luce; da botta, perforante e tagliente di attacchi non magici +3\\
\textbf{Immunità alle Condizioni}: affascinato, spaventato\\
...
\medskip\textbf{Angelo Solar}\index{Mostri - Angelo Solar}\\
\emph{Grande celestiale, legale buono}\\
\textbf{Forza}: +8\\
\textbf{Destrezza}: +6\\
...
\textbf{Resistenze ai Danni} da Luce; da botta, perforante e tagliente di attacchi non magici +3\\
\textbf{Immunità ai Danni} da Vuoto, veleno\\
...
\medskip\textbf{Ankheg}\index{Mostri - Ankheg}\\
...
\medskip\textbf{Arpia}\index{Mostri - Arpia}\\
...
\medskip\textbf{Azer}\index{Mostri - Azer}\\
...
\medskip\textbf{Basilisco}\index{Mostri - Basilisco}\\
...
\medskip\textbf{Behir}\index{Mostri - Behir}\\
...
\medskip\textbf{Bugbear}\index{Mostri - Bugbear}\\
...
\medskip\textbf{Bulette}\index{Mostri - Bulette}\\
\emph{Grande mostruosità, disallineato}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}:+5\\
...
\medskip\textbf{Centauro}\index{Mostri - Centauro}\\
...
\medskip\textbf{Chimera}\index{Mostri - Chimera}\\
...
\medskip\textbf{Chuul}\index{Mostri - Chuul}\\
...
\medskip\textbf{Coboldo}\index{Mostri - Coboldo}\\
...
\medskip\textbf{Cockatrice}\index{Mostri - Cockatrice}\\
...
\medskip\textbf{Couatl}\index{Mostri - Couatl}\\
...
\medskip\textbf{Cumulo Strisciante}\index{Mostri - Cumulo Strisciante}\\
...
\subsubsection{Demoni}\index{Mostri - Demoni}

\medskip\textbf{Balor}\index{Mostri - Balor}\\
...
\textbf{Resistenze al Danno} freddo, fulmine; da botta, perforante e tagliente di attacchi non magici +3\\ 
...
\medskip\textbf{Dretch}\index{Mostri - Dretch}\\
...
\medskip\textbf{Glabrezu}\index{Mostri - Glabrezu}\\
...
\medskip\textbf{Hezrou}\index{Mostri - Hezrou}\\
\emph{Grande immondo (demone), caotico malvagio}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +4\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Marilith}\index{Mostri - Marilith}\\
\emph{Grande immondo (demone), caotico malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +5\\
\textbf{Costituzione}: +4\\
...
\textbf{Resistenze al Danno} freddo, fulmine, fuoco; da botta, perforante e tagliente di attacchi non magici +3\\
\textbf{Immunità al Danno}: veleno\\
\textbf{Immunità alle Condizioni} avvelenato\\
\textbf{Sensi}: visione del vero 36 m\\
\textbf{Linguaggi} Abissale, telepatia 36 m\\
...
\medskip\textbf{Nalfeshnee}\index{Mostri - Nalfeshnee}\\
\emph{Grande immondo (demone), caotico malvagio}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +5\\
...
\textbf{Resistenze al Danno} freddo, fulmine, fuoco; da botta, perforante e tagliente di attacchi non magici +2\\
\textbf{Immunità al Danno}: veleno\\
\textbf{Immunità alle Condizioni}: avvelenato\\
\textbf{Sensi}: Scurovisione 36 m\\
\textbf{Linguaggi} Abissale, telepatia 36 m \\
...
\medskip\textbf{Quasit}\index{Mostri - Quasit}\\
...
\medskip\textbf{Vrock}\index{Mostri - Vrock}\\
\emph{Grande immondo (demone), caotico malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Destriero da Incubo}\index{Mostri - Destriero da Incubo}\\
...
\subsubsection{Diavoli}\index{Mostri - Diavoli}

\medskip\textbf{Diavolo Barbuto}\index{Mostri - Diavolo Barbuto}\\
...
\medskip\textbf{Diavolo delle Catene}\index{Mostri - Diavolo delle Catene}\\
\emph{Media immondo (diavolo), legale malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Diavolo Cornuto}\index{Mostri - Diavolo Cornuto}\\
...
\emph{\textbf{Forcone.} Attacco con arma da mischia}: +15 al colpire, portata 3 m, un bersaglio.\\
...
\emph{\textbf{Scagliare Fiamma.} Attacco con incantesimo a Distanza}: +9 al colpire, gittata 45 m, un bersaglio.\\
...
\medskip\textbf{Diavolo della Fossa}\index{Mostri - Diavolo della Fossa}\\
\emph{Grande immondo (diavolo), legale malvagio}\\
\textbf{Forza}: +8\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +8\\
...
\textbf{Resistenze al Danno} freddo; da botta, perforante e tagliente di attacchi non magici che non siano argentati +4\\
\textbf{Immunità al Danno}: fuoco, veleno\\
\textbf{Immunità alle Condizioni} avvelenato\\
\textbf{Sensi}: visione del vero 36 m\\
\emph{\textbf{Vista del Diavolo.}} La Scurovisione penetra l'oscurità ed anche quella magica\\
...
\medskip\textbf{Diavolo del Ghiaccio}\index{Mostri - Diavolo del Ghiaccio}\\
\emph{Grande immondo (diavolo), legale malvagio}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +5\\
...
\textbf{Resistenze al Danno} da botta, perforante e tagliente di attacchi non magici che non siano argentate +2\\
...
Il muro rimane per 1 minuto o finché il diavolo non è reso inabile o muore. Il muro può essere danneggiato e bucato; ogni sezione di 3 metri ha Difesa 5, 30 punti ferita, vulnerabilità al danno da fuoco, e immunità al danno da acido, freddo, da Vuoto, psichico e da veleno. Se una sezione viene distrutta, lascia una patina di aria gelida nello spazio che occupava prima il muro. Ogni volta che una creatura finisce per muoversi attraverso quest'aria gelida durante un round, consenziente o meno, deve effettuare un tiro salvezza su Tempra DC  21, subendo 17 (5d6) danni da freddo se lo fallisce, o la metà di questi danni se lo riesce. \\
L'aria gelida si dissipa quando il resto del muro svanisce.\\


\medskip\textbf{Diavolo d'Ossa}\index{Mostri - Diavolo d'Ossa}\\
\emph{Grande immondo (diavolo), legale malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Diavolo Spinoso}\index{Mostri - Diavolo Spinoso}\\
...
\medskip\textbf{Erinni}\index{Mostri - Erinni}\\
\emph{Media immondo (diavolo), legale malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Imp}\index{Mostri - Imp}\\
...
\medskip\textbf{Lemure}\index{Mostri - Lemure}\\
\emph{Media immondo (diavolo), legale malvagio}\\
\textbf{Forza}: +0\\
\textbf{Destrezza}: -3\\
\textbf{Costituzione}: +0\\
...
\subsubsection{Dinosauri}\index{Mostri - Dinosauri}

\medskip\textbf{Plesiosauro}\index{Mostri - Plesiosauro}\\
...
\medskip\textbf{Tirannosauro}\index{Mostri - Tirannosauro}\\
...
\medskip\textbf{Triceratopo}\index{Mostri - Triceratopo}\\
\emph{Enorme bestia, disallineato}\\
\textbf{Forza}: +6\\
\textbf{Destrezza}: -1\\
\textbf{Costituzione}: +6\\
...
\medskip\textbf{Doppelganger}\index{Mostri - Doppelganger}\\
...
\subsubsection{Draghi Cromatici}\index{Mostri - Draghi Cromatici}

\medskip\textbf{Drago Bianco Antico}\index{Mostri - Drago Bianco Antico}\\
...
\medskip\textbf{Drago Bianco Adulto}\index{Mostri - Drago Bianco Adulto}\\
...
\medskip\textbf{Drago Bianco Giovane}\index{Mostri - Drago Bianco Giovane}\\
...
\medskip\textbf{Drago Bianco Cucciolo}\index{Mostri - Drago Bianco Cucciolo}\\
...
\medskip\textbf{Drago Blu Antico}\index{Mostri - Drago Blu Antico}\\
...
\medskip\textbf{Drago Blu Adulto}\index{Mostri - Drago Blu Adulto}\\
...
\medskip\textbf{Drago Blu Giovane}\index{Mostri - Drago Blu Giovane}\\
\emph{Enorme drago, legale malvagio}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Drago Blu Cucciolo}\index{Mostri - Drago Blu Cucciolo}\\
\emph{Enorme drago, legale malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Drago Nero Antico}\index{Mostri - Drago Nero Antico}\\
\emph{Mastodontica drago, caotico malvagio}\\
\textbf{Forza}: +8\\
\textbf{Destrezza}: +2\\\
\textbf{Costituzione}: +8\\
...
\medskip\textbf{Drago Nero Adulto}\index{Mostri - Drago Nero Adulto}\\
\emph{Enorme drago, caotico malvagio}\\
\textbf{Forza}: +6\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +6\\
...
\medskip\textbf{Drago Nero Giovane}\index{Mostri - Drago Nero Giovane}\\
\emph{Grande drago, caotico malvagio}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Drago Nero Cucciolo}\index{Mostri - Drago Nero Cucciolo}\\
\emph{Media drago, caotico malvagio}\\
\textbf{Forza}: +3\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +3\\
...
\medskip\textbf{Drago Rosso Antico}\index{Mostri - Drago Rosso Antico}\\
\emph{Mastodontica drago, caotico malvagio}\\
\textbf{Forza}: +10\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +10\\
...
\medskip\textbf{Drago Rosso Adulto}\index{Mostri - Drago Rosso Adulto}\\
\emph{Enorme drago, caotico malvagio}\\
\textbf{Forza}: +8\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +8\\
...
\medskip\textbf{Drago Rosso Giovane}\index{Mostri - Drago Rosso Giovane}\\
\emph{Grande drago, caotico malvagio}\\
\textbf{Forza}: +6\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +6\\
...
\medskip\textbf{Drago Rosso Cucciolo}\index{Mostri - Drago Rosso Cucciolo}\\
\emph{Media drago, caotico malvagio}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Drago Verde Antico}\index{Mostri - Drago Verde Antico}\\
\emph{Mastodontica drago, legale malvagio} \\
\textbf{Forza}: +8\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +8\\
...
\medskip\textbf{Drago Verde Adulto}\index{Mostri - Drago Verde Adulto}\\
\emph{Enorme drago, legale malvagio}\\
\textbf{Forza}: +6\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +6\\
...
\medskip\textbf{Drago Verde Cucciolo}\index{Mostri - rago Verde Cucciolo}\\
...
\subsubsection{Draghi Metallici}\index{Mostri - Draghi Metallici}

\medskip\textbf{Drago d'Argento Antico}\index{Mostri - Drago d'Argento Antico}\\
...
\medskip\textbf{Drago d'Argento Adulto}\index{Mostri - Drago d'Argento Adulto}\\
...
\medskip\textbf{Drago d'Argento Giovane}\index{Mostri - Drago d'Argento Giovane}\\
...
\medskip\textbf{Drago d'Argento Cucciolo}\index{Mostri - Drago d'Argento Cucciolo}\\
...
\medskip\textbf{Drago di Bronzo Antico}\index{Mostri - Drago di Bronzo Antico}\\
...
\medskip\textbf{Drago di Bronzo Adulto}\index{Mostri - Drago di Bronzo Adulto}\\
...
\medskip\textbf{Drago di Bronzo Giovane}\index{Mostri - Drago di Bronzo Giovane}\\
...
\medskip\textbf{Drago di Bronzo Cucciolo}\index{Mostri - Drago di Bronzo Cucciolo}\\
...
\medskip\textbf{Drago d'Oro Antico}\index{Mostri - Drago d'Oro Antico}\\
\emph{Mastodontica drago, legale buono}\\
\textbf{Forza}: +10\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +10\\
...
\medskip\textbf{Drago d'Oro Adulto}\index{Mostri - Drago d'Oro Adulto}\\
\emph{Enorme drago, legale buono}\\
\textbf{Forza}: +8\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +8\\
...
\medskip\textbf{Drago d'Oro Giovane}\index{Mostri - Drago d'Oro Giovane}\\
\emph{Grande drago, legale buono}\\
\textbf{Forza}: +6\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +6\\
...
\medskip\textbf{Drago d'Oro Cucciolo}\index{Mostri - Drago d'Oro Cucciolo}\\
\emph{Media drago, legale buono}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Drago d'Ottone Antico}\index{Mostri - Drago d'Ottone Antico}\\
\emph{Mastodontica drago, caotico buono}\\
\textbf{Forza}: +8\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +8\\
...
\medskip\textbf{Drago d'Ottone Adulto}\index{Mostri - Drago d'Ottone Adulto}\\
\emph{Enorme drago, caotico buono}\\
\textbf{Forza}: +6\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +6\\
...
\medskip\textbf{Drago d'Ottone Giovane}\index{Mostri - Drago d'Ottone Giovane}\\
\emph{Grande drago, caotico buono}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Drago d'Ottone Cucciolo}\index{Mostri - Drago d'Ottone Cucciolo}
\emph{Media drago, caotico buono}\\
\textbf{Forza}: +3\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +3\\
...
\medskip\textbf{Drago di Rame Antico}\index{Mostri - Drago di Rame Antico}\\
\emph{Mastodontica drago, caotico buono}\\\
\textbf{Forza}: +8\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +8\\
...
\medskip\textbf{Drago di Rame Adulto}\index{Mostri - Drago di Rame Adulto}\\
\emph{Enorme drago, caotico buono}\\
\textbf{Forza}: +6\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +6\\
...
\medskip\textbf{Drago di Rame Giovane}\index{Mostri - Drago di Rame Giovane}\\
\emph{Grande drago, caotico buono}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Drago di Rame Cucciolo}\index{Mostri - Drago di Rame Cucciolo}\\
\emph{Media drago, caotico buono}\\
\textbf{Forza}: +3\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +3\\
...
\medskip\textbf{Drider}\index{Mostri - Drider}\\
\emph{Grande mostruosità, caotico malvagio}\\
\textbf{Forza}: +3\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +3\\
...
\medskip\textbf{Driade}\index{Mostri - Driade}\\
...
\medskip\textbf{Duergar}\index{Mostri - Duergar}\\
...
\subsubsection{Elementali}\index{Mostri - Elementali}

\medskip\textbf{Elementale dell'Acqua}\index{Mostri - Elementale dell'Acqua}\\
...
\medskip\textbf{Elementale dell'Aria}\index{Mostri - Elementale dell'Aria}\\
\emph{Grande elementale, neutrale}\\
\textbf{Forza}: +2\\
\textbf{Destrezza}: +5\\
\textbf{Costituzione}: +2\\
...
\medskip\textbf{Elementale del Fuoco}\index{Mostri - Elementale del Fuoco}\\
\emph{Grande elementale, neutrale}\\
\textbf{Forza}: +0\\
\textbf{Destrezza}: +4\\
\textbf{Costituzione}: +0\\
...
\emph{\textbf{Illuminazione.}} L'elementale emette luce in un raggio di 9 metri e luce fioca per ulteriori 9 metri.\\
\emph{\textbf{Natura Elementale.}} Un elementale non ha bisogno di aria, cibo, bevande o sonno.\\
...
\medskip\textbf{Elementale della Terra}\index{Mostri - Elementale della Terra}\\
\emph{Grande elementale, neutrale}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: -1\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Elfo, Drow}\index{Mostri - Elfo, Drow}\\
...
\medskip\textbf{Ettercap}\index{Mostri - Ettercap}\\
...
\medskip\textbf{Ettin}\index{Mostri - Ettin}\\
...
\medskip\textbf{Fantasma}\index{Mostri - Fantasma}\\
...
\medskip\textbf{Fauci Gorgoglianti}\index{Mostri - Fauci Gorgoglianti}\\
...
\subsubsection{Funghi}\index{Mostri - Funghi}

\medskip\textbf{Fungo Stridente}\index{Mostri - Fungo Stridente}\\
...
\textbf{Punti Ferita}: 13 (3d8)\\
\textbf{Movimento}: 0 m\\
\textbf{Tiri Salvezza}: Fort -3, Ref +3, Will -4\\
...
\medskip\textbf{Fungo Violetto}\index{Mostri - Fungo Violetto}\\
\emph{Media pianta, disallineato}\\
\textbf{Forza}: -4\\
\textbf{Destrezza}: -4\\
\textbf{Costituzione}: -1\\
...
\medskip\textbf{Fuoco Fatuo}\index{Mostri - Fuoco Fatuo}\\
...
\textbf{Resistenze al Danno} acido, freddo, fuoco, da Vuoto, suono; contendente, perforante e tagliente di attacchi non magici\\
...
\emph{\textbf{Illuminazione Variabile.}} Il fuoco fatuo promana luce in un raggio da 1,5 a 6 metri e luce fioca per un numero di metri aggiuntivi pari al raggio scelto. Il fuoco fatuo può modificare questo raggio con un'azione immediata.\\
...
\medskip\textbf{Fustigatore}\index{Mostri - Fustigatore}\\
...
\medskip\textbf{Gargoyle}\index{Mostri - Gargoyle}\\
...
\subsubsection{Geni}\index{Mostri - Geni}

\medskip\textbf{Djinni}\index{Mostri - Djinni}\\
...
\medskip\textbf{Efreeti}\index{Mostri - Efreeti}\\
...
\medskip\textbf{Ghast}\index{Mostri - Ghast}\\
...
\medskip\textbf{Ghoul}\index{Mostri - Ghoul}\\
\emph{Media non morto, caotico malvagio}\\
\textbf{Forza}: +2\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +2\\
...
\subsubsection{Giganti}\index{Mostri - Giganti}

\medskip\textbf{Gigante di Collina}\index{Mostri - Gigante di Collina}\\
...
\medskip\textbf{Gigante del Fuoco}\index{Mostri - Gigante del Fuoco}\\
...
\medskip\textbf{Gigante del Gelo}\index{Mostri - Gigante del Gelo}\\
...
\medskip\textbf{Gigante delle Nuvole}\index{Mostri - Gigante delle Nuvole}\\
...
\medskip\textbf{Gigante di Pietra}\index{Mostri - Gigante di Pietra}\\
...
\medskip\textbf{Gigante delle Tempeste}\index{Mostri - Gigante delle Tempeste}\\
...
\medskip\textbf{Gnoll}\index{Mostri - Gnoll}\\
...
\medskip\textbf{Gnomo delle Profondità (Svirfneblin)}\index{Mostri - Gnomo delle Profondità} \index{Mostri - Svirfneblin}\\
...
\subsubsection{Golem}\index{Mostri - Golem}

\medskip\textbf{Golem di Argilla}\index{Mostri - Golem di Argilla}\\
...
\medskip\textbf{Golem di Carne}\index{Mostri - Golem di Carne}\\
...
\medskip\textbf{Golem di Ferro}\index{Mostri - Golem di Ferro}\\
\emph{Grande costrutto, disallineato}\\
\textbf{Forza}: +7\\
\textbf{Destrezza}: -1\\
\textbf{Costituzione}: +7\\
...
\textbf{Movimento}: 9 m\\
\textbf{Tiri Salvezza}: Tempra +6, Riflessi +5, Volontà +6\\
\textbf{Immunità al Danno}: fuoco, psichico, veleno; da botta, perforante e tagliente di attacchi non magici +2, che non siano di adamantio\\
\textbf{Immunità alle Condizioni}: affascinato, avvelenato, paralizzato, pietrificato, spaventato\\
\textbf{Sensi}: Scurovisione 36 m\\
\textbf{Linguaggi} comprende le lingue del suo creatore ma non può parlare\\
\textbf{Sfida}: 16 (15.000 PE)\smallskip\\
...
\medskip\textbf{Golem di Pietra}\index{Mostri - Golem di Pietra}\\
\emph{Grande costrutto, disallineato}\\
\textbf{Forza}: +6 \\
\textbf{Destrezza}: -1\\
\textbf{Costituzione}: +6\\
...
\medskip\textbf{Gorgone}\index{Mostri - Gorgone}\\
\emph{Grande mostruosità, disallineato}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Grick}\index{Mostri - Grick}\\
...
\medskip\textbf{Grifone}\index{Mostri - Grifone}\\
\emph{Grande mostruosità, disallineato}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Grimlock}\index{Mostri - Grimlock}\\
...
\medskip\textbf{Guardiano Protettore}\index{Mostri - Guardiano Protettore}\\
\emph{Grande costrutto, disallineato}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: -1\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Hobgoblin}\index{Mostri - Hobgoblin}\\
...
\medskip\textbf{Idra}\index{Mostri - Idra}\\
...
\medskip\textbf{Ippogrifo}\index{Mostri - Ippogrifo}\\
\emph{Grande mostruosità, disallineato}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Kraken}\index{Mostri - Kraken}\\
...
\textbf{Immunità al Danno}: fulmine; da botta, perforante e tagliente di attacchi non magici +2\\
...
\medskip\textbf{Lamia}\index{Mostri - Lamia}\\
\emph{Grande mostruosità, caotico malvagio}\\
\textbf{Forza}: +3\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +3\\
...
\medskip\textbf{Lich}\index{Mostri - Lich}\\
...
\textbf{Immunità al Danno}: veleno; da botta, perforante e tagliente di attacchi non magici +3\\
\textbf{Immunità alle Condizioni}: affascinato, avvelenato, paralizzato, spaventato\\
\textbf{Sensi}: visione del vero 36 m\\
\textbf{Linguaggi} Comune più altre cinque lingue\\
\textbf{Sfida}: 21 (33.000 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} Il lich è un incantatore con CM 18 livello. La sua caratteristica da incantatore è l'Intelligenza. Il lich ha preparati i seguenti incantesimi:\\
...
\medskip\textbf{Lucertoloide}\index{Mostri - Lucertoloide}\\
...
\subsubsection{Mannari}\index{Mostri - Mannari}

\medskip\textbf{Cinghiale Mannaro}\index{Mostri - Cinghiale Mannaro}\\
...
\medskip\textbf{Lupo Mannaro}\index{Mostri - Lupo Mannaro}\\
...
\medskip\textbf{Orso Mannaro}\index{Mostri - Orso Mannaro}\\
...
\medskip\textbf{Ratto Mannaro}\index{Mostri - Ratto Mannaro}\\
...
\medskip\textbf{Tigre Mannara}\index{Mostri - Tigre Mannara}\\
...
\medskip\textbf{Manticora}\index{Mostri - Manticora}\\
...
\medskip\textbf{Manto Assassino}\index{Mostri - Manto Assassino}\\
...
\medskip\textbf{Mantoscuro}\index{Mostri - Mantoscuro}\\
\emph{Piccola mostruosità, disallineato}\\
\textbf{Forza}: +3\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +3\\
...
\medskip\textbf{Medusa}\index{Mostri - Medusa}\\
...
\subsubsection{Mefiti}\index{Mostri - Mefiti}

\medskip\textbf{Mefito di Ghiaccio}\index{Mostri - Mefito di Ghiaccio}\\
...
\medskip\textbf{Mefito di Magma}\index{Mostri - Mefito di Magma}\\
\emph{Piccola elementale, malvagio}\\
\textbf{Forza}: -1\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: -1\\
...
\medskip\textbf{Mefito di Polvere}\index{Mostri - Mefito di Polvere}\\
\emph{Piccola elementale, malvagio}\\
\textbf{Forza}: -3\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: -1\\
...
\medskip\textbf{Mefito di Vapore}\index{Mostri - Mefito di Vapore}\\
\emph{Piccola elementale, malvagio}\\
\textbf{Forza}: -3\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: -1\\
...
\subsubsection{Megere}\index{Mostri - Megere}

\medskip\textbf{Megera Marina}\index{Mostri - Megera Marina}\\
...
\medskip\textbf{Megera Notturna}\index{Mostri - Megera Notturna}\\
...
\medskip\textbf{Megera Verde}\index{Mostri - Megera Verde}\\
...
\subsubsection{Melme}\index{Mostri - Melme}

\medskip\textbf{Ameba Paglierina}\index{Mostri - Ameba Paglierina}\\
...
\medskip\textbf{Cubo Gelatinoso}\index{Mostri - Cubo Gelatinoso}\\
\emph{Grande melma, disallineato}\\
\textbf{Forza}: +2\\
\textbf{Destrezza}: -4\\
\textbf{Costituzione}: +2\\
...
\medskip\textbf{Melma Grigia}\index{Mostri - Melma Grigia}\\
...
\medskip\textbf{Protoplasma Nero}\index{Mostri - Protoplasma Nero}\\
\emph{Grande melma, disallineato}\\
\textbf{Forza}: +3\\
\textbf{Destrezza}: -3\\
\textbf{Costituzione}: +3\\
...
\medskip\textbf{Mimic}\index{Mostri - Mimic}\\
\emph{Media mostruosità (mutaforma), neutrale}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Minotauro}\index{Mostri - Minotauro}\\
\emph{Grande mostruosità, caotico malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Mummia}\index{Mostri - Mummia}\\
...
\medskip\textbf{Mummia Sovrana}\index{Mostri - Mummia Sovrana}\\
\emph{Media non morto, legale malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +4\\
...
\textbf{Vulnerabilità al Danno} fuoco\\
\textbf{Immunità al Danno}: da Vuoto, veleno; da botta, perforante e tagliente di attacchi non magici +2\\
\textbf{Immunità alle Condizioni}: affascinato, avvelenato, paralizzato, spaventato\\
\textbf{Sensi}: Scurovisione 18 m\\
\textbf{Linguaggi} le lingue che conosceva in vita\\
\textbf{Sfida}: 15 (13.000 PE)\smallskip\\
...
La mummia ha preparati i seguenti incantesimi:\\
...
\subsubsection{Naga}\index{Mostri - Naga}

\medskip\textbf{Naga Guardiano}\index{Mostri - Naga Guardiano}\\
...
\textbf{Sfida}: 10 (5.900 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} Il naga è un incantatore con CM 11. La sua caratteristica da incantatore è la Volontà e ha bisogno solo delle componenti verbali per lanciare i suoi incantesimi. Il naga prepara i seguenti incantesimi :\\
...
\medskip\textbf{Naga Spirituale}\index{Mostri - Naga Spirituale}\\
\emph{Grande mostruosità, caotico malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +4\\
\textbf{Costituzione}: +4\\
...
\textbf{Linguaggi} Abissale, Comune\\
\textbf{Sfida}: 8 (3.900 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} Il naga è un incantatore con CM 10. La sua abilità da incantatore è l'Intelligenza (DC dei Tiri Salvezza degli incantesimi 14, +8 al colpire con attacchi con incantesimo), e ha bisogno solo delle componenti verbali per eseguire i suoi incantesimi. Il naga prepara i seguenti incantesimi : \\
Trucchetti (a volontà): \emph{illusione minore, mano magica, raggio di} \emph{gelo}\\
Difficoltà 10 (4 slot): \emph{charme su persone, individuazione del magico,} \emph{sonno}\\
...
\subsubsection{Oggetti Animati}\index{Mostri - Oggetti Animati}

\medskip\textbf{Armatura Animata}\index{Mostri - Armatura Animata}\\
...
\medskip\textbf{Spada Volante}\index{Mostri - Spada Volante}\\
...
\medskip\textbf{Tappeto del Soffocamento}\index{Mostri - Tappeto del Soffocamento}\\
\emph{Grande costrutto, disallineato}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Ogre}\index{Mostri - Ogre}\\
\emph{Grande gigante, caotico malvagio}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: -1\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Ombra}\index{Mostri - Ombra}\\
\emph{Media non morto, caotico malvagio}\\
\textbf{Forza}: -2\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: 0\\
...
\textbf{Competenze}: Criminalità +4 (+6 in luce fioca o oscurità)\\
...
\emph{\textbf{Furtività d'Ombra.}} Quando si trova in luce fioca o all'oscurità, l'ombra può effettuare l'azione Nascondersi come azione immediata.\\
...
\medskip\textbf{Omuncolo}\index{Mostri - Omuncolo}\\
...
\medskip\textbf{Oni}\index{Mostri - Oni}\\
...
\medskip\textbf{Orco}\index{Mostri - Orco}\\
...
\medskip\textbf{Orsogufo}\index{Mostri - Orsogufo}\\
\emph{Grande mostruosità, disallineato}\\
\textbf{Forza}: +5\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +5\\
...
\medskip\textbf{Otyugh}\index{Mostri - Otyugh}\\
...
\medskip\textbf{Pegaso}\index{Mostri - Pegaso}\\
...
\medskip\textbf{Persecutore Invisibile}\index{Mostri - Persecutore Invisibile}\\
...
\medskip\textbf{Pseudodrago}\index{Mostri - Pseudodrago}\\
...
\medskip\textbf{Rakshasa}\index{Mostri - Rakshasa}\\
...
\textbf{Immunità al Danno}: da botta, perforante e tagliente di attacchi non magici +2\\
\textbf{Sensi}: Scurovisione 18 m\\
...
\medskip\textbf{Remorhaz}\index{Mostri - Remorhaz}\\
\emph{Enorme mostruosità, disallineato}\\
\textbf{Forza}: +7\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +7\\
...
\medskip\textbf{Rugginofago}\index{Mostri - Rugginofago}\\
\emph{Media Mostruosità, disallineato}\\
\textbf{Forza}: +2\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +2\\
...
\medskip\textbf{Sahuagin}\index{Mostri - Sahuagin}\\
...
\medskip\textbf{Salamandra}\index{Mostri - Salamandra}\\
...
\medskip\textbf{Satiro}\index{Mostri - Satiro}\\
...
\medskip\textbf{Scheletro}\index{Mostri - Scheletro}\\
\emph{Media non morto, legale malvagio}\\
\textbf{Forza}: +0\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +0\\
...
\medskip\textbf{Scheletro di Cavallo da Guerra}\index{Mostri - Scheletro di Cavallo da Guerra}\\
...
\medskip\textbf{Scheletro di Minotauro}\index{Mostri - Scheletro di Minotauro}\\
\emph{Grande non morto, legale malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Segugio Infernale}\index{Mostri - Segugio Infernale}\\
\emph{Media immondo, legale malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +4\\
...
\subsubsection{Sfingi}\index{Mostri - Sfingi}

\medskip\textbf{Androsfinge}\index{Mostri - Androsfinge}\\
...
\textbf{Immunità al Danno}: psichico; da botta, perforante e tagliente di attacchi non magici +3\\
\textbf{Immunità alle Condizioni}: affascinato, spaventato\\
\textbf{Sensi} visione del vero 36 m\\
...
\emph{\textbf{Incantesimi.}} La sfinge ha CM 12. La sua caratteristica da incantatore è la Volontà. Non ha bisogno di componenti materiali per lanciare i suoi incantesimi. La sfinge tiene preparati i seguenti incantesimi:\\
...
\medskip\textbf{Ginosfinge}\index{Mostri - Ginosfinge}\\
\emph{Grande mostruosità, legale neutrale}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Spiritello}\index{Mostri - Spiritello}\\
...
\medskip\textbf{Strige (Uccello Stigeo)}\index{Mostri - Strige (Uccello Stigeo)}\\
...
\medskip\textbf{Succube}\index{Mostri - Succube}\\
...
\medskip\textbf{Tarrasque}\index{Mostri - Tarrasque}\\
...
\medskip\textbf{Testuggine Dragona}\index{Mostri - Testuggine Dragona}\\
...
\medskip\textbf{Troll}\index{Mostri - Troll}\\
\emph{Grande gigante, caotico malvagio}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Uomo Acquatico}\index{Mostri - Uomo Acquatico}\\
...
\medskip\textbf{Uomo Albero (Treant)}\index{Mostri - Treant}\\
...
\medskip\textbf{Uomo Magma (Magmin)}\index{Mostri - Magmin}\\
...
\textbf{Linguaggi} Ignan\\
\textbf{Sfida}: 1/2 (100 PE)\smallskip\\
\emph{\textbf{Illuminazione Incendiaria.}} Come azione immediata, l'uomo magma può accendere o spegnere le sue fiamme. Mentre la fiamma è accesa, l'uomo magma irradia luce intensa in un raggio di 3 metri e luce fioca per ulteriori 3 metri.\\
...
\medskip\textbf{Unicorno}\index{Mostri - Unicorno}\\
\emph{Grande celestiale, legale buono}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +4\\
...
\subsubsection{Vampiri}\index{Mostri - Vampiri}

\medskip\textbf{Vampiro}\index{Mostri - Vampiro}\\
...
\textbf{Immunità al Danno}: da Vuoto; da botta, perforante e tagliente di attacchi non magici +2\\
\textbf{Sensi}: Scurovisione 36 m\\
\textbf{Linguaggi} le lingue che conosceva in vita\\
\textbf{Sfida}: 13 (10.000 PE)\smallskip\\
...
\emph{Colpisce:} 7 (1d6 + 4) danni perforanti più 10 (3d6) danni necrotici. I punti ferita massimi del bersaglio sono ridotti di un ammontare pari al danno da Vuoto subito, e il vampiro recupera un numero di punti ferita pari a quell'ammontare. Questa riduzione permane finché il bersaglio non termina 8 ore di riposo. Il bersaglio muore se questo effetto riduce i suoi punti ferita massimi a 0. Un umanoide ucciso in questo modo e poi sepolto nel terreno si rianima la notte seguente come progenie vampirica sotto il controllo del vampiro. \\
...
\medskip\textbf{Progenie Vampirica}\index{Mostri - Progenie Vampirica}\\
...
\emph{Colpisce:} 6 (1d6 + 3) danni perforanti più 7 (2d6) danni necrotici. I punti ferita massimi del bersaglio sono ridotti di un ammontare pari al danno da Vuoto subito, e il vampiro recupera unnumero di punti ferita pari a quell'ammontare. Questa riduzione permane  finché il bersaglio non termina 8 ore di riposo. Il bersaglio muore se  questo effetto riduce i suoi punti ferita massimi a 0.\\
\textbf{Ecologia}\\
Ambiente: Qualsiasi\\
...
\medskip\textbf{Verme Purpureo}\index{Mostri - Verme Purpureo}\\
...
\emph{\textbf{Pungiglione.} Attacco con arma da mischia}: +12 al colpire, portata 3 m, una creatura.\\

\emph{Colpisce:} 19 (3d6 + 9) danni perforanti, e il bersaglio deve effettuare un tiro salvezza su Tempra DC  24, subendo 42 (12d6) danni da veleno se fallisce il tiro salvezza, o la metà di questi danni se lo riesce.\\
\textbf{Ecologia}\\
Ambiente: Qualsiasi sotterraneo\\
Organizzazione: Solitario\\
Tesoro: Accidentale\\
...
\medskip\textbf{Viverna}\index{Mostri - Viverna}\\
...
\medskip\textbf{Wight}\index{Mostri - Wight}\\
\emph{Media non morto, malvagio}\\
\textbf{Forza}: +3\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +3\\
...
\textbf{Tiri Salvezza}: Tempra +3, Riflessi +2, Volontà +5\\
\textbf{Competenze}: Criminalità +4, Consapevolezza +3\\
\textbf{Resistenze al Danno} da Vuoto; da botta, perforante e tagliente di attacchi non magici che non siano argentati \\
\textbf{Immunità al Danno}: veleno\\
\textbf{Immunità alle Condizioni}: avvelenato, esausto\\
\textbf{Sensi}: Scurovisione 18 m\\
\textbf{Linguaggi} le lingue che conosceva in vita\\
...
\medskip\textbf{Wraith}\index{Mostri - Wraith}\\
\emph{Media non morto, malvagio}\\
\textbf{Forza}: -2\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +3\\
...
\medskip\textbf{Xorn}\index{Mostri - Xorn}\\
\emph{Media elementale, neutrale}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Zombi}\index{Mostri - Zombi}\\
\emph{Media non morto, malvagio}\\
\textbf{Forza}: +2\\
\textbf{Destrezza}: -2\\
\textbf{Costituzione}: +2\\
...
\medskip\textbf{Zombi Ogre}\index{Mostri - Zombi Ogre}\\
...
\subsubsection{Addendum: Creature Varie}\index{Mostri - Creature Varie}
...
\medskip\textbf{Centopiedi Gigante}\index{Mostri - Centopiedi Gigante}\\
\emph{Piccola bestia, disallineato}\\
\textbf{Forza}: -3\\
\textbf{Destrezza}: +2\\
\textbf{Costituzione}: +0\\
...
\medskip\textbf{Piranha}\index{Mostri - Piranha}\\
...
\medskip\textbf{Lupo gigante}\index{Mostri - Lupo gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Piovra Gigante}\index{Mostri - Piovra Gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Forza}: +4\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +4\\
...
\medskip\textbf{Pipistrello}\index{Mostri - Pipistrello}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Forza}: -4\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: -1\\
...
\medskip\textbf{Pipistrello Gigante}\index{Mostri - Pipistrello Gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Forza}: +3\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +3\\
...
\subsubsection{Sciami}\index{Mostri - Sciami}
...
\medskip\textbf{Sciame di Centopiedi}\index{Mostri - Sciame di Centopiedi}\\
...
\medskip\textbf{Sciame di Scarabei}\index{Mostri - Sciame di Scarabei}\\
\emph{Medio sciame di Minuscole bestie, disallineato}\\
\textbf{Forza}: -4\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: -3\\
...
\medskip\textbf{Sciame di Serpenti Velenosi}\index{Mostri - Sciame di Serpenti Velenosi}\\
\emph{Medio sciame di Minuscole bestie, disallineato}\\
\textbf{Forza}: -1\\
\textbf{Destrezza}: +4\\
\textbf{Costituzione}: +0\\
...
\medskip\textbf{Sciame di Vespe}\index{Mostri - Sciame di Vespe}\\
\emph{Medio sciame di Minuscole bestie, disallineato}\\
\textbf{Forza}: -4\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: -3\\
...
\subsubsection{Addendum: Personaggi Non Giocanti}\index{Mostri - Personaggi Non Giocanti}
...
\subsubsection{Veterano}\index{Mostri - Veterano}
...
\subsubsection*{Cavaliere}\index{Mostri - Cavaliere}
...
\subsubsection{Gladiatore}\index{Mostri - Gladiatore}
...
\subsubsection{Nobile}\index{Mostri - Nobile}
...
\subsubsection{Popolano}\index{Mostri - Popolano}
...
\subsubsection{Criminali}\index{Mostri - Criminali}
...
\subsubsection{Bandito/Pirata}\index{Mostri - Bandito}\index{Mostri - Pirata}
...
\subsubsection{Spia}\index{Mostri - Spia}
...
\subsubsection{Capitano dei Banditi/Pirata}\index{Mostri - Capitano Pirata}\index{Mostri - Capitano dei Banditi}
...
\subsubsection{Assassino}\index{Mostri - Assassino}
...
\subsubsection{Mago}\index{Mostri - Mago}\index{Mostri - Incantatore}
...
\textbf{Sfida}: 1 (200 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} Il mago ha CM 4. La sua abilità da incantatore è l'Intelligenza (DC dei Tiri Salvezza degli incantesimi 13, +5 al colpire con attacchi con incantesimo). Il mago ha preparato i seguenti incantesimi: \\
...
\textbf{Lingue}: quattro lingue qualsiasi\\
\textbf{Sfida}: 6 (2.300 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} Il mago ha CM 9. La sua abilità da incantatore è l'Intelligenza (DC dei Tiri Salvezza degli incantesimi 14, +6 al colpire con attacchi con incantesimo). Il mago ha preparato i seguenti incantesimi:\\
Trucchetti (a volontà): \emph{dardo infuocato, luce, mano magica,} \emph{prestidigitazione}\\
Difficoltà 10 (4 slot): \emph{armatura del magio, dardo incantato,} \emph{individuare magia, scudo}\\
...
\textbf{Sfida}: 12 (8.400 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} L'Arcimago ha CM 18. La sua abilità da incantatore è l'Intelligenza (DC dei Tiri Salvezza degli incantesimi 17, +9 al colpire con attacchi con incantesimo). L'arcimagio può eseguire \emph{camuffare sé stesso} e \emph{invisibilità} a volontà e ha preparato i seguenti incantesimi:\\
Trucchetti (a volontà): \emph{dardo infuocato, luce, mano magica,} \emph{prestidigitazione, stretta folgorante}\\
Difficoltà 10 (4 slot): \emph{armatura magica*, dardo incantato,} \emph{identificare, individuare magia}\\
Difficoltà 13 (3 slot): \emph{immagine speculare, individuazione dei} \emph{pensieri, passo velato}\\
...
\subsubsection{Sacerdoti}\index{Mostri - Sacerdoti}
...
\subsubsection{Cultista}\index{Mostri - Cultista}
...
\subsubsection{Accolito}\index{Mostri - Accolito}
...
\textbf{Lingue}: una qualsiasi lingua (di solito il Comune)\\
\textbf{Sfida}: 1/4 (50 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} L'accolito ha CM 1. La sua abilità da incantatore è la Volontà (DC dei Tiri Salvezza degli incantesimi 12, +4 al colpire con attacchi con incantesimo). L'accolito ha preparato i seguenti incantesimi:\\
Trucchetti (a volontà): \emph{fiamma sacra, luce, taumaturgia} \\
Difficoltà 10 (3 slot): \emph{benedizione}, \emph{cura ferite, santuario}\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Randello.} Attacco con Arma da Mischia}: +3 al colpire, portata 1,5 m, un bersaglio.\\
\emph{Colpisce:} 2 (1d4) danni contundenti.\\

\subsubsection{Fanatico del Culto}\index{Mostri - Fanatico del Culto}
...
\textbf{Lingue}: una qualsiasi lingua (di solito il Comune)\\
\textbf{Sfida}: 2 (450 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} Il sacerdote ha CM 4. La sua abilità da incantatore è la Volontà (DC dei Tiri Salvezza degli incantesimi 11, +3 al colpire con attacchi conincantesimo). Il sacerdote ha preparato i seguenti incantesimi:\\
Trucchetti (a volontà): \emph{fiamma sacra, luce, taumaturgia} \\
...
\subsubsection{Gran Sacerdote}\index{Mostri - Gran Sacerdote}
...
\emph{\textbf{Incantesimi.}} Il sacerdote ha CM 5. La sua abilità da incantatore è la Volontà (DC dei Tiri Salvezza degli incantesimi 13, +5 al colpire con attacchi con incantesimo). Il sacerdote ha preparato i seguenti incantesimi: \\
Trucchetti (a volontà): \emph{fiamma sacra, luce, taumaturgia}\\
...
\subsubsection{Berserker}\index{Mostri - Berserker}
...
\subsubsection{Combattente Tribale}\index{Mostri - Combattente Tribale}
...
\subsubsection{Druido}\index{Mostri - Druido}
...
Difficoltà 10 (4 slot): \emph{intralciare, onda tonante, parlare con gli} \emph{animali, passo veloce}\\
...
\subsubsection{Esploratore}\index{Mostri - Esploratore}
