...
Queste regole opzionali, sceglietene una quando si parte con la campagna, permettono al Narratore di stabilire se una prova di magia fallita può comunque essere sufficiente per ottenere un qualche risultato.

\begin{enumerate}

\item
\textbf{I 6 comandano}\index{I 6 comandano}: con questa regola se nella prova di magia fallita se si sono ottenuti almeno 2 volte sei (quindi successo critico) il giocatore potrà lanciare un incantesimo di Difficoltà inferiore purché la Difficoltà sia superata.

Es: Tups fa 6,2,6. Ritira i sei ed ottiene 2,1 per un totale di 17. Non potrà quindi lanciare Invisibilità come aveva sperato (Difficoltà 19) ma potrà comunque lanciare ad esempio l'incantesimo Spruzzo Colorato (Difficoltà 16).
...
\begin{tcolorbox}[enhanced,arc=5pt,boxrule=0.3pt,width=0.42\textwidth,title = Fallire gli Incantesimi]{
...
\begin{itemize}
	...
	\item
	\textbf{Aumentare il tempo} di lancio da 2 Azioni a 1 round diminuisce la Difficoltà dell'incantesimo di 1.
	\item
	\textbf{Magie collaborative}: un altro mago, sacrificando uno slot incantesimi e impiegando le stesso tempo di lancio di incantesimo del compagno, puo' concedere +1d6 alla prova di magia del compagno.
	\item
	\textbf{Circolo del Potere}: fino a 4 maghi,che siano tutti Seguaci o Devoti dello stesso Patrono, possono ognuno sacrificare uno slot di incantesimo per ottenere che uno di loro abbia +3d6 nella prova di magia dell'incantesimo.
	\item
