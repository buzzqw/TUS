...
\begin{narratore}
Se volente un sistema magico piu' provante e difficile che renda la magia ancora piu' rara e ardite suggerisco di aumentare la Difficoltà di lancio ogni incantesimo di 6, tranne per i trucchetti che aumenterete di 4.

Una modifica di questo genere farà ragionare ancora di piu' i giocatori se rischiare il lancio di una magia oppure sfruttare il round per fare qualcos'altro.	
\end{narratore}	


\begin{narratore}
Volete un sistema piu' tradizionale?
