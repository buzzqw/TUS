...
parte è priva di intelligenza e non ha alcuna forma di società o
...
Costituzione, Intelligenza, Saggezza e Carisma) e i corrispondenti
modificatori.
...
potrebbe avere bonus alle prove di Saggezza (Percezione) e Destrezza
(Furtività). Un bonus di abilità è la somma del modificatore di
...
La voce Sensi indica il punteggio passivo di Saggezza (Percezione),
oltre a qualsiasi senso speciale di cui il mostro sia in possesso. I
...
\textbf{Tiri Salvezza} Costituzione +6, Intelligenza +8, Saggezza +6
...
esso, deve effettuare un tiro salvezza di Costituzione DC 14. Se lo
...
creatura, deve riuscire un tiro salvezza di Costituzione DC 14 o
...
riuscire un tiro salvezza di Saggezza DC 14 o restare affascinato
...
\textbf{Individuare.} L'aboleth effettua una prova di Saggezza
...
\textbf{Tiri Salvezza} Saggezza +9, Carisma +9 \textbf{Abilità}
Intuizione +9, Percezione +9

\textbf{Resistenze ai Danni} radiante; contundente, perforante e
...
\textbf{Tiri Salvezza} Costituzione +12, Saggezza +11, Carisma +12
...
\textbf{Tiri Salvezza} Intelligenza +14, Saggezza +14, Carisma +17
...
deve riuscire un tiro salvezza di Costituzione DC 15 o morire.
...
metri, deve effettuare un tiro salvezza di Destrezza DC 23, subendo 14
...
può vedere il solare, il bersaglio deve riuscire un tiro salvezza di
Costituzione DC 15 o restare accecato finché un incantesimo come
...
canzone deve riuscire un tiro salvezza di Saggezza DC 11 o restare
...
vicendevolmente, se non
\end{quote}

\begin{itemize}
\item
  inabile il basilisco può obbligare la creatura ad effettuare un tiro
  salvezza di Costituzione DC 12. Se la creatura fallisce il tiro
  salvezza, inizia magicamente a trasformarsi in pietra ed è
  intralciata. La creatura deve ripetere il tiro salvezza al termine del
  suo prossimo turno. Se lo riesce, l'effetto termina. Se lo fallisce,
  la creatura è pietrificata finché non viene liberata dall'incantesimo
  \emph{ristorare} \emph{superiore} o altra magia.
\end{itemize}
...
che ha inghiottito, deve riuscire un tiro salvezza di Costituzione DC 14
...
linea deve effettuare un tiro salvezza di Destrezza DC 16 e subire 66
...
Ciascuna di queste creature deve riuscire un tiro salvezza di Forza o
...
effettuare un tiro salvezza di Destrezza DC 15 e subire 31 (7d8) danni
...
riuscire un tiro salvezza di Costituzione DC 13 o restare avvelenata per
...
\textbf{Tiri Salvezza} Costituzione +5, Saggezza +7, Carisma +6
\textbf{Resistenze al Danno} radiante
...
riuscire un tiro salvezza di Costituzione DC 13 o restare avvelenato per
...
tiro salvezza di Costituzione DC 14 all'inizio di ciascun turno del
...
\textbf{Tiri Salvezza} Forza +14, Costituzione +12, Saggezza +9, Carisma
+12
...
fuoco, e il bersaglio deve riuscire un tiro salvezza di Forza DC 20 o
...
inizi il proprio turno in quell'area deve riuscire un tiro salvezza di
Costituzione DC 11 o restare avvelenata fino all'inizio del suo prossimo
...
\textbf{Tiri Salvezza} Forza +9, Costituzione +9, Saggezza +7, Carisma
+7
...
demone è l'Intelligenza (DC dei tiri salvezza degli incantesimi 16). Il
...
\textbf{Tiri Salvezza} Forza +7, Costituzione +8, Saggezza +4
\textbf{Resistenze al Danno} freddo, fulmine, fuoco; contundente,
perforante e tagliente di attacchi non magici
...
3 metri dal demone, deve riuscire un tiro salvezza di Costituzione DC 14
...
\textbf{Tiri Salvezza} Forza +9, Costituzione +10, Saggezza +8, Carisma
+10
...
\textbf{Tiri Salvezza} Costituzione +11, Intelligenza +9, Saggezza +6,
Carisma +7
...
dal demone e che possa vedere la luce, deve riuscire un tiro salvezza di
Saggezza DC 15 o restare spaventata per 1 minuto. Una creatura può
...
riuscire un tiro salvezza di Costituzione DC 10 o subire 5 (2d4) danni
...
si trovi entro 6 metri da lui, deve riuscire un tiro salvezza di
Saggezza DC 10 o restare spaventata per 1 minuto. Il bersaglio può
...
un tiro salvezza di Costituzione DC 14 o restare avvelenata. Mentre
\end{quote}
...
Costituzione DC 14 o restare stordita fino al termine del prossimo turno
del demone.
\end{quote}
...
riuscire un tiro salvezza di Costituzione DC 12 o restare avvelenato per
...
riuscire un tiro salvezza di Saggezza DC 14 o rimanere spaventata fino
...
veleno, e il bersaglio deve riuscire un tiro salvezza di Costituzione DC
...
riuscire un tiro salvezza di Costituzione DC 21 o restare avvelenato.
...
\item
  ...
  effettua un tiro salvezza di Destrezza DC 17, subendo 35 (10d6) danni
...
effettuare un tiro salvezza di Costituzione DC 17, subendo 17 (5d6)
...
\textbf{Tiri Salvezza} Intelligenza +5, Saggezza +6, Carisma +7
...
effettuare un tiro salvezza di Costituzione DC 11, subendo 10 (3d6)
...
riuscire un tiro salvezza di Saggezza DC 16 o restare spaventata per 1
...
quell'area deve effettuare un tiro salvezza di Costituzione DC 22 e
...
creatura entro 4,5 metri dal drago deve riuscire un tiro salvezza di
Destrezza DC 22 o subire 15 (2d6 + 8) danni contundenti e venir gettato
...
\emph{\textbf{Presenza Spaventosa.}} Ogni creatura scelta dal drago, che
si trovi entro 36 metri da esso e consapevole della sua presenza, deve
riuscire un tiro salvezza di Saggezza DC 14 o restare spaventata per 1
minuto. Una creatura può ripetere il tiro salvezza al termine di ciascun
suo turno, terminando l'effetto se lo riesce. Se il tiro salvezza della
creatura ha successo o l'effetto ha termine per essa, la creatura è
immune alla Presenza Spaventosa del drago per le successive 24 ore.
...
quell'area deve effettuare un tiro salvezza di Costituzione DC 19 e
...
Destrezza DC 19 o subire 13 (2d6 + 6) danni contundenti e venir gettato
prono. Il drago può poi volare fino a metà della sua velocità di volo.
\textbf{Attacco di Coda.} Il drago effettua un attacco di coda.
\textbf{Individuare.} Il drago effettua una prova di Saggezza
(Percezione).
...
quell'area deve effettuare un tiro salvezza di Costituzione DC 15 e
...
quell'area deve effettuare un tiro salvezza di Costituzione DC 12 e
...
\emph{\textbf{Presenza Spaventosa.}} Ogni creatura scelta dal drago, che
si trovi entro 36 metri da esso e consapevole della sua presenza, deve
riuscire un tiro salvezza di Saggezza DC 20 o restare spaventata per 1
minuto. Una creatura può ripetere il tiro salvezza al termine di ciascun
suo turno, terminando l'effetto se lo riesce. Se il tiro salvezza della
creatura ha successo o l'effetto ha termine per essa, la creatura è
immune alla Presenza Spaventosa del drago per le successive 24 ore.
...
linea deve effettuare un tiro salvezza di Destrezza DC 23 e subire 88
...
\textbf{Attacco di Ala (Costa 2 Azioni).} Il drago batte le ali. Ogni
creatura entro 4,5 metri dal drago deve riuscire un tiro salvezza di
Destrezza DC 24 o subire 16 (2d6 + 9) danni contundenti e venir gettato
prono. Il drago può poi volare fino a metà della sua velocità di volo.
...
\emph{\textbf{Presenza Spaventosa.}} Ogni creatura scelta dal drago, che
si trovi entro 36 metri da esso e consapevole della sua presenza, deve
riuscire un tiro salvezza di Saggezza DC 17 o restare spaventata per 1
minuto. Una creatura può ripetere il tiro salvezza al termine di ciascun
suo turno, terminando l'effetto se lo riesce. Se il tiro salvezza della
creatura ha successo o l'effetto ha termine per essa, la creatura è
immune alla Presenza Spaventosa del drago per le successive 24 ore.
...
linea deve effettuare un tiro salvezza di Destrezza DC 19 e subire 66
(12d10) danni da fulmine se fallisce il tiro salvezza, o la metà di
questi danni se lo riesce.
...
\textbf{Attacco di Ala (Costa 2 Azioni).} Il drago batte le ali. Ogni
creatura entro 3 metri dal drago deve riuscire un tiro salvezza di
Destrezza DC 20 o subire 14 (2d6 + 7) danni contundenti e venir gettato
prono. Il drago può poi volare fino a metà della sua velocità di volo.
...
linea deve effettuare un tiro salvezza di Destrezza DC 16 e subire 55
...
linea deve effettuare un tiro salvezza di Destrezza DC 12 e subire 22
...
\emph{\textbf{Presenza Spaventosa.}} Ogni creatura scelta dal drago, che
si trovi entro 36 metri da esso e consapevole della sua presenza, deve
riuscire un tiro salvezza di Saggezza DC 19 o restare spaventata per 1
minuto. Una creatura può ripetere il tiro salvezza al termine di ciascun
suo turno, terminando l'effetto se lo riesce. Se il tiro salvezza della
creatura ha successo o l'effetto ha termine per essa, la creatura è
immune alla Presenza Spaventosa del drago per le successive 24 ore.
...
effettuare un tiro salvezza di Destrezza DC 22 e subire 67 (15d8) danni
...
\textbf{Attacco di Ala (Costa 2 Azioni).} Il drago batte le ali. Ogni
creatura entro 4,5 metri dal drago deve riuscire un tiro salvezza di
Destrezza DC 23 o subire 15 (2d6 + 8) danni contundenti e venir gettato
prono. Il drago può poi volare fino a metà della sua velocità di volo.
...
effettuare un tiro salvezza di Destrezza DC 18 e subire 54 (12d8) danni
da acido se fallisce il tiro salvezza, o la metà di questi danni se lo
riesce.
...
effettuare un tiro salvezza di Destrezza DC 14 e subire 49 (11d8) danni
da acido se fallisce il tiro salvezza, o la metà di questi danni se lo
riesce.
...
effettuare un tiro salvezza di Destrezza DC 11 e subire 22 (5d8) danni
da acido se fallisce il tiro salvezza, o la metà di questi danni se lo
riesce.
...
\emph{\textbf{Presenza Spaventosa.}} Ogni creatura scelta dal drago, che
si trovi entro 36 metri da esso e consapevole della sua presenza, deve
riuscire un tiro salvezza di Saggezza DC 21 o restare spaventata per 1
minuto. Una creatura può ripetere il tiro salvezza al termine di ciascun
suo turno, terminando l'effetto se lo riesce. Se il tiro salvezza della
creatura ha successo o l'effetto ha termine per essa, la creatura è
immune alla Presenza Spaventosa del drago per le successive 24 ore.
...
\textbf{Attacco di Ala (Costa 2 Azioni).} Il drago batte le ali. Ogni
creatura entro 4,5 metri dal drago deve riuscire un tiro salvezza di
Destrezza DC 25 o subire 17 (2d6 + 10) danni contundenti e venir gettato
prono. Il drago può poi volare fino a metà della sua velocità di volo.
...
tiro salvezza di Destrezza DC 13 e subire 24 (7d6) danni da fuoco se
fallisce il tiro salvezza, o la metà di questi danni se lo riesce.
...
effettuare un tiro salvezza di Costituzione DC 22 e subire 77 (22d6)
...
\textbf{Attacco di Ala (Costa 2 Azioni).} Il drago batte le ali. Ogni
creatura entro 4,5 metri dal drago deve riuscire un tiro salvezza di
Destrezza DC 23 o subire 15 (2d6 + 8) danni contundenti e venire gettato
prono. Il drago può poi volare fino a metà della sua velocità di volo.
...
effettuare un tiro salvezza di Costituzione DC 18 e subire 56 (16d6)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
effettuare un tiro salvezza di Costituzione DC 14 e subire 42 (12d6)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
effettuare un tiro salvezza di Costituzione DC 11 e subire 21 (6d6)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
di 27 metri. Ogni creatura nell'area deve effettuare un tiro salvezza di
...
Nella nuova forma, il drago mantiene il suo allineamento, punti  ferita, Dadi Vita, la facoltà di parlare, le competenze, la Resistenza  Leggendaria, le azioni da tana, e i punteggi di Intelligenza, Saggezza  e Carisma, oltre a questa azione. Le sue statistiche e capacità  vengono altrimenti rimpiazzate da quelle della nuova forma, eccetto i privilegi di classe o azioni aggiuntive della nuova forma.
...
\emph{\textbf{Presenza Spaventosa.}} Ogni creatura scelta dal drago, che
si trovi entro 36 metri da esso e consapevole della sua presenza, deve
riuscire un tiro salvezza di Saggezza DC 18 o restare spaventata per 1
minuto. Una creatura può ripetere il tiro salvezza al termine di ciascun
suo turno, terminando l'effetto se lo riesce. Se il tiro salvezza della
creatura ha successo o l'effetto ha termine per essa, la creatura è
immune alla Presenza Spaventosa del drago per le successive 24 ore.
...
\emph{Soffio Gelido.} Il drago esala un'esplosione ghiacciata in un cono
di 18 metri. Ogni creatura nell'area deve effettuare un tiro salvezza di
...
Leggendaria, le azioni da tana, e i punteggi di Intelligenza, Saggezza e
...
\textbf{Attacco di Ala (Costa 2 Azioni).} Il drago batte le ali. Ogni
creatura entro 3 metri dal drago deve riuscire un tiro salvezza di
Destrezza DC 21 o subire 15 (2d6 + 8) danni contundenti e venir gettato
prono. Il drago può poi volare fino a metà della sua velocità di volo.
...
\emph{Soffio Gelido.} Il drago esala un'esplosione ghiacciata in un cono
di 9 metri. Ogni creatura nell'area deve effettuare un tiro salvezza di
...
tiro salvezza di Destrezza DC 19, subendo 66 (12d10) danni da fulmine se
fallisce il tiro salvezza, o la metà di questi danni se lo riesce.
\emph{Soffio Repulsivo.} Il drago esala dell'energia repulsiva in un
cono di 9 metri. Ogni creatura in quell'area deve riuscire un tiro
...
metri e larga 1,5 metri. Ogni creatura sulla linea deve effettuare un
tiro salvezza di Destrezza DC 15, subendo 55 (10d10) danni da fulmine se
fallisce il tiro salvezza, o la metà di questi danni se lo riesce.
\emph{Soffio Repulsivo.} Il drago esala dell'energia repulsiva in un
cono di 9 metri. Ogni creatura in quell'area deve riuscire un tiro
...
metri e larga 1,5 metri. Ogni creatura sulla linea deve effettuare un
tiro salvezza di Destrezza DC 12, subendo 16 (3d10) danni da fulmine se
fallisce il tiro salvezza, o la metà di questi danni se lo riesce.
...
\emph{\textbf{Presenza Spaventosa.}} Ogni creatura scelta dal drago, che
si trovi entro 36 metri da esso e consapevole della sua presenza, deve
riuscire un tiro salvezza di Saggezza DC 24 o restare spaventata per 1
minuto. Una creatura può ripetere il tiro salvezza al termine di ciascun
suo turno, terminando l'effetto se lo riesce. Se il tiro salvezza della
creatura ha successo o l'effetto ha termine per essa, la creatura è
immune alla Presenza Spaventosa del drago per le successive 24 ore.
...
Ogni creatura nell'area deve effettuare un tiro salvezza di Destrezza DC
...
Forza DC 24 o avere svantaggio ai tiri di attacco basati sulla Forza,
...
metri. Ogni creatura in quell'area deve riuscire un tiro salvezza di
Forza DC 21 o avere svantaggio ai tiri di attacco basati sulla Forza,
prove di Forza, e tiri salvezza di Forza per 1 minuto. Una creatura può
ripetere il tiro salvezza al termine di ciascun suo turno, terminando
l'effetto su di sé in caso di successo.
...
metri. Ogni creatura in quell'area deve riuscire un tiro salvezza di
Forza DC 13 o avere svantaggio ai tiri di attacco basati sulla Forza,
prove di Forza, e tiri salvezza di Forza per 1 minuto. Una creatura può
ripetere il tiro salvezza al termine di ciascun suo turno, terminando
l'effetto su di sé in caso di successo.
...
metri e larga 1,5 metri. Ogni creatura sulla linea deve effettuare un
tiro salvezza di Destrezza DC 18, subendo 45 (13d6) danni da fuoco se
fallisce il tiro salvezza, o la metà di questi danni se lo riesce.
\emph{Soffio Soporifero.} Il drago esala del gas soporifero in un cono
...
metri e larga 1,5 metri. Ogni creatura sulla linea deve effettuare un
tiro salvezza di Destrezza DC 14, subendo 42 (12d6) danni da fuoco se
fallisce il tiro salvezza, o la metà di questi danni se lo riesce.
\emph{Soffio Soporifero.} Il drago esala del gas soporifero in un cono
...
metri. Ogni creatura in quell'area deve riuscire un tiro salvezza di
Costituzione DC 22. Se fallisce il tiro salvezza, la creatura non può
...
metri. Ogni creatura in quell'area deve riuscire un tiro salvezza di
Costituzione DC 18. Se fallisce il tiro salvezza, la creatura non può
usare la sua reazione, ha la velocità dimezzata, e non può effettuare
più di un attacco durante il suo turno. Inoltre, la creatura può usare
un'azione o un'azione bonus, ma non entrambe. Questi effetti permangono
1 minuto. La creatura può ripetere il tiro salvezza al termine di
...
Costituzione DC 14. Se fallisce il tiro salvezza, la creatura non può
usare la sua reazione, ha la velocità dimezzata, e non può effettuare
più di un attacco durante il suo turno. Inoltre, la creatura può usare
un'azione o un'azione bonus, ma non entrambe. Questi effetti permangono
1 minuto. La creatura può ripetere il tiro salvezza al termine di
...
bersaglio può vedere la driade, deve riuscire un tiro salvezza di
Saggezza DC 14 o restare affascinato dalla magia. Le creature
...
dell'elementale deve effettuare un tiro salvezza di Forza DC 15. Se lo
...
dell'elementale deve effettuare un tiro salvezza di Forza DC 13. Se lo
...
creatura, quella creatura deve riuscire un tiro salvezza di Destrezza DC
...
veleno. Il bersaglio deve riuscire un tiro salvezza di Costituzione DC
...
visibile al fantasma, deve riuscire un tiro salvezza di Carisma DC 13 o
...
allineamento, Intelligenza, Saggezza, Carisma e immunità all'essere
...
gorgoglio deve effettuare un tiro salvezza di Saggezza DC 10. Se lo
...
inizi il suo turno in quell'area deve riuscire un tiro salvezza di Forza
...
Media o inferiore, deve riuscire un tiro salvezza di Forza DC 10 o venir
...
dal lampo deve riuscire un tiro salvezza di Destrezza DC 13 o restare
...
riuscire un tiro salvezza di Costituzione DC 10 contro questa magia o
...
deve riuscire un tiro salvezza di Forza DC 18 o restare intralciata da
...
\textbf{Tiri Salvezza} Intelligenza +7, Saggezza +6, Carisma +7
\textbf{Immunità al Danno} fuoco
...
\emph{\textbf{Fetore.}} Qualsiasi creatura che inizi il suo turno entro
1,5 metri dal ghast deve riuscire un tiro salvezza di Costituzione DC 10
o restare
...
creatura, diversa da un non morto, deve riuscire un tiro salvezza di
Costituzione DC 10 o restare paralizzata per 1 minuto. Il bersaglio può
ripetere il tiro salvezza al termine di ciascun suo turno, terminando
...
creatura, deve riuscire un tiro salvezza di Forza DC 17 o cadere prona.

\textbf{Reazioni}

\emph{\textbf{Afferrare Sassi.}} Se un sasso o un simile oggetto viene
scagliato al gigante, il gigante può, riuscendo un tiro salvezza di
Destrezza DC 10, afferrare il proiettile e non subire danni contundenti
da esso.
...
Destrezza DC 17, subendo 54 (12d8) danni da fulmine se lo fallisce, o la
metà se lo supera.
...
\emph{\textbf{Incantesimi Innati.}} La caratteristica da incantatore
innato dello gnomo è l'Intelligenza (DC dei tiri salvezza 11). Lo gnomo
...
\emph{Colpisce:} 16 (2d10 + 5) danni contundenti. Se il bersaglio è una
creatura, deve riuscire un tiro salvezza di Costituzione DC 15 o vedere
...
effettuare un tiro salvezza di Costituzione DC 19, subendo 45 (10d8)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
bersaglio deve effettuare un tiro salvezza di Saggezza DC 17 contro
...
al suo interno, il kraken deve riuscire un tiro salvezza di Costituzione
...
quella creatura deve riuscire un tiro salvezza di Destrezza DC 18 o
...
tiro salvezza di Destrezza DC 23, e subire 22 (4d10) danni da fulmine se
...
\textbf{Tiri Salvezza} Costituzione +10, Intelligenza +12, Saggezza +9
...
sua caratteristica da incantatore è l'Intelligenza (DC dei tiri salvezza
...
tiro salvezza di Costituzione DC 18 o restare paralizzato per 1 minuto.
...
bersaglio deve riuscire un tiro salvezza di Saggezza DC 18 contro questa
...
una creatura, deve riuscire un tiro salvezza di Forza DC 13 o cadere
prono.
...
umanoide, deve riuscire un tiro salvezza di Costituzione DC 12 o venire
...
umanoide, deve riuscire un tiro salvezza di Costituzione DC 12 o venir
...
umanoide, deve riuscire un tiro salvezza di Costituzione DC 14 o venir
...
umanoide, deve riuscire un tiro salvezza di Costituzione DC 11 o venir
...
umanoide, deve riuscire un tiro salvezza di Costituzione DC 13 o venir
...
creatura, può obbligarla ad effettuare un tiro salvezza di Costituzione
...
deve effettuare un tiro salvezza di Destrezza DC 10 o subire 4 (1d8)
...
tiro salvezza di Destrezza DC 10, subendo 5 (2d4) danni da freddo in
...
un tiro salvezza di Destrezza DC 11 o subire 7 (2d6) danni da fuoco in
caso di fallimento, o la metà di questi danni in caso di successo.
...
un tiro salvezza di Costituzione DC 10 o restare accecata per 1 minuto.
...
un tiro salvezza di Destrezza DC 10 o restare accecata per 1 minuto. Una
...
tiro salvezza di Destrezza DC 10, subendo 4 (1d8) danni da fuoco in caso
...
ispezionare visivamente l'illusione e riuscire una prova di Intelligenza
...
vedere la megera, deve riuscire un tiro salvezza di Saggezza DC 11
...
creatura, la creatura deve effettuare un tiro salvezza di Destrezza DC
12.
...
bersaglio può vedere la mummia, deve riuscire un tiro salvezza di
Saggezza DC 11 contro questa magia o restare spaventato fino al termine
...
\textbf{Tiri Salvezza} Costituzione +8, Intelligenza +5, Saggezza +9,
Carisma +8
...
creatura che possa vedere e si trovi entro 18 metri da lei. Se il
bersaglio può vedere la mummia, deve riuscire un tiro salvezza di
Saggezza DC 16 contro questa magia o restare spaventato fino al termine
del prossimo turno della mummia. Se il bersaglio fallisce il tiro
salvezza di 5 o più, è anche paralizzato per la stessa durata. Un
bersaglio che riesca il tiro salvezza è immune all'Occhiata Terribile di
tutte le mummie (ma non delle mummie sovrane) per le successive 24 ore.
...
deve riuscire un tiro salvezza di Costituzione DC 16 o restare stordita
...
dalla mummia sovrana deve riuscire un tiro salvezza di Costituzione DC
...
\textbf{Tiri Salvezza} Destrezza +8, Costituzione +7, Intelligenza +7,
...
effettuare un tiro salvezza di Costituzione DC 15, subendo 45 (10d8)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
\emph{Colpisce:} Il bersaglio deve effettuare un tiro salvezza di
Costituzione DC 15, subendo 45 (10d8) danni da veleno se fallisce il
tiro salvezza, o la metà di questi danni se lo riesce.
...
sua abilità da incantatore è l'Intelligenza (DC dei tiri salvezza degli
...
effettuare un tiro salvezza di Costituzione DC 13, subendo 31 (7d8)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
\emph{dissolvi} \emph{magie}, la spada deve riuscire un tiro salvezza di
Costituzione contro la DC del tiro salvezza dell'incantesimo o restare
...
tiro salvezza di Costituzione contro la DC del tiro salvezza
...
\textbf{Vulnerabilità al Danno} radiante
...
tiro salvezza di Costituzione DC 10 o restare avvelenato per 1 minuto.
...
creatura, deve riuscire un tiro salvezza di Costituzione DC 15 contro
...
creatura deve riuscire un tiro salvezza di Forza DC 14 o subire 10 (2d6
...
\emph{Colpisce:} 4 (1d4 + 2) danni perforanti, e il bersaglio deve
riuscire un tiro salvezza di Costituzione DC 11 o restare avvelenato per
...
creatura al suo interno, il remorhaz deve riuscire un tiro salvezza di
Costituzione DC 15 al termine di quel turno o vomitare tutte le creature
...
riuscire un tiro salvezza di Forza DC 14 o venire spinto di 3 metri
...
tiro salvezza di Destrezza DC 12, e subire 21 (6d6) danni da fuoco se
fallisce il tiro salvezza, o la metà di questi danni se lo riesce.
...
\textbf{Tiri Salvezza} Destrezza +6, Costituzione +11, Intelligenza +9,
Saggezza +10
...
\begin{quote}
\textbf{Primo Ruggito.} Ogni creatura che fallisce un tiro salvezza di
Saggezza DC 18 resta spaventata per 1 minuto. Una creatura spaventata
può ripetere il tiro salvezza al termine di ciascun suo turno,
terminandone l'effetto per sé, se lo riesce.

\textbf{Secondo Ruggito.} Ogni creatura che fallisce un tiro salvezza di
Saggezza DC 18 resta assordata e spaventata per 1 minuto. Una creatura
...
\textbf{Terzo Ruggito.} Ogni creatura effettua un tiro salvezza di
Costituzione DC 18. Chi fallisce il tiro salvezza subisce 44 (8d10)
...
La sua abilità da incantatore è l'Intelligenza (DC del tiro salvezza
...
deve riuscire un tiro salvezza di Costituzione DC 10 o restare
...
un tiro salvezza di Costituzione DC 10, lo spiritello apprende anche
...
metri da esso deve riuscire un tiro salvezza di Saggezza DC 15 o restare
...
tiro salvezza di Costituzione DC 15 contro questa magia, subendo 32
...
\textbf{Tiri Salvezza} Intelligenza +5, Saggezza +9, Carisma +9
...
creatura, deve riuscire un tiro salvezza di Forza DC 20 o cadere prona.
...
creatura al suo interno, il tarrasque deve riuscire un tiro salvezza di
Costituzione DC 30 al termine di quel turno o vomitare tutte le creature
...
deve riuscire un tiro salvezza di Saggezza DC 17 o restare spaventata
...
creatura, deve riuscire un tiro salvezza di Forza DC 20 o venire spinta
...
quell'area deve effettuare un tiro salvezza di Costituzione DC 18 e
...
di Intelligenza e Carisma 1 (-5), non possono parlare, e hanno solo
...
effettuare un tiro salvezza di Destrezza DC 11, subendo 7 (2d6) danni da
...
danno radiante o danno dall'acqua sacra, questo tratto non funziona
...
deve effettuare un tiro salvezza di Saggezza DC 17 contro questa magia o
...
Vampirica subisce danno radiante o danno dall'acqua sacra, questo tratto
...
creatura di taglia Grande, deve riuscire un tiro salvezza di Destrezza
...
al suo interno, il verme deve riuscire un tiro salvezza di Costituzione
...
effettuare un tiro salvezza di Costituzione DC 19, subendo 42 (12d6)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
effettuare un tiro salvezza di Costituzione DC 15, e subire 24 (7d6)
danni da veleno se lo fallisce, o la metà di questi danni se lo riesce.
...
un tiro salvezza di Costituzione DC 13 o vedere i suoi punti ferita
...
riuscire un tiro salvezza di Costituzione DC 14 o vedere i suoi punti
...
punti ferita, lo zombi deve effettuare un tiro salvezza di Costituzione
DC 5 + il danno subito, a meno che il danno non sia radiante o un colpo
...
Se il bersaglio è una creatura, deve riuscire un tiro salvezza di Forza
...
L'avvoltoio gigante possiede un'intelligenza superiore e un'attitudine
maligna.
...
creatura, deve riuscire un tiro salvezza di Costituzione DC 12 contro la
...
bersaglio è una creatura, deve riuscire un tiro salvezza di Forza DC 10
o cadere prona.
...
bersaglio è una creatura, deve riuscire un tiro salvezza di Forza DC 13
o cadere prona.
...
Forza DC 14 o cadere prono. Se il bersaglio è prono, il cavallo può
...
\emph{Colpisce:} 4 (1d4 + 2) danni perforanti e il bersaglio deve
riuscire un tiro salvezza di Costituzione DC 11 o subire 10 (3d6) danni
...
creatura, deve riuscire un tiro salvezza di Forza DC 16 o cadere prono.
...
stesso turno, il bersaglio deve riuscire un tiro salvezza di Forza DC 13
...
creatura, deve riuscire un tiro salvezza di Forza DC 11 o cadere prona.
...
creatura, deve riuscire un tiro salvezza di Forza DC 13 o cadere prona.
...
creatura, deve riuscire un tiro salvezza di Forza DC 14 o cadere prona.
...
quell'area deve effettuare un tiro salvezza di Destrezza DC 12, e subire
...
creatura, deve riuscire un tiro salvezza di Forza DC 11 o cadere prono.
...
verso una creatura e la colpisce con un attacco di artiglio durante lo
stesso turno, il bersaglio deve riuscire un tiro salvezza di Forza DC 12
...
effettuare un tiro salvezza di Costituzione DC 11, e subire 18 (4d8)
...
effettuare un tiro salvezza di Costituzione DC 11, e subire 7 (2d6)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce. Se il danno da veleno riduce il bersaglio a 0 punti
ferita, il bersaglio è stabile ma avvelenato per 1 ora, anche dopo aver
recuperato i punti ferita, e mentre è avvelenato in questo modo resta
...
effettuare un tiro salvezza di Costituzione DC 10, e subire 14 (4d6)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
tiro salvezza di Costituzione DC 9, e subire 4 (1d8) danni da veleno se
fallisce il tiro salvezza, o la metà di questi danni se lo riesce.
...
\emph{Colpisce:} 7 (1d10 + 2) danni perforanti e il bersaglio deve
effettuare un tiro salvezza di Costituzione DC 12, e subire 22 (4d10)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
\emph{Colpisce:} 1 danno perforante e il bersaglio deve effettuare un
tiro salvezza di Costituzione DC 10, e subire 5 (2d4) danni da veleno se
fallisce il tiro salvezza, o la metà di questi danni se lo riesce.
...
effettuare un tiro salvezza di Costituzione DC 11, e subire 10 (3d6)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
\emph{\textbf{Balzo.}} Se la tigre si muove di almeno 6 metri diretta
verso una creatura e la colpisce con un attacco di artiglio durante lo
stesso turno, il bersaglio deve riuscire un tiro salvezza di Forza DC 14
o cadere prono. Se il bersaglio è prono, la tigre può effettuare un
attacco di morso contro di esso come azione bonus.
...
creatura di taglia Media o inferiore, deve riuscire un tiro salvezza di
Forza DC 15 o cadere prono.
...
\textbf{Tiri Salvezza} Destrezza +6, Intelligenza +4
...
permette di effettuare un tiro salvezza di Destrezza per dimezzare i
...
effettuare un tiro salvezza di Costituzione DC 15, subendo 24 (7d6)
danni da veleno se fallisce il tiro salvezza, o la metà di questi danni
se lo riesce.
...
\textbf{Tiri Salvezza} Intelligenza +5, Saggezza +3
...
\textbf{Tiri Salvezza} Intelligenza +6, Saggezza +4 \textbf{Abilità}
Arcano +6, Storia +6
...
\textbf{Tiri Salvezza} Intelligenza +9, Saggezza +6 \textbf{Abilità}
Arcano +13, Storia +13
...
La sua abilità da incantatore è l'Intelligenza (DC dei tiri salvezza
