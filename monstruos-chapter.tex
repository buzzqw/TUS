...
%Ricarica dopo un Riposo Breve o Lungo	
%La caratteristica da incantatore innato del djinni è il Carisma
% Tempra +7, Riflessi +6, Arbitrio +4
%riposo breve o lungo.
%Religione + >>> Cultura +
%+1d6 nelle prove di Volontà
...
\subsubsection{Angeli}\index{Angeli}
...
\emph{\textbf{Sensibilità alla Luce}}. Mentre è alla luce del sole, il coboldo ha -1d6 ai tiri per colpire, oltre che alle prove di Volontà (Percezione) basate sulla vista.\\
...
\subsubsection{Demoni}\index{Demoni}
...
\emph{\textbf{Spavento (1/Giorno).}} Una creatura scelta dal demone che si trovi entro 6 metri da lui, deve riuscire un tiro salvezza su Arbitrio DC 10 o restare spaventata per 1 minuto. Il bersaglio può ripetere il tiro salvezza al termine di ciascun suo round, con svantaggio se il demone è in linea di visuale, ponendo termine all'effetto prematuramente se riesce il tiro salvezza.\\
\textbf{Ecologia}\\
Ambiente: Qualsiasi (Abisso)\\
...
\subsubsection{Diavoli}\index{Diavoli}
...
\subsubsection{Dinosauri}\index{Dinosauri}
...
\emph{\textbf{Leggere Pensieri.}} Il doppelganger legge magicamente i pensieri di superficie di una creatura entro 18 metri da lui. L'effetto può penetrare le barriere, ma 1 metro di legno o terra, 50 centimetri di pietra, 5 centimetri di metallo, o un sottile foglio di piombo lo blocca. Mentre il bersaglio è a gittata, il doppelganger può continuare a leggerne i pensieri, purché la concentrazione del doppelganger non venga infranta (come la concentrazione di un incantesimo). Mentre legge la mente di un bersaglio, il doppelganger ha +1d6 alle prove di Saggezza (Intuizione) e Carisma (Inganno, Intimidire e Persuasione) contro il bersaglio.\\
\textbf{Ecologia}\\
Ambiente: Qualsiasi\\
...
\subsubsection{Draghi Cromatici}\index{Draghi Cromatici}
...
\medskip\textbf{Drago Blu Antico}\index{Drago Blu Antico}\\
...
\medskip\textbf{Drago Blu Adulto}\index{Drago Blu Adulto}\\
...
\medskip\textbf{Drago Blu Giovane}\index{Drago Blu Giovane}\\
\emph{Enorme drago, legale malvagio}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +2\\
...
\medskip\textbf{Drago Blu Cucciolo}\index{Drago Blu Cucciolo}\\
\emph{Enorme drago, legale malvagio}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +1\\
...
\medskip\textbf{Drago Nero Antico}\index{Drago Nero Antico}\\
\emph{Mastodontica drago, caotico malvagio}\\
\textbf{Potenza}: +8\\
\textbf{Agilità}: +2\\\
\textbf{Intelletto}: +3\\
...
\medskip\textbf{Drago Nero Adulto}\index{Drago Nero Adulto}
\emph{Enorme drago, caotico malvagio}\\
\textbf{Potenza}: +6\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: +2\\
...
\medskip\textbf{Drago Nero Giovane}\index{Drago Nero Giovane}\\
\emph{Grande drago, caotico malvagio}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: +1\\
...
\medskip\textbf{Drago Nero Cucciolo}\index{Drago Nero Cucciolo}\\
\emph{Media drago, caotico malvagio}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: +0\\
...
\medskip\textbf{Drago Rosso Antico}\index{Drago Rosso Antico}\\
\emph{Mastodontica drago, caotico malvagio}\\
\textbf{Potenza}: +10\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +4\\
...
\medskip\textbf{Drago Rosso Adulto}\index{Drago Rosso Adulto}\\
\emph{Enorme drago, caotico malvagio}\\
\textbf{Potenza}: +8\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +3\\
...
\medskip\textbf{Drago Rosso Giovane}\index{Drago Rosso Giovane}\\
\emph{Grande drago, caotico malvagio}\\
\textbf{Potenza}: +6\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +2\\
...
\medskip\textbf{Drago Rosso Cucciolo}\index{Drago Rosso Cucciolo}\\
\emph{Media drago, caotico malvagio}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +1\\
...
\medskip\textbf{Drago Verde Antico}\index{Drago Verde Antico}\\
\emph{Mastodontica drago, legale malvagio} \\
\textbf{Potenza}: +8\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: +5\\
...
\medskip\textbf{Drago Verde Adulto}\index{Drago Verde Adulto}\\
\emph{Enorme drago, legale malvagio}\\
\textbf{Potenza}: +6\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: +4\\
...
\medskip\textbf{Drago Verde Cucciolo}\index{rago Verde Cucciolo}\\
...
\subsubsection{Draghi Metallici}\index{Draghi Metallici}

\medskip\textbf{Drago d'Argento Antico}\index{Drago d'Argento Antico}\\
...
\medskip\textbf{Drago d'Argento Adulto}\index{Drago d'Argento Adulto}\\
...
\textbf{Descrizione}\\
Tra tutti i draghi, quelli d’argento sono i più coraggiosi, e si attengono ad un codice cavalleresco che impone loro di aiutare i deboli, sconfiggere il male e comportarsi in modo onorevole.\\
\medskip\textbf{Drago d'Argento Giovane}\index{Drago d'Argento Giovane}\\
...
\textbf{Descrizione}\\
Tra tutti i draghi, quelli d’argento sono i più coraggiosi, e si attengono ad un codice cavalleresco che impone loro di aiutare i deboli, sconfiggere il male e comportarsi in modo onorevole.\\
\medskip\textbf{Drago d'Argento Cucciolo}\index{Drago d'Argento Cucciolo}\\
...
\textbf{Descrizione}\\
Tra tutti i draghi, quelli d’argento sono i più coraggiosi, e si attengono ad un codice cavalleresco che impone loro di aiutare i deboli, sconfiggere il male e comportarsi in modo onorevole.\\
\medskip\textbf{Drago di Bronzo Antico}\index{Drago di Bronzo Antico}\\
...
.
\medskip\textbf{Drago di Bronzo Adulto}\index{Drago di Bronzo Adulto}\\
...
\medskip\textbf{Drago di Bronzo Giovane}\index{Drago di Bronzo Giovane}\\
...
\medskip\textbf{Drago di Bronzo Cucciolo}\index{Drago di Bronzo Cucciolo}\\
...
\medskip\textbf{Drago d'Oro Antico}\index{Drago d'Oro Antico}\\
\emph{Mastodontica drago, legale buono}\\
\textbf{Potenza}: +10\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: +4\\
...
\emph{Soffio Indebolente.} Il drago esala del gas in un cono di 27 metri. Ogni creatura in quell'area deve riuscire un tiro salvezza di Forza DC 24 o avere s+1d6 ai tiri di attacco basati sulla Forza, prove di Forza, e tiri salvezza di Forza per 1 minuto.\\
\emph{\textbf{Mutare Forma.}} Il drago può trasformarsi magicamente in un umanoide o bestia il cui grado di sfida sia pari o inferiore al proprio, o tornare alla sua vera forma. Alla morte ritorna alla sua vera forma. Qualsiasi equipaggiamento stia indossando o trasportando viene assorbito o trasportato nella nuova forma (a scelta del drago).\\
Nella nuova forma, il drago mantiene il suo allineamento, punti ferita, Dadi Vita, la facoltà di parlare, le competenze, la Resistenza Leggendaria, le azioni da tana, e i punteggi di Intelletto, Saggezza e Carisma, oltre a questa azione. Le sue statistiche e capacità vengono altrimenti rimpiazzate da quelle della nuova forma, eccetto azioni aggiuntive della nuova forma.\\
\textbf{Azioni Aggiuntive}\\
Il drago può effettuare 3 azioni aggiuntive, scelte tra le opzioni seguenti. Può usare solo un'Azione Aggiuntiva alla volta e solo al termine del turno di un'altra creatura. Il drago recupera le Azioni Aggiuntive spese all'inizio del proprio round.\\
...
\medskip\textbf{Drago d'Oro Adulto}\index{Drago d'Oro Adulto}\\
\emph{Enorme drago, legale buono}\\
\textbf{Potenza}: +8\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: +3\\
...
\emph{Soffio Indebolente.} Il drago esala del gas in un cono di 18 metri. Ogni creatura in quell'area deve riuscire un tiro salvezza di Forza DC 21 o avere s+1d6 ai tiri di attacco basati sulla Forza, prove di Forza, e tiri salvezza di Forza per 1 minuto. Una creatura può ripetere il tiro salvezza al termine di ciascun suo round, terminando l'effetto su di sé in caso di successo.\
\emph{\textbf{Mutare Forma.}} Il drago può trasformarsi magicamente in un umanoide o bestia il cui grado di sfida sia pari o inferiore al proprio, o tornare alla sua vera forma. Alla morte ritorna alla sua vera forma. Qualsiasi equipaggiamento stia indossando o trasportando viene assorbito o trasportato nella nuova forma (a scelta del drago).\\
Nella nuova forma, il drago mantiene il suo allineamento, punti ferita, Dadi Vita, la facoltà di parlare, le competenze, la Resistenza Leggendaria, le azioni da tana, e i punteggi di Intelletto, Saggezza e Carisma, oltre a questa azione. Le sue statistiche e capacità  vengono altrimenti rimpiazzate da quelle della nuova forma, eccetto azioni aggiuntive della nuova forma.\\
\textbf{Azioni Aggiuntive}\\
Il drago può effettuare 3 azioni aggiuntive, scelte tra le opzioni seguenti. Può usare solo un'Azione Aggiuntiva alla volta e solo al termine del turno di un'altra creatura. Il drago recupera le Azioni Aggiuntive spese all'inizio del proprio round.\\
...
\textbf{Descrizione}\\
I draghi d'oro sono l'emblema della virtù. Gli altri draghi metallici li riveriscono come agenti delle potenze divine e membri esemplari della razza draconica, e spesso li cercano per consigli o aiuto.\\
\medskip\textbf{Drago d'Oro Giovane}\index{entry}\index{Drago d'Oro Giovane}\\
\emph{Grande drago, legale buono}\\
\textbf{Potenza}: +6\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: +3\\
...
\textbf{Descrizione}\\
I draghi d'oro sono l'emblema della virtù. Gli altri draghi metallici li riveriscono come agenti delle potenze divine e membri esemplari della razza draconica, e spesso li cercano per consigli o aiuto.\\
\medskip\textbf{Drago d'Oro Cucciolo}\index{Drago d'Oro Cucciolo}\\
\emph{Media drago, legale buono}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: +2\\
...
\medskip\textbf{Drago d'Ottone Antico}\index{Drago d'Ottone Antico}\\
\emph{Mastodontica drago, caotico buono}\\
\textbf{Potenza}: +8\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +3\\
...
\medskip\textbf{Drago d'Ottone Adulto}\index{Drago d'Ottone Adulto}\\
\emph{Enorme drago, caotico buono}\\
\textbf{Potenza}: +6\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +2\\
...
\medskip\textbf{Drago d'Ottone Giovane}\index{Drago d'Ottone Giovane}\\
\emph{Grande drago, caotico buono}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +1\\
...
\medskip\textbf{Drago d'Ottone Cucciolo}\index{Drago d'Ottone Cucciolo}
\emph{Media drago, caotico buono}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +0\\
...
\medskip\textbf{Drago di Rame Antico}\index{Drago di Rame Antico}\\
\emph{Mastodontica drago, caotico buono}\\\
\textbf{Potenza}: +8\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: +5\\
...
\medskip\textbf{Drago di Rame Adulto}\index{Drago di Rame Adulto}\\
\emph{Enorme drago, caotico buono}\\
\textbf{Potenza}: +6\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: +4\\
...
\medskip\textbf{Drago di Rame Giovane}\index{Drago di Rame Giovane}\\
\emph{Grande drago, caotico buono}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: +3\\
...
\medskip\textbf{Drago di Rame Cucciolo}\index{Drago di Rame Cucciolo}\\
\emph{Media drago, caotico buono}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: +2\\
...
\medskip\textbf{Drider}\index{Drider}\\
\emph{Grande mostruosità, caotico malvagio}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: +2\\
...
\medskip\textbf{Driade}\index{Driade}\\
...
\medskip\textbf{Duergar}\index{Duergar}\\
...
\emph{\textbf{Sensibilità alla Luce}}. Mentre è alla luce del sole, il duergar ha s+1d6 ai tiri di attacco, oltre che alle prove di Saggezza (Percezione) basate sulla vista.\\
\smallskip\textbf{Azioni}\\
...
\subsubsection{Elementali}\index{Elementali}

\medskip\textbf{Elementale dell'Acqua}\index{Elementale dell'Acqua}\\
...
\medskip\textbf{Elementale dell'Aria}\index{Elementale dell'Aria}\\
\emph{Grande elementale, neutrale}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: +5\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Elementale del Fuoco}\index{Elementale del Fuoco}\\
\emph{Grande elementale, neutrale}\\
\textbf{Potenza}: +0\\
\textbf{Agilità}: +4\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Elementale della Terra}\index{Elementale della Terra}\\
\emph{Grande elementale, neutrale}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: -1\\
\textbf{Intelletto}: -3\\
...
\medskip\textbf{Elfo, Drow}\index{Elfo, Drow}\\
...
\emph{\textbf{Sensibilità alla Luce}}. Mentre è alla luce del sole, il drow ha -1d6 ai tiri per colpire, oltre che alle prove di Saggezza (Percezione) basate sulla vista.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Ettercap}\index{Ettercap}\\
...
\medskip\textbf{Ettin}\index{Ettin}\\
...
\textbf{Sfida} 4 (1.100 PE)\smallskip\\
\emph{\textbf{Due Teste.}} L'ettin ha +1d6 alle prove di Saggezza (Percezione) e sui tiri salvezza contro le condizioni accecato, affascinato, assordato, privo di sensi, spaventato e stordito. \\
...
\medskip\textbf{Fantasma}\index{Fantasma}\\
...
\medskip\textbf{Fauci Gorgoglianti}\index{Fauci Gorgoglianti}\\
...
\subsubsection{Funghi}\index{Funghi}

\medskip\textbf{Fungo Stridente}\index{Fungo Stridente}\\
...
\medskip\textbf{Fungo Violetto}\index{Fungo Violetto}\\
\emph{Media pianta, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: -4\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Fuoco Fatuo}\index{Fuoco Fatuo}\\
...
\medskip\textbf{Fustigatore}\index{Fustigatore}\\
...
\emph{Colpisce:} Il bersaglio è afferrato (DC 15 per fuggire). Fino al termine dell'afferrare, il bersaglio è intralciato e ha -1d6 alle prove di Forza e ai tiri salvezza di Forza, mentre il fustigatore non può usare lo stesso viticcio contro un altro bersaglio.\\
...
\medskip\textbf{Gargoyle}\index{Gargoyle}\\
...
\subsubsection{Geni}\index{Geni}

\medskip\textbf{Djinni}\index{Djinni}\\
...
\medskip\textbf{Efreeti}\index{Efreeti}\\
...
\medskip\textbf{Ghast}\index{Ghast}\\
...
\medskip\textbf{Ghoul}\index{Ghoul}\\
\emph{Media non morto, caotico malvagio}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\subsubsection{Giganti}\index{Giganti}

\medskip\textbf{Gigante di Collina}\index{Gigante di Collina}\\
...
\medskip\textbf{Gigante del Fuoco}\index{Gigante del Fuoco}\\
...
\medskip\textbf{Gigante del Gelo}\index{Gigante del Gelo}\\
...
\medskip\textbf{Gigante delle Nuvole}\index{Gigante delle Nuvole}\\
...
\emph{\textbf{Olfatto Affinato.}} Il gigante ha +1d6 alle prove di Saggezza (Percezione) basate sull'olfatto.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Gigante di Pietra}\index{Gigante di Pietra}\\
...
\textbf{Linguaggi} Gigante\\
\textbf{Sfida} 7 (2.900 PE)\smallskip\\
\emph{\textbf{Mimetismo di Pietra.}} Il gigante ha +1d6 alle prove di Destrezza (Furtività) effettuate per nascondersi su terreni rocciosi.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Multiattacco.}} Il gigante effettua due attacchi con il randello pesante.\\
...
\medskip\textbf{Gigante delle Tempeste}\index{Gigante delle Tempeste}\\
...
\medskip\textbf{Gnoll}\index{Gnoll}\\
...
\medskip\textbf{Gnomo delle Profondità (Svirfneblin)}\index{Gnomo delle Profondità} \index{Svirfneblin}\\
...
\emph{\textbf{Camuffamento di Pietra.}} Lo gnomo ha +1d6 alle prove di Destrezza (Furtività) effettuate per nascondersi su terreni rocciosi.\\
...
\subsubsection{Golem}\index{Golem}

\medskip\textbf{Golem di Argilla}\index{Golem di Argilla}\\
...
\medskip\textbf{Golem di Carne}\index{Golem di Carne}\\
...
\medskip\textbf{Golem di Ferro}\index{Golem di Ferro}\\
\emph{Grande costrutto, disallineato}\\
\textbf{Potenza}: +7\\
\textbf{Agilità}: -1\\
\textbf{Intelletto}: -4\\
...
\medskip\textbf{Golem di Pietra}\index{Golem di Pietra}\\
\emph{Grande costrutto, disallineato}\\
\textbf{Potenza}: +6 \\
\textbf{Agilità}: -1\\
\textbf{Intelletto}: -4\\
...
\medskip\textbf{Gorgone}\index{Gorgone}\\
\emph{Grande mostruosità, disallineato}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Grick}\index{Grick}\\
...
\textbf{Linguaggi} -\\
\textbf{Sfida} 2 (450 PE)\smallskip\\
\emph{\textbf{Camuffamento di Pietra.}} Il grick ha +1d6 alle prove di Destrezza (Furtività) per nascondersi su terreno roccioso.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Grifone}\index{Grifone}\\
\emph{Grande mostruosità, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\textbf{Linguaggi} -\\
\textbf{Sfida} 2 (450 PE)\smallskip\\\
\emph{\textbf{Vista Affinata.}} Il grifone ha +1d6 nelle prove di Volontà (Percezione) basate sulla vista.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Grimlock}\index{Grimlock}\\
...
\textbf{Sfida} 1/4 (50 PE)\smallskip\\
\emph{\textbf{Camuffamento di Pietra.}} Il grimlock ha +1d6 alle prove di Destrezza (Furtività) effettuate per nascondere su terreni rocciosi.\\
\emph{\textbf{Sensi Ciechi.}} Il grimlock non può usare la vista cieca mentre è assordato e non più fiutare.\\
\emph{\textbf{Olfatto e Udito Affinati.}} Il grimlock ha +1d6 alle prove di Saggezza (Percezione) basate su udito o olfatto.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Guardiano Protettore}\index{Guardiano Protettore}\\
\emph{Grande costrutto, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: -1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Hobgoblin}\index{Hobgoblin}\\
...
\medskip\textbf{Ippogrifo}\index{Ippogrifo}\\
\emph{Grande mostruosità, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\textbf{Linguaggi} -\\
\textbf{Sfida} 1 (200 PE)\smallskip\\
\emph{\textbf{Vista Affinata.}} L'ippogrifo ha +1d6 nelle prove di Volontà (Percezione) basate sulla vista.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Kraken}\index{Kraken}\\
...
\medskip\textbf{Lamia}\index{Lamia}\\
\emph{Grande mostruosità, caotico malvagio}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: +2\\
...
\emph{Colpisce:} Il bersaglio è maledetto per 1 ora da questa magia. Fino al termine della maledizione, il bersaglio ha -1d6 ai tiri salvezza di Saggezza e a tutte le prove di abilità.\\
\textbf{Ecologia}\\
...
\medskip\textbf{Lucertoloide}\index{Lucertoloide}\\
...
\subsubsection{Mannari}\index{Mannari}

\medskip\textbf{Cinghiale Mannaro}\index{Cinghiale Mannaro}\\
...
\medskip\textbf{Lupo Mannaro}\index{Lupo Mannaro}\\
...
\emph{\textbf{Udito e Olfatto Affinato.}} Il lupo mannaro ha +1d6 nelle prove di Volontà (Percezione) basate su udito o olfatto.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Orso Mannaro}\index{Orso Mannaro}\\
...
\emph{\textbf{Olfatto Affinato.}} L'orso mannaro ha +1d6 nelle prove di Volontà (Percezione) basate sull'olfatto.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Ratto Mannaro}\index{Ratto Mannaro}\\
...
\emph{\textbf{Olfatto Affinato.}} Il ratto mannaro ha +1d6 nelle prove di Volontà (Percezione) basate sull'olfatto.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Tigre Mannara}\index{Tigre Mannara}\\
...
\emph{\textbf{Olfatto e Udito Affinato.}} La tigre mannara ha +1d6 nelle prove di Volontà (Percezione) basate su olfatto e udito.\\
...
\medskip\textbf{Manticora}\index{Manticora}\\
...
\medskip\textbf{Manto Assassino}\index{Manto Assassino}\\
...
\emph{\textbf{Sensibilità alla Luce}}. Mentre è alla luce del sole, il manto assassino ha -1d6 ai tiri per colpire, oltre che alle prove di Saggezza (Percezione) basate sulla vista.\\
...
\medskip\textbf{Mantoscuro}\index{Mantoscuro}\\
\emph{Piccola mostruosità, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Medusa}\index{Medusa}\\
...
\subsubsection{Mefiti}\index{Mefiti}

\medskip\textbf{Mefito di Ghiaccio}\index{Mefito di Ghiaccio}\\
...
\medskip\textbf{Mefito di Magma}\index{Mefito di Magma}\\
\emph{Piccola elementale, malvagio}\\
\textbf{Potenza}: -1\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Mefito di Polvere}\index{Mefito di Polvere}\\
\emph{Piccola elementale, malvagio}\\
\textbf{Potenza}: -3\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -1\\
...
\medskip\textbf{Mefito di Vapore}\index{Mefito di Vapore}\\
\emph{Piccola elementale, malvagio}\\
\textbf{Potenza}: -3\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +0\\
...
\subsubsection{Megere}\index{Megere}

\medskip\textbf{Megera Marina}\index{Megera Marina}\\
...
\emph{\textbf{Aspetto Orripilante.}} Qualsiasi umanoide che inizi il suo turno entro 9 metri dalla megera e ne può vedere la vera forma deve effettuare un tiro salvezza su Arbitrio DC 11. Se fallisce il tiro salvezza, la creatura resta spaventata per 1 minuto. Una creatura può ripetere il tiro salvezza al termine di ciascun suo round, con svantaggio se la megera è in linea di visuale, e terminando l'effetto se riesce il tiro salvezza. Se il tiro salvezza della creatura riesce o l'effetto ha termine su di essa, la creatura è immune all'Aspetto Orripilante per le successive 24 ore.\\
...
\medskip\textbf{Megera Notturna}\index{Megera Notturna}\\
...
\medskip\textbf{Megera Verde}\index{Megera Verde}\\
...
\subsubsection{Melme}\index{Melme}

\medskip\textbf{Ameba Paglierina}\index{Ameba Paglierina}\\
...
\medskip\textbf{Cubo Gelatinoso}\index{Cubo Gelatinoso}\\
\emph{Grande melma, disallineato}\\
\textbf{Potenza}: +2\\
\textbf{Agilità} -4\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Melma Grigia}\index{entry}\\
...
\medskip\textbf{Protoplasma Nero}\index{Protoplasma Nero}\\
\emph{Grande melma, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: -3\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Mimic}\index{Mimic}\\
\emph{Media mostruosità (mutaforma), neutrale}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -3\\
...
\medskip\textbf{Minotauro}\index{Minotauro}\\
\emph{Grande mostruosità, caotico malvagio}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Mummia}\index{Mummia}\\
...
\medskip\textbf{Mummia Sovrana}\index{Mummia Sovrana}\\
\emph{Media non morto, legale malvagio}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: +0\\
...
\subsubsection{Naga}\index{Naga}

\medskip\textbf{Naga Guardiano}\index{Naga Guardiano}\\
...
\medskip\textbf{Naga Spirituale}\index{Naga Spirituale}\\
\emph{Grande mostruosità, caotico malvagio}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +4\\
\textbf{Intelletto}: +3\\
...
\subsubsection{Oggetti Animati}\index{Oggetti Animati}

\medskip\textbf{Armatura Animata}\index{Armatura Animata}\\
...
\medskip\textbf{Spada Volante}\index{Spada Volante}\\
...
\medskip\textbf{Tappeto del Soffocamento}\index{Tappeto del Soffocamento}\\
\emph{Grande costrutto, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Ombra}\index{Ombra}\\
\emph{Media non morto, caotico malvagio}\\
\textbf{Potenza}: -2\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Omuncolo}\index{Omuncolo}\\
...
\medskip\textbf{Orsogufo}\index{Orsogufo}\\
\emph{Grande mostruosità, disallineato}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -4\\
...
\textbf{Linguaggi} -\\
\textbf{Sfida} 3 (700 PE)\smallskip\\
\emph{\textbf{Olfatto e Vista Affinati.}} L'orsogufo ha +1d6 nelle prove di Volontà (Percezione) basate su olfatto o vista.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Otyugh}\index{Otyugh}\\
...
\medskip\textbf{Pegaso}\index{Pegaso}\\
...
\medskip\textbf{Persecutore Invisibile}\index{Persecutore Invisibile}\\
...
\medskip\textbf{Pseudodrago}\index{Pseudodrago}\\
...
\emph{\textbf{Sensi Affinati.}} Lo pseudodrago ha +1d6 alle prove di Saggezza (Percezione) basate su vista, udito e olfatto.\\
...
\medskip\textbf{Rakshasa}\index{Rakshasa}\\
...
\medskip\textbf{Remorhaz}\index{Remorhaz}\\
\emph{Enorme mostruosità, disallineato}\\
\textbf{Potenza}: +7\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -3\\
...
\medskip\textbf{Rugginofago}\index{Rugginofago}\\
\emph{Media Mostruosità, disallineato}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Sahuagin}\index{Sahuagin}\\
...
\medskip\textbf{Salamandra}\index{Salamandra}\\
...
\medskip\textbf{Satiro}\index{Satiro}\\
...
\medskip\textbf{Scheletro}\index{Scheletro}\\
\emph{Media non morto, legale malvagio}\\
\textbf{Potenza}: +0\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Scheletro di Cavallo da Guerra}\index{Scheletro di Cavallo da Guerra}\\
...
\medskip\textbf{Scheletro di Minotauro}\index{Scheletro di Minotauro}\\
\emph{Grande non morto, legale malvagio}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Segugio Infernale}\index{Segugio Infernale}\\
\emph{Media immondo, legale malvagio}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\textbf{Linguaggi} comprende l'Infernale ma non può parlare\\
\textbf{Sfida} 3 (700 PE)\smallskip\\
\emph{\textbf{Udito e Olfatto Affinato.}} Il segugio ha +1d6 nelle prove di Volontà (Percezione) basate su udito od olfatto.\\
...
\subsubsection{Sfingi}\index{Sfingi}

\medskip\textbf{Androsfinge}\index{Androsfinge}\\
...
\medskip\textbf{Ginosfinge}\index{Ginosfinge}\\
\emph{Grande mostruosità, legale neutrale}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: +4\\
...
\medskip\textbf{Spiritello}\index{Spiritello}\\
...
\medskip\textbf{Strige (Uccello Stigeo)}\index{Strige (Uccello Stigeo)}\\
...
\medskip\textbf{Succube}\index{Succube}\\
...
\medskip\textbf{Tarrasque}\index{Tarrasque}\\
...
\emph{\textbf{Presenza Spaventosa.}} Ogni creatura scelta dal tarrasque, che si trovi entro 36 metri da esso e consapevole della sua presenza, deve riuscire un tiro salvezza su Arbitrio DC 17 o restare spaventata per 1 minuto. Una creatura può ripetere il tiro salvezza al termine di ciascun suo round, con svantaggio se il tarrasque è in linea di visuale, terminando l'effetto per sé, se lo riesce. Se il tiro salvezza della creatura ha successo o l'effetto ha termine per essa, la creatura è immune alla Presenza Spaventosa del tarrasque per le successive 24 ore.\\
\textbf{Azioni Aggiuntive}\\
...
\medskip\textbf{Testuggine Dragona}\index{Testuggine Dragona}\\
...
\medskip\textbf{Troll}\index{Troll}\\
\emph{Grande gigante, caotico malvagio}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\textbf{Linguaggi} Gigante\\
\textbf{Sfida} 5 (1.800 PE)\smallskip\\
\emph{\textbf{Olfatto Affinato.}} Il troll ha +1d6 alle prove di Saggezza (Percezione) basate sull'olfatto.\\
...
\medskip\textbf{Uomo Acquatico}\index{Uomo Acquatico}\\
...
\medskip\textbf{Uomo Albero (Treant)}\index{Treant}\\
...
\medskip\textbf{Uomo Magma (Magmin)}\index{Magmin}\\
...
\medskip\textbf{Unicorno}\index{Unicorno}\\
\emph{Grande celestiale, legale buono}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: +0\\
...
\subsubsection{Vampiri}\index{Vampiri}

\medskip\textbf{Vampiro}\index{Vampiro}\\
...
\medskip\textbf{Progenie Vampirica}\index{Progenie Vampirica}\\
...
\medskip\textbf{Verme Purpureo}\index{Verme Purpureo}\\
...
\medskip\textbf{Viverna}\index{Viverna}\\
...
\medskip\textbf{Wight}\index{Wight}\\
\emph{Media non morto, malvagio}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: +0\\
...
\emph{\textbf{Sensibilità alla Luce}}. Mentre è alla luce del sole, il wight ha s+1d6 ai tiri di attacco, oltre che alle prove di Saggezza (Percezione) basate sulla vista.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Wraith}\index{Wraith}\\
\emph{Media non morto, malvagio}\\
\textbf{Potenza}: -2\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: +1\\
...
\emph{\textbf{Sensibilità alla Luce}}. Mentre è alla luce del sole, il wraith ha s+1d6 ai tiri di attacco, oltre che alle prove di Saggezza (Percezione) basate sulla vista.\\
\smallskip\textbf{Azioni}\\
...
\textbf{Linguaggi} Terran\\
\textbf{Sfida} 5 (1.800 PE)\smallskip\\
\emph{\textbf{Mimetismo di Pietra.}} Lo xorn ha +1d6 alle prove di Destrezza (Furtività) effettuate per nascondersi su terreno roccioso.\\
...
\medskip\textbf{Zombi}\index{Zombi}\\
\emph{Media non morto, malvagio}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: -2\\
\textbf{Intelletto}: -4\\
...
\medskip\textbf{Zombi Ogre}\index{Zombi Ogre}\\
...
\subsubsection{Addendum: Creature Varie}\index{Creature Varie}
...
\medskip\textbf{Albero Risvegliato}\index{Albero Risvegliato}\\
...
\medskip\textbf{Alce Gigante}\index{Alce Gigante}\\
\emph{Enorme bestia, disallineato}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Aquila}\index{Aquila}\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 0 (10 PE)\smallskip\\
\emph{\textbf{Vista Affinata.}} L'aquila ha +1d6 nelle prove di Volontà (Percezione) basate sulla vista.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Aquila Gigante}\index{Aquila Gigante}\\
...
\medskip\textbf{Avvoltoio}\index{Avvoltoio}\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 0 (10 PE)\smallskip\\
\emph{\textbf{Olfatto e Vista Affinati.}} L'avvoltoio ha +1d6 nelle prove di Volontà (Percezione) basate su olfatto o vista.\\
...
\medskip\textbf{Avvoltoio Gigante}\index{Avvoltoio Gigante}\\
...
\medskip\textbf{Babbuino}\index{Babbuino}\\
\emph{Piccola bestia, disallineato}\\
\textbf{Potenza}: -1\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -3\\
...
\medskip\textbf{Balena Assassina (Orca)}\index{Orca}\\
\emph{Enorme bestia, disallineato}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -4\\
...
\emph{\textbf{Udito Affinato.}} La balena ha +1d6 alle prove di Saggezza (Percezione) basate sull'udito.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Morso.} Attacco con arma da mischia}: +7 a colpire, portata 1 m, un bersaglio.\\
...
\medskip\textbf{Becco d'Ascia}\index{Becco d'Ascia}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Cammello}\index{Cammello}
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: -1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Cane della Morte}\index{Cane della Morte}\\
...
\textbf{Sfida} 1 (200 PE)\smallskip\\
\emph{\textbf{Bicefalo.}} Il cane ha +1d6 nelle prove di Volontà (Percezione) e nei tiri salvezza contro le condizioni accecato, affascinato, assordato, spaventato, stordito o svenuto.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Cane Intermittente}\index{Cane Intermittente}\\
...
\textbf{Sfida} 1/4 (50 PE)\smallskip\\
\emph{\textbf{Udito e Olfatto Affinato.}} Il cane ha +1d6 nelle prove di Volontà (Percezione) basate su udito o olfatto.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Morso.} Attacco con Arma da Mischia}: +3 a colpire, portata 1 m, un bersaglio.\\
...
\medskip\textbf{Caprone}\index{Caprone}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +1\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Caprone Gigante}\index{Caprone Gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -4\\
...
\medskip\textbf{Cavallo da Corsa}\index{Cavallo da Corsa}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Cavallo da Guerra}\index{Cavallo da Guerra}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Cavallo da Tiro}\index{Cavallo da Tiro}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Cavallo Marino Gigante}\index{Cavallo Marino Gigante}
...
\medskip\textbf{Cervo}\index{Cervo}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +1\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Cinghiale}\index{Cinghiale}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Cinghiale Gigante}\index{Cinghiale Gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Coccodrillo}\index{Coccodrillo}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Coccodrillo Gigante}\index{Coccodrillo Gigante}\\
\emph{Enorme bestia, disallineato}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: -1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Corvo}\index{Corvo}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Donnola}\index{Donnola}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 0 (10 PE)\smallskip\\
\emph{\textbf{Udito e Olfatto Affinati.}} La donnola ha +1d6 nelle prove di Volontà (Percezione) basate su udito o olfatto.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Morso.} Attacco con Arma da Mischia}: +5 a colpire, portata 1 m, un bersaglio.\\
\emph{Colpisce:} 1 danno perforante.\\


\medskip\textbf{Donnola Gigante}\index{Donnola Gigante}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +1\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -3\\
...
\medskip\textbf{Elefante}\index{Elefante}\\
\emph{Enorme bestia, disallineato}\\
\textbf{Potenza}: +6\\
\textbf{Agilità}: -1\\
\textbf{Intelletto}: -4\\
...
\medskip\textbf{Falco}\index{Falco}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Potenza}: -3\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 0 (10 PE)\smallskip\\
\emph{\textbf{Vista Affinata.}} Il falco ha +1d6 alle prove di Saggezza (Percezione) basate sulla vista.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Speroni.} Attacco con Arma da Mischia}: +5 a colpire, portata 1 m, un bersaglio.\\
\emph{Colpisce:} 1 danno tagliente. \\
\textbf{Ecologia}\\
...
\medskip\textbf{Falco di Sangue}\index{Falco di Sangue}\\
...
\medskip\textbf{Piranha}\index{Piranha}\\
...
\medskip\textbf{Gatto}\index{Gatto}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -4\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 0 (10 PE)\smallskip\\
\emph{\textbf{Olfatto Affinato.}} Il gatto ha +1d6 alle prove di Saggezza (Percezione) basate sull'olfatto.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Granchio Gigante}\index{Granchio Gigante}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\emph{\textbf{Udito e Vista Affinati.}} Il gufo ha +1d6 nelle prove di Volontà (Percezione) basate su udito o vista.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Gufo Gigante}\index{Gufo Gigante}\\
...
\medskip\textbf{Iena Gigante}\index{Iena Gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Leone}\index{Leone}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -4\\
...
\emph{\textbf{Olfatto Affinato.}} Il leone ha +1d6 alle prove di Saggezza (Percezione) basate sull'olfatto.\\
...
\medskip\textbf{Lucertola}\index{Lucertola}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Lucertola Gigante}\index{Lucertola Gigante}\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 1/4 (50 PE)\smallskip\\
\emph{\textbf{Udito e Olfatto Affinato.}} Il lupo ha +1d6 nelle prove di Volontà (Percezione) basate su udito o olfatto.\\
...
\medskip\textbf{Lupo gigante}\index{Lupo gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -4\\
...
\medskip\textbf{Lupo Invernale}\index{Lupo Invernale}\\
...
\textbf{Sfida} 3 (700 PE)\smallskip\\
\emph{\textbf{Camuffamento di Neve.}} Il lupo ha +1d6 alle prove di Destrezza (Furtività) per nascondersi su terreno innevato.\\
\emph{\textbf{Udito e Olfatto Affinato.}} Il lupo ha +1d6 nelle prove di Volontà (Percezione) basate su udito o olfatto.\\
\emph{\textbf{Tattiche di Branco.}} Il lupo ha +1d6 ai tiri di attacco contro una creatura se almeno uno degli alleati del lupo si trova entro 1 metro dalla creatura e quell'alleato non è inabile.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Morso.} Attacco con arma da mischia}: +7 a colpire, portata 1 m, un bersaglio.\\
...
\medskip\textbf{Mammut}\index{Mammut}\\
...
\medskip\textbf{Mastino}\index{Mastino}\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 1/8 (25 PE)\smallskip\\
\emph{\textbf{Udito e Olfatto Affinato.}} Il mastino ha +1d6 nelle prove di Volontà (Percezione) basate su udito o olfatto.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Morso.} Attacco con Arma da Mischia}: +3 a colpire, portata 1 m, un bersaglio.\\
...
\medskip\textbf{Orso Bruno}\index{Orso Bruno}
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 1 (200 PE)\smallskip\\
\emph{\textbf{Olfatto Affinato.}} L'orso ha +1d6 alle prove di Saggezza (Percezione) basate sull'olfatto.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Orso Nero}\index{Orso Nero}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Orso Polare}\index{Orso Polare}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Pantera}\index{Pantera}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\emph{\textbf{Olfatto Affinato.}} La pantera ha +1d6 alle prove di Saggezza (Percezione) basate sull'olfatto.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Piovra Gigante}\index{Piovra Gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -3\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 1 (200 PE)\smallskip\\
\emph{\textbf{Camuffamento Subacqueo.}} La piovra ha +1d6 alle prove di Destrezza (Furtività) effettuate sottacqua.\\
...
\medskip\textbf{Pipistrello}\index{Pipistrello}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\emph{\textbf{Udito Affinato.}} Il pipistrello ha +1d6 alle prove di Saggezza (Percezione) basate sull'udito.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Pipistrello Gigante}\index{Pipistrello Gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Ragno}\index{Ragno}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Potenza} -5\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Ragno Fase}\index{Ragno Fase}\\
...
\medskip\textbf{Ragno Gigante}\index{Ragno Gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Ragno Lupo Gigante}\index{Ragno Lupo Gigante}\\
...
\medskip\textbf{Rana Gigante}\index{Rana Gigante}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +1\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Ratto}\index{Ratto}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 0 (10 PE)\smallskip\\
\emph{\textbf{Olfatto Affinato.}} Il ratto ha +1d6 alle prove di Saggezza (Percezione) basate sull'olfatto.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Morso.} Attacco con Arma da Mischia}: +0 a colpire, portata 1 m, un bersaglio.\\
\emph{Colpisce:} 1 danno perforante.\\

\medskip\textbf{Ratto Gigante}\index{Ratto Gigante}\\
\emph{Piccola bestia, disallineato}\\
\textbf{Potenza}: -2\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Rinoceronte}\index{Rinoceronte}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: -1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Rospo Gigante}\index{Rospo Gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Scarabeo di Fuoco Gigante}\index{Scarabeo di Fuoco Gigante}\\
...
\medskip\textbf{Sciacallo}\index{Sciacallo}\\
\emph{Piccola bestia, disallineato}\\
\textbf{Potenza}: -1\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -4\\
...
\emph{\textbf{Udito e Olfatto Affinato.}} Lo sciacallo ha +1d6 nelle prove di Volontà (Percezione) basate su udito o olfatto.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Morso.} Attacco con Arma da Mischia}: +1 a colpire, portata 1 m, un bersaglio.\\
\emph{Colpisce:} 1 (1d4 - 1) danni perforanti.\\
...
\subsubsection{Sciami}\index{Sciami}
...
\medskip\textbf{Sciame di Centopiedi}\index{Sciame di Centopiedi}\\
...
\medskip\textbf{Sciame di Corvi}\index{Sciame di Corvi}\\
\emph{Medio sciame di Minuscole bestie, disallineato}\\
\textbf{Potenza}: -2\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -4\\
...
\medskip\textbf{Sciame di Pirana}\index{Sciame di Pirana}\\
\emph{Medio sciame di Minuscole bestie, disallineato}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Sciame di Insetti}\index{Sciame di Insetti}\\
\emph{Medio sciame di Minuscole bestie, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Sciame di Pipistrelli}\index{Sciame di Pipistrelli}\\
\emph{Medio sciame di Minuscole bestie, disallineato}\\
\textbf{Potenza}: -3\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\emph{\textbf{Udito Affinato.}} Lo sciame ha +1d6 alle prove di Saggezza (Percezione) basate sull'udito.\\
\smallskip\textbf{Azioni}\\
...
\medskip\textbf{Sciame di Ragni}\index{Sciame di Ragni}\\
\emph{Medio sciame di Minuscole bestie, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Sciame di Ratti}\index{Sciame di Ratti}\\
\emph{Medio sciame di Minuscole bestie, disallineato}\\
\textbf{Potenza}: -1\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 1/4 (50 PE)\smallskip\\
\emph{\textbf{Olfatto Affinato.}} Lo sciame ha +1d6 alle prove di Saggezza (Percezione) basate sull'olfatto.\\
...
\medskip\textbf{Sciame di Vespe}\index{Sciame di Vespe}\\
\emph{Medio sciame di Minuscole bestie, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Scimmione}\index{Scimmione}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Scimmione Gigante}\index{Scimmione Gigante}\\
\emph{Enorme bestia, disallineato}\\
\textbf{Potenza}: +6\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Scorpione}\index{Scorpione}\\
...
\medskip\textbf{Scorpione Gigante}\index{Scorpione Gigante}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +1\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Serpente Costrittore}\index{Serpente Costrittore}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +3\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Serpente Costrittore Gigante}\index{Serpente Costrittore Gigante}\\
\emph{Enorme bestia, disallineato}\\
\textbf{Potenza}: +5\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Serpente Velenoso}\index{Serpente Velenoso}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Potenza}: -4\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Serpente Velenoso Gigante}\index{Serpente Velenoso Gigante}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +0\\
\textbf{Agilità}: +4\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Serpente Volante}\index{Serpente Volante}\\
...
\medskip\textbf{Squalo Cacciatore}\index{Squalo Cacciatore}\\
...
\medskip\textbf{Squalo Corallino}\index{Squalo Corallino}\\
...
\textbf{Sfida} 1/2 (100 PE)\smallskip\\
\emph{\textbf{Respirare Acqua.}} Lo squalo può respirare solo sottacqua.\\
\emph{\textbf{Tattiche di Branco.}} Lo squalo ha vantaggio al tiro di attacco contro una creatura se almeno uno degli alleati dello squalo si  trova entro 1 metro dalla creatura e quell'alleato non è inabile.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Morso.} Attacco con Arma da Mischia}: +4 a colpire, portata 1,5 m, un bersaglio.\\
\emph{Colpisce:} 6 (1d8 + 2) danni perforanti.\\

\medskip\textbf{Squalo Gigante}\index{Squalo Gigante}\\
...
\medskip\textbf{Strige}\index{Strige}\\
...
\medskip\textbf{Tasso}\index{Tasso}\\
\emph{Minuscola bestia, disallineato}\\
\textbf{Potenza}: -3\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\textbf{Lingue} -\\
\textbf{Sfida} 0 (10 PE)\smallskip\\
\emph{\textbf{Olfatto Affinato.}} Il tasso ha +1d6 alle prove di Saggezza (Percezione) basate sull'olfatto.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Morso.} Attacco con Arma da Mischia}: +2 a colpire, portata 1 m, un bersaglio.\\
\emph{Colpisce:} 1 danno perforante.\\

\medskip\textbf{Tasso Gigante}\index{Tasso Gigante}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +2\\
\textbf{Agilità}: +0\\
\textbf{Intelletto}: -2\\
...
\medskip\textbf{Tigre}\index{Tigre}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +3\\
\textbf{Intelletto}: -4\\
...
\emph{\textbf{Olfatto Affinato.}} La tigre ha +1d6 alle prove di Saggezza (Percezione) basate sull'olfatto.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Artiglio.} Attacco con Arma da Mischia}: +5 a colpire, portata 1 m, un bersaglio.\\
\emph{Colpisce:} 7 (1d8 + 3) danni taglienti.\\
\emph{\textbf{Morso.} Attacco con Arma da Mischia}: +5 a colpire, portata 1 m, un bersaglio.\\
...
\medskip\textbf{Tigre dai Denti a Sciabola}\index{Tigre dai Denti a Sciabola}\\
\emph{Grande bestia, disallineato}\\
\textbf{Potenza}: +4\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -4\\
...
\medskip\textbf{Vespa Gigante}\index{Vespa Gigante}\\
\emph{Media bestia, disallineato}\\
\textbf{Potenza}: +0\\
\textbf{Agilità}: +2\\
\textbf{Intelletto}: -2\\
...
\textbf{Sfida} 1/2 (100 PE)\smallskip\\
\emph{\textbf{Udito e Olfatto Affinato.}} Il worg ha +1d6 nelle prove di Volontà (Percezione) basate su udito o olfatto.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Morso.} Attacco con Arma da Mischia}: +5 a colpire, portata 1 m, un bersaglio.\\
\emph{Colpisce:} 10 (2d6 + 3) danni perforanti. Se il bersaglio è una creatura, deve riuscire un tiro salvezza su Tempra DC 13 o cadere prona. 
...
\subsubsection{Addendum: Personaggi Non Giocanti}\index{Personaggi Non Giocanti}
...
\subsubsection{Personalizzare i PNG}\index{Personalizzare i PNG}
...
\subsubsection{Veterano}\index{Veterano}
...
\subsubsection*{Cavaliere}\index{Cavaliere}
...
perforanti.
\emph{\textbf{Autorità (Ricarica dopo un Riposo Breve o Lungo)}}. Per 1 minuto, il cavaliere può pronunciare un comando speciale o avvertimento ogni qualvolta una creatura non ostile entro 9 metri da lui, e che possa vedere, effettua un tiro di attacco o tiro salvezza. La creatura può sommare un d4 al suo tiro purchè possa udire e comprendere il cavaliere. Una creatura può beneficiare di un solo dado Autorità alla volta. Questo effetto termina se il cavaliere è inabile. \\
\textbf{Reazioni}\\
...
\subsubsection{Gladiatore}\index{Gladiatore}
...
\emph{Colpisce:} 9 (2d4 + 4) danni contundenti. Se il bersaglio è una creatura di taglia Media o inferiore, deve riuscire un tiro salvezza di Forza DC 15 o cadere prono.\\
\textbf{Reazioni}\\
...
\subsubsection{Nobile}\index{Nobile}
...
\subsubsection{Popolano}\index{Popolano}
...
\subsubsection{Criminali}\index{Criminali}
...
\subsubsection{Bandito/Pirata}\index{Bandito}\index{Pirata}
...
\textbf{Competenze} Furtività +4, Intuizione +4, Investigazione +5, Percezione +6, Persuasione +5, Raggiro +5, Rapidità di Mano +4\\
\textbf{Lingue} due lingue qualsiasi\\
\textbf{Sfida} 1 (200 PE)\smallskip\\
\emph{\textbf{Attacco Furtivo (1/Turno).}} La spia infligge 7 (2d6) danni aggiuntivi quando colpisce un bersaglio con un attacco con arma e ha vantaggio al tiro di attacco, o quando il bersaglio è entro 1 metro da un alleato dell'assassino che non è inabile e l'assassino non ha svantaggio al tiro di attacco.\\
...
\subsubsection{Capitano dei Banditi/Pirata}\index{Capitano Pirata}\index{Capitano dei Banditi}
...
\textbf{Movimento} 9 m\\
\textbf{Tiri Salvezza}: Tempra +5, Riflessi +5, Arbitrio +3 \\
\textbf{Competenze} Atletica +4, Raggiro +4\\
\textbf{Lingue} due lingue qualsiasi\\
\textbf{Sfida} 2 (450 PE)\smallskip\\
\smallskip\textbf{Azioni}\\
...
\subsubsection{Assassino}\index{Assassino}
...
\emph{\textbf{Attacco Furtivo (1/Turno).}} L'assassino infligge 14 (4d6) danni aggiuntivi quando colpisce un bersaglio con un attacco con arma e ha vantaggio al tiro di attacco, o quando il bersaglio è entro 1 metro da un alleato dell'assassino che non è inabile e l'assassino non ha svantaggio al tiro di attacco.\\
...
\subsubsection{Mago}\index{Mago}\index{Incantatore}
...
\subsubsection{Sacerdoti}\index{Sacerdoti}
...
\subsubsection{Cultista}\index{Cultista}
...
\textbf{Lingue} una qualsiasi lingua (di solito il Comune)\\
\textbf{Sfida} 1/8 (25 PE)\smallskip\\
\emph{\textbf{Oscura Devozione.}} Il cultista ha vantaggio sui tiri salvezza contro l'essere affascinato o spaventato.\\
\smallskip\textbf{Azioni}\\
\emph{\textbf{Scimitarra.} Attacco con Arma da Mischia}: +3 a colpire, portata 1 m, una creatura.
\emph{Colpisce:} 4 (1d6 + 1) danni taglienti.\\

\subsubsection{Accolito}\index{Accolito}
...
\textbf{Lingue} una qualsiasi lingua (di solito il Comune)\\
\textbf{Sfida} 1/4 (50 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} L'accolito ha CM 1. La sua abilità da incantatore è la Saggezza (DC dei tiri salvezza degli incantesimi 12, +4 al colpire con attacchi con incantesimo). L'accolito ha preparato i seguenti incantesimi da chierico:\\
...
\subsubsection{Fanatico del Culto}\index{Fanatico del Culto}
...
\textbf{Competenze} Persuasione +4, Raggiro +4, Religione +2\\
\textbf{Lingue} una qualsiasi lingua (di solito il Comune)\\
\textbf{Sfida} 2 (450 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} Il sacerdote ha CM 4. La sua abilità da incantatore è la Saggezza (DC dei tiri salvezza degli incantesimi 11, +3 al colpire con attacchi conincantesimo). Il sacerdote ha preparato i seguenti incantesimi da chierico:\\
Trucchetti (a volontà): \emph{fiamma sacra, luce, taumaturgia} \\
...
\subsubsection{Gran Sacerdote}\index{Gran Sacerdote}
...
\emph{\textbf{Incantesimi.}} Il sacerdote ha CM 5. La sua abilità da incantatore è la Saggezza (DC dei tiri salvezza degli incantesimi 13, +5 al colpire con attacchi con incantesimo). Il sacerdote ha preparato i seguenti incantesimi da chierico: \\
Trucchetti (a volontà): \emph{fiamma sacra, luce, taumaturgia}\\
...
\subsubsection{Berserker}\index{Berserker}
...
\textbf{Lingue} una qualsiasi lingua (di solito il Comune)\\
\textbf{Sfida} 2 (450 PE)\smallskip\\
\emph{\textbf{Incauto.}} All'inizio del suo turno, il berserker può ottenere vantaggio su tutti i tiri di attacco con armi da mischia effettuati durante quel turno, ma i tiri di attacco contro di esso hanno vantaggio fino all'inizio del suo prossimo turno.\\
\smallskip\textbf{Azioni} \\
\emph{\textbf{Ascia Grossa.} Attacco con Arma da Mischia}: +5 a colpire, portata 1 m, un bersaglio.\\
\emph{Colpisce:} 9 (1d12 + 3) danni taglienti. \\


\subsubsection{Combattente Tribale}\index{Combattente Tribale}
...
\subsubsection{Druido}\index{Druido}
...
\textbf{Competenze} Medicina +4, Natura +3, Percezione +4\\
\textbf{Lingue} Druidico più due altre lingue\\
\textbf{Sfida} 2 (450 PE)\smallskip\\
\emph{\textbf{Incantesimi.}} Il Druido ha CM 4. La sua abilità da incantatore è la Saggezza (DC dei tiri salvezza degli incantesimi 12, +4 al colpire con attacchi con incantesimo). Il sacerdote ha preparato i seguenti incantesimi:\\
...
\subsubsection{Esploratore}\index{Esploratore}
...
\textbf{Sfida} 1/2 (100 PE)\smallskip\\
\emph{\textbf{Olfatto e Vista Affinati.}} L'esploratore ha +1d6 nelle prove di Volontà (Percezione) basate su olfatto o vista.\\
\smallskip\textbf{Azioni}\\
