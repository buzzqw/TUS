...
\begin{tabular}{l|l|l} 
\flushleft{\textbf{Forza}: +5 & \textbf{Destrezza}: -1 & \textbf{Costituzione}: +5\\
\textbf{Intelligenza}: +4&\textbf{Saggezza}: +2&\textbf{Carisma}: +4\\
\end{tabular}}
...
\begin{tabular}{l|l|l}
\textbf{Forza}: +8 &\textbf{Destrezza}: +0& \textbf{Costituzione}: 8\\
\textbf{Intelligenza}: +0&\textbf{Saggezza}: +1&\textbf{Carisma}: +1\\
\end{tabular}
\textbf{Difesa}: 26 (armatura naturale) - \textbf{Iniziativa}: +0\\
