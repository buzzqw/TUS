...
raggio) \textbf{Linguaggi} Parlata delle Profondita'
...
attacco con arma, se quella creatura si trova entro 1 metro da un
...
+4 a colpire, portata 1 m o gittata 12 m, un bersaglio.
\emph{Colpisce:} 5 (1d6 + 2) danni perforanti.
...
\textbf{Sensi}: Scurovisione 18 m (solo in forma di ratto), Percezione
passiva 12
...
Attacco con arma a Distanza}: +4 a colpire, gittata 12 m, un
bersaglio.
...
\textbf{Sensi}: Scurovisione 18 m, 
\textbf{Linguaggi} Parlata delle Profondità, Parlata delle Profondita' \textbf{Sfida}
...
scoppio di frammenti di ghiaccio. Ogni creatura entro 1 metro da esso
...
\emph{\textbf{Scoppio Mortale.}} Quando il mefito muore, esplode in uno
scoppio di lava. Ogni creatura entro 1 metro da esso deve effettuare
...
\emph{\textbf{Scoppio Mortale.}} Quando il mefito muore, esplode in uno
scoppio di polvere. Ogni creatura entro 1 metro da esso deve riuscire
...
Una creatura entro 1 metro dal cubo può effettuare un'azione per
...
entra nello spazio di sua scelta entro 1 metro dal cubo.
