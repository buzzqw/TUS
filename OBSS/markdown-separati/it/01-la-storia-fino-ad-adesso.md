...
All'alba del secondo giorno una mistica energia avvolse Tàhil e questo mutò in un drago a molte teste di colori diversi. Nel suo petto apparve un'altra breccia e a ogni passo una moltitudine di altri draghi, per fortuna *leggermente* più piccoli, cominciò a uscire.
...
La vera regola che il Narratore deve ricordare è che qualsiasi regola venga usata, finché fa divertire tutti, è quella giusta!
...
**+1d6 oppure -1d6**: è un bonus o una penalità a una prova. Aggiungi o sottrai un dado a 6 alla prova. Il massimo della penalità porta il numero dei dadi lanciati a 0 e il bonus massimo a +3d6.
...
**Punti ferita (Punti Ferita)**: indicano l'energia vitale, la resistenza e la fortuna nel resistere alle ferite della creatura. Finché la creatura ha almeno 1 Punto Ferita, combatterà al suo meglio, senza problemi (ma potrebbe anche decidere di scappare piuttosto che morire!).
...
**Tiro Salvezza (TS)**: quando una creatura è sottoposta a un effetto particolare, spesso viene concesso un Tiro Salvezza per mitigarne o annullarne gli effetti. Il Tiro Salvezza è un'azione che non occupa tempo o Azioni.
