...
E se fosse alle nostre spalle e neanche l'avessimo notato?

## La Copertura 

Se è noto che l'obiettivo è presente ma è occultato in qualche maniera, allora si dice che ha **copertura**.
...
***Esempio***. La quarta creatura sulla linea di tiro equivale, in caso di creature tutte della stessa taglia, a una Copertura Completa. La prima creatura fornirà copertura leggera (+2 Difesa), la seconda copertura media (+4 Difesa) e la terza copertura completa (+8 Difesa). Ogni ulteriore creatura della medesima taglia somma un ulteriore +6 alla Difesa di copertura e +6 ulteriori per taglia di differenza.

***Esempio***. Se la terza creatura sulla linea di tiro è coperta da una creatura media e poi da una creatura piccola, godrà di una Copertura Leggera. La creatura piccola non fornisce bonus di copertura, se l'obiettivo è di taglia media.

Se chi si deve colpire è di taglia maggiore tra le creature coinvolte nella copertura, questa non beneficerà di alcuna copertura.
...
***Esempio.*** Se la creatura da colpire è di taglia piccola ed è coperta da una creatura grande, avrà un bonus di copertura pari a Completa +8 (+2 per una copertura, +4 per la prima taglia di differenza, +8 per la seconda taglia di differenza).

***Esempio.*** Se la creatura da colpire è di taglia media ed è coperta da una creatura di taglia grande, la copertura fornita sarà +4. Normalmente sarebbe copertura leggera perché è una sola creatura a coprire, ma, essendo di una taglia maggiore, conta come 2 creature che forniscono copertura.

Vedi anche Abilità Precisino .

## Invisibilità 

Se un avversario è invisibile o non si sa dove è si seguono le regole dell'Invisibilità.

Anche se si è invisibili non è detto che non si possa essere percepiti diversamente attraverso altri sensi, come l'olfatto, l'udito o il tatto. L'invisibilità rende una creatura non individuabile tramite la vista, ma non rende di per sé una creatura non percepibile o immune ai Tiri Critici o alle Esplosioni del Danno.

Una creatura accecata, che combatta contro una creatura invisibile o che combatta nell'oscurità più completa senza scurovisione, può effettuare una prova di Consapevolezza, 1 Azione, a difficoltà 20, oppure 2 Azioni a difficoltà 15, per **individuare** una creatura se questa è entro 6 metri da lei.
...
Chi attacca una creatura per lui **invisibile ma individuata** ha un -1d6 al Tiro per Colpire; la creatura che attacca colui che non la vede ha +1d6 al Tiro per Colpire.

Una creatura Accecata  subisce una penalità di -2 alle Prove di Competenza Base basate su Forza e Destrezza e fallisce automaticamente qualsiasi prova di Consapevolezza che dipenda dalla vista.

Attaccare un bersaglio non individuato significa attaccare un *quadretto* a caso della mappa. Permettete sempre il Tiro per Colpire, che ci sia un avversario o meno in quel quadretto. Se il bersaglio è in quel quadretto, modificate la sua Difesa di +8; se il *quadretto* è vuoto, il Tiro per Colpire non colpirà nessuno e informerete il personaggio che non ha colpito nulla.
