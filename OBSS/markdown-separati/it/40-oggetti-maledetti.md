...
Una maledizione può manifestarsi anche a seguito di influenze negative od emozionali estreme che coinvolgono un oggetto.
...
| 21-23 | Il colore della pelle del personaggio cambia. |
...
| 28-29 | Il personaggio ora porta un segno distintivo (un tatuaggio, una strana luminescenza ecc.). |
...
| 43-45 | Il personaggio diventa estremamente possessivo nei confronti dell'oggetto. |
...
| 53-54 | Il personaggio deve attaccare la creatura a lui più vicina (probabilità del 5\% ogni giorno). |
| 55-57 | Il personaggio rimane Stordito per 1d4 round ogni volta che l'oggetto è servito al suo scopo |
...
| 86-89 | Il PG incomincia a parlare di sé in terza persona. |
...
| 95 | Il personaggio viene trasformato in una creatura a caso di una specie specifica (probabilità del 5\% ogni giorno). |
| 96 | Il personaggio viene trasformato in una creatura specifica (probabilità del 5\% ogni giorno). |
| 97 | Il personaggio non può più usare oggetti magici o Incantesimi con livello oltre 5 |
| 98 | Il personaggio non può più usare oggetti magici o Incantesimi con livello oltre 3 |
| 99 | Il personaggio non può più usare Incantesimi |
| 100 | Tira due volte |
