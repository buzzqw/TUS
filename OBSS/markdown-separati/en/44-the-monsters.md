...
**Actions*Multiattack.*** The demon makes two attacks: one with its longsword and one with its whip.
...
**Actions*Corrupting Touch***. Touch Attack: +6 to hit, reach 1 m, one target.
...
**Actions*Multiattack.** 3 attacks with longsword +3*: +27 to hit, reach 1 m, up to three different creatures, or 1 sword strike with Corruption
...
**Actions*Multiattack*** Bone Bloom can attack with the Great Club 3 times or use Blow Spores and execute one attack with the Great Club
...
**Actions*Multiattack.*** The devil makes three attacks: two with its claws and one with its sting or one with its hooked polearm and one with its sting.
...
**Actions*Bite.** Melee Weapon Attack*: +5 to hit,
...
**Actions*Morningstar.** Melee Weapon Attack*: +4 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The devil makes two attacks with its chain.
...
**Actions*Multiattack.*** The chuul makes two claw attacks. If the chuul is grappling a creature, it can also use its tentacles once.
...
**Actions*Multiattack.*** The cloaker makes two attacks: one with its bite and one with its tail.

***Bite.** Melee Weapon Attack*: +9 to hit, reach 1 m, one creature.

*Hit:* 10 (2d6 + 3) piercing damage, and if the target is Large or smaller, the cloaker attaches to it.
...
**Actions*Multiattack.*** The giant makes two attacks with its Morningstar.
...
**Actions*Bite.** Melee weapon attack*: +8 to hit, reach 1 m, one creature.
...
| **Multiattack** |
| ***Attack*** Darklight attacks twice with its torch or uses Cry of Sadness |
| ***Torch*** Melee attack, +6 to hit |
...
**Actions*Crush.** Melee Weapon Attack*: +4 to hit, reach 1 m, one creature.
...
**Actions*War Pick.** Melee Weapon Attack*: +4 to hit, reach 1 m, one target.
...
**Actions*Multiattack.** 2 tentacle attacks*: +19, reach 3 meters, one creature. All of Demogorgon' \*\*s attacks are considered magical +2.
...
**Actions*Multiattack.*** The dragon can make three attacks: one with its bite and two with its claws. It can make one tail attack in place of two claw attacks.
...
***Tail.** Melee Weapon Attack*: +13 to hit, reach 5 meters, one target.
*Hit:* 26 (3d12 + 7) bludgeoning damage. If the target is a creature, it must succeed on a DC 31 Fortitude Saving Throw or be pushed 3 meters away from the dragon turtle and knocked prone.
...
**Actions*Claws.** Melee Weapon Attack*: +4 to hit, reach 1 m, one creature.
...
**Actions*Multiattack.*** The efreeti makes two scimitar attacks or uses Hurl Flame twice.
...
**Actions*Multiattack.*** The Explosive Roach can make 1 charge attack or emit a fire slurry.
...
**Actions*Longsword.** Melee Weapon Attack*: +4 to hit, reach 1 m, one target.
...
**Actions*Withering Touch.** Melee Weapon Attack*: +5 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The gibbering mouther makes one bite attack and, if it can, one Blinding Spittle attack.
...
**Actions*Multiattack.*** The demon makes four attacks: two with its pincers and two with its fists. Alternatively, it can make two attacks with its pincers and cast a spell.
...
**Actions*Tentacle***. Melee Attack, +5 to hit, reach 3 meters, one target
...
**Actions*Gore.** Melee Weapon Attack*: +6 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The grick makes one attack with its tentacles. If the attack hits, the grick can make a beak attack against the same target.
...
**Actions*Multiattack.*** The griffin makes two attacks: one with its beak and one with its talons.
...
**Actions*Spiked Bone Club.** Melee Weapon Attack*: +5 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The demon makes three attacks: one with its bite and two with its claws.
...
**Actions*Multiattack.*** The hippogriff makes two attacks: one with its beak and one with its talons.
...
**Actions*Longsword.** Melee Weapon Attack*: +5 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The devil makes three melee attacks: two with its fork and one with its sting. It can use Hurl Flame in place of any melee attack.
...
**Actions*Multiattack.*** The Hungry Coin makes two attacks. It can use Bite twice or use Bite and use Stinger.
...
**Actions*Multiattack.*** The devil makes three attacks: one with its bite, one with its claws, and one with its tail. Alternatively it makes two attacks: one with its tail and one with its spear.
...
**Actions*Multiattack.*** The Immortal Cursed makes three attacks with the longsword.
...
**Actions*Sting (Bite in Beast Form).** Melee Weapon Attack*: +4 to hit, reach 1 m, one creature.
...
**Actions*Dagger.** Melee weapon attack*: +3 to hit, reach 1 m, one target.
...
**Actions*Fist.** Melee Weapon Attack*: +3 to hit, reach 1 m, one target.
...
**Actions*Paralyzing Touch.** Melee Spell Attack*: +14 to hit, reach 1 m, one creature.
...
**Actions*Multiattack.*** The lizardfolk makes two melee attacks, each with a different weapon.
...
**Actions*Touch.** Melee Weapon Attack*: +4 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The demon makes seven attacks: six with its longswords and one with its tail.
...
**Actions*Multiattack.*** The medusa makes three attacks, one with its snake hair and two with its shortsword or two ranged attacks with its longbow.
...
| **Actions** |
| --- |
| ***Little Snout*** every target chosen by La Topi, within 30 meters, suffers a Little Snout. The target is pushed back 2d6 meters and takes 3d6 damage |
| ***Tiny Bite** Melee Weapon Attack*: +26 to hit, reach 0 m, one target. |
| *Hit:* 6 piercing damage. |
| ***Scratch** up to 4 Melee Weapon Attacks*: hits automatically, reach 0 m. |
...
**Actions*Multiattack.*** The demon uses Horror Nimbus if possible. Then it makes three attacks: one with its bite and two with its claws.
...
**Actions*Hooves.** Melee weapon attack*: +6 to hit, reach 3 m, one target.
...
**Actions*Spiked Club.** Melee Weapon Attack*: +6 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The oni makes two attacks, with its claws or with the glaive.
...
**Actions*Multiattack.** 2 attacks with wand*: +19, reach 3 meters, one creature. All of Orcus' \*\*s attacks are considered magical +3.
...
**Actions*Multiattack.*** The Panoptikhan can attack with two short tentacles.
...
**Actions*Multiattack.*** The Phoenix can attack with two claws and its bite
...
**Actions*Multiattack.*** The devil makes four attacks: one with its bite, one with its claw, one with its mace, and one with its tail.
...
**Actions*Claws (Bite in Beast Form).** Melee weapon attack*: +4 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The rakshasa can make two claw attacks.
...
**Actions*Smother.** Melee Weapon Attack*: +6 to hit, reach 1 m, one Medium or smaller creature.
...
**Actions*Multiattack.*** The scourger can make four attacks with its tendrils, use wrap and make one bite attack.
...
**Actions*Strength Drain.** Melee Weapon Attack*: +4 to hit, reach 1 m, one creature.
...
**Actions*Multiattack.*** The shambling mound makes two slam attacks. If both attacks hit a Medium or smaller creature, the target is grappled (DC 14 to escape) and the shambling mound uses Engulf on it.
...
**Actions*Multiattack.*** The golem makes two fist attacks.
...
**Actions*Multiattack.*** The devil makes two attacks: one with its bite and one with its fork or two with its tail spines.
...
**Actions*Claw (Fiend Form Only).** Melee weapon attack*: +6 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The Tarrasque can use its Frightful Presence. Then it makes five attacks: one with its bite, two with its claws, one with its horns, and one with its tail. It can use Swallow instead of bite. The Tarrasque' \*\*s attacks are considered magical +4.
...
**Actions*Multiattack.*** The Tentacled Crawler Worm makes 3 attacks, one with its bite and two with its tentacles.
...
**Actions*Multiattack.*** The tree man makes two slam attacks.
...
**Actions*Gore.** Melee Weapon Attack*: +7 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The troll can make three attacks: one with its bite and two with its claws.
...
**Actions*Multiattack.*** The vampire can make two attacks, but only one of them can be a bite attack.
...
**Actions*Multiattack.*** The vampire spawn can make two attacks, but only one of them can be a bite attack.
...
**Actions*Multiattack.*** The fungus makes 1d4 attacks with Rotting Touch.
...
**Actions*Multiattack.*** The demon makes two attacks: one with its beak and one with its talons or two with its spurs.
...
**Actions*Multiattack.*** The Wall Crawler Horror makes two attacks with its hooked claws.
...
**Actions*Multiattack.*** The wight can make two longsword attacks or two longbow attacks. It can use Life Drain in place of one of its longsword attacks.
...
**Actions*Shock.** Melee Spell Attack*: +6 to hit, reach 1 m, one creature.
...
**Actions*Multiattack.*** The wise Owlbear makes two attacks: one with its beak and one with its claws.
...
**Actions*Life Drain.** Melee Weapon Attack*: +7 to hit, reach 1 m, one creature.
...
**Actions*Slam.** Melee Weapon Attack*: +4 to hit, reach 1 m, one target.
...
**Actions*Slam.** Melee Weapon Attack*: +6 to hit, reach 3 m, one target.
...
**Actions*Bite.** Melee Weapon Attack*: +1 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The black bear makes two attacks: one with its bite and one with its claws.
...
**Actions*Beak.** Melee Weapon Attack*: +3 to hit, reach 1 m, one target.
...
**Actions*Tusk.** Melee Weapon Attack*: +3 to hit, reach 1 m, one target.
...
**Actions*Claws.** Melee Weapon Attack*: +2 to hit, reach 1 m, one target.
...
**Actions*Talons.** Melee Weapon Attack*: +4 to hit, reach 1 m, one target.
...
**Actions*Ram.** Melee Weapon Attack*: +5 to hit, reach 1 m, one target.
...
**Actions*Tusk.** Melee Weapon Attack*: +5 to hit, reach 1 m, one target.
...
**Actions*Claw.** Melee Weapon Attack*: +3 to hit, reach 1 m, one target.
...
**Actions*Ram.** Melee Weapon Attack*: +6 to hit, reach 3 m, one target.
...
**Actions*Ram.** Melee Weapon Attack*: +3 to hit, reach 1 m, one target.
...
**Actions*Bite.** Melee Weapon Attack*: +5 to hit, reach 1 m, one creature.
...
**Actions*Talons.** Melee Weapon Attack*: +5 to hit, reach 1 m, one target.
...
**Actions*Gore.** Melee Weapon Attack*: +8 to hit, reach 3 m, one target.
...
**Actions*Talons.** Melee Weapon Attack*: +3 to hit, reach 1 m, one target.
...
**Actions*Claw.** Melee Weapon Attack*: +4 to hit, reach 1 m, one target.
...
**Actions*Gore.** Melee Weapon Attack*: +4 to hit, reach 1 m, one target.
...
**Actions*Bites.** Melee Weapon Attack*: +4 to hit, reach 0 m, one creature in the swarm' \*\*s space.
...
**Actions*Bites.** Melee Weapon Attack*: +4 to hit, reach 0 m, one target in the swarm' \*\*s space.
...
**Actions*Bites.** Melee Weapon Attack*: +5 to hit, reach 0 m, one creature in the swarm' \*\*s space.
...
**Actions*Bites.** Melee Weapon Attack*: +3 to hit, reach 0 m, one target in the swarm' \*\*s space.
...
**Actions*Beaks.** Melee Weapon Attack*: +4 to hit, reach 1 m, one target in the swarm' \*\*s space.
...
**Actions*Multiattack.*** The veteran makes two longsword attacks. If they have drawn a shortsword, they can also make a shortsword attack.
...
**Actions*Rapier.** Melee Weapon Attack*: +3 to hit, reach 1 m, one target.
...
**Actions*Club.** Melee Weapon Attack*: +2 to hit, reach 1 m, one target.
...
**Actions*Scimitar.** Melee Weapon Attack*: +3 to hit, reach 1 m, one target.
...
**Actions*Multiattack.*** The captain makes three melee attacks: two with the scimitar and one with the dagger. Or the captain makes two ranged attacks with daggers.
...
**Actions*Staff.** Melee Weapon Attack*: +1 to hit, reach 1 m, one target.
...
**Actions*Dagger.** Melee or Ranged Weapon Attack*: +5 to hit, reach 1 m or range 6m, one target.
...
**Actions*Dagger.** Melee or Ranged Weapon Attack*: +6 to hit, reach 1 m or range 6m, one target.
...
**Actions*Scimitar.** Melee Weapon Attack*: +3 to hit, reach 1 m, one creature.
...
**Actions*Mace.** Melee Weapon Attack*: +4 to hit, reach 1 m, one target.
...
**Actions*Greataxe.** Melee Weapon Attack*: +5 to hit, reach 1 m, one target.
...
**Actions*Quarterstaff.** Melee Weapon Attack*: +3 to hit (+5 to hit with *Shillelagh*), reach 1 m or range 6m, one target.
...
**Incorporeal Movement**. The creature can move through creatures and objects as if they were difficult terrain. It takes 5 (1d10) damage if it ends its turn
inside an object.
...
**Sleep**: Whenever a character completes a 24-hour period without sleeping at least 8 hours, they must succeed on a Fortitude Saving Throw with DC 17, or become Fatigued. Each additional missed rest will make them even more Fatigued, accumulating the related penalties.
...
**Invisible**: Invisible creatures cannot be perceived by sight.
