...
These are the names of the months starting from what is defined as the beginning of the year:
	...
	\begin{enumerate}
		\item Ianas (season: spring)
		\item Prineva (season: spring)
		\item Marc (season: summer)
		\item Epral (season: summer)
		\item Meea (season: summer)
		\item Vernam (season: autumn)
		\item Ilai (season: autumn)
		\item Arkast (season: autumn)
		\item Cester (season: winter)
		\item Koper (season: winter)
		\item Narava (season: winter)
		\item Raanant* (special)
		\item Kartan (season: spring)
	\end{enumerate}
