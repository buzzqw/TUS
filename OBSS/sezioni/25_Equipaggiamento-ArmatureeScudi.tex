...
Nella prova esce 4,5,2 / 3,4,\cancel{1},\cancel{1}. Toglie i due 1 per Adepto della Magia ma aggiunge un 2 per l'armatura. Nel complesso non ha ottenuto fallimenti critici, grazie ai dadi tolti da Adepto della Magia, ne può ottenere successi critici. Riesce quindi a formulare l'incantesimo (ha ottenuto un 2 e nessun altro 2 o 1).

Se Tups avesse indossato una Mezza armatura la prova sarebbe stata 4,5,2 / 3,4,\cancel{1},\cancel{1} / 1,2 (dall'armatura). Anche togliendo i due 2 rimane un 1 e due 2, abbastanza per fare fallire la Prova di Magia e quindi fallire il lancio dell'incantesimo.
