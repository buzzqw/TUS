...
Sopravvivi e reclama la Legge del Premio e vedrai che con il passare dei livelli acquisirai competenze e abilità fuori dal comune! \emph{Spes ultima dea}!
...
Se hai Intelligenza pari o superiore a 2, scegli un'altra \hyperlink{linguaggi}{lingua} (pag. \pageref{linguaggi}) parlata/scritta oltre al Comune; se hai 3, puoi sceglierne altre 2.
...
La Competenza Armi ti aiuta nel colpire meglio. La Competenza Magica è l'unica cosa che ti permette di usare la magia. Ricorda anche che i punti in Competenze Armi vanno dichiarati a quale \hyperlink{lista.armi}{Lista d'Armi} (pag. \pageref{lista.armi}) sono stati applicati.
...
Passa alle \hyperlink{abilita}{Abilità} (pag. \pageref{abilita}): al primo livello ne scegli due, prestando attenzione ai prerequisiti e alle eventuali Abilità che ti concede la tua razza.
...
Scegli l'\hyperlink{equipaggiamento}{equipaggiamento} (pag. \pageref{equipaggiamento}), l'\hyperlink{equipaggiamento.armature.scudi}{armatura} (pag. \pageref{equipaggiamentoarmature}), le \hyperlink{equipaggiamento.armi}{armi} (pag. \pageref{equipaggiamentoarmi}), lo zaino, due torce, qualche razione di cibo... un peluche... quello che ti sembra indispensabile per l'avventura.
...
Hai il vantaggio che in OBSS le classi non esistono: il personaggio cresce, evolve e impara in base a ciò che fai e sperimenti. Puoi prepararti la \emph{build} a tavolino, ma non avrai mai la certezza che il tuo personaggio si evolva come hai pensato. Lascialo vivere e crescere!
...
\item Aumentate i Punti Ferita massimi e attuali di 1d6+Costituzione e aggiungetene altri 3 se avete dato 1 punto in Competenza Armi. Se il tiro di dado è inferiore a Costituzione, potete prendere come risultato il valore di Costituzione
...
\item Aggiornate il punteggio dei Tiri per Colpire in base al nuovo valore della Competenza Armi, alle Abilità e ai bonus dati dalla Lista d'Armi
...
\item Verificate, in base al nuovo punteggio di Competenza Magica e all'Abilità Adepto della Magia, il \hyperlink{scuoleelivelli}{livello massimo di incantesimo} (pag. \pageref{scuoleelivelli}) lanciabile e i \hyperlink{magiepuntimagia}{Punti Magia disponibili} (pag. \pageref{magiepuntimagia})
...
\item
Descrivi in maniera realistica ciò che fai, aiuterai il Narratore e i compagni intorno a te. È sicuramente meglio che dire \emph{faccio una prova di Consapevolezza}. Esaltati nel descrivere le azioni più importanti, il Narratore ne terrà conto.
...
\item
Lo scopo è divertirsi, far divertire e assaporare la sfida. Non creare un personaggio che sia contro gli altri personaggi o dia sempre fastidio e problemi. Media il tuo desiderio con le necessità del gruppo, perché sempre e \textbf{solo come gruppo} sopravviverete e mai solo come singolo.
