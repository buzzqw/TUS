...
\def \versione {1.0.13} \fontsize{11}{11.5}\selectfont  %la prima è la grandezza del font, la seconda la spaziatura tra riga e riga  %\def \versione {0.99.36} \fontsize{10.5}{12}\selectfont
