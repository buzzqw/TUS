...
\usepackage{hyphenat}
\hyphenation{mate-mati-ca re-cu-pe-ra-re}

% ========== PACCHETTI GRAFICI E COLORI ==========
\usepackage{xcolor}

% Definizione colori del tema OBSS
\definecolor{OBSSblue!10}{RGB}{240,244,247}
\definecolor{OBSSblue!20}{RGB}{215,230,239}
\definecolor{OBSSblue!80}{RGB}{54,107,148}
\definecolor{OBSSblue}{RGB}{30,84,131}
\definecolor{OBSSgold!10}{RGB}{252,248,239}
\definecolor{OBSSgold}{RGB}{218,165,32}
\definecolor{OBSSpurple!10}{RGB}{244,241,247}
\definecolor{OBSSpurple!8}{RGB}{246,243,249}
...
%	\noindent
%	\begin{center}
%		\textcolor{OBSSgold}{\rule{0.1\linewidth}{1pt}} 		{\textbf{\textcolor{OBSSgold}{#1}}} 		\textcolor{OBSSgold}{\rule{0.1\linewidth}{1pt}}
%	\end{center}
%	\pdfbookmark[3]{#1}{#1}
%	\vspace{-1mm}
%	\noindent
...
% Salvataggio ambienti originali
\let\obssoriginaltabular\tabular
\let\obssendinaltabular\endtabular
\let\obssoriginaltabularx\tabularx
\let\obssendoriginaltabularx\endtabularx
\let\obssoriginalxltabular\xltabular
\let\obssendoriginalxltabular\endxltabular

% Ridefinizione ambienti tabella con colori
\renewenvironment{tabular}[1]{%
	\obssgrey%
	\arrayrulecolor{\obsscurrentcolor}%
	\setlength{\arrayrulewidth}{1.5pt}%
	\rowcolors{1}{white}{\obsscurrentcolor!15}% Prima riga bianca, poi alterna
	\obssoriginaltabular{#1}%
}{%
	\obssendinaltabular%
}
...
\renewenvironment{tabularx}[2]{%
	...
	\setlength{\arrayrulewidth}{1.5pt}%
	\rowcolors{1}{white}{\obsscurrentcolor!15}% Prima riga bianca, poi alterna
	\obssoriginaltabularx{#1}{#2}%
}{%
	\obssendoriginaltabularx%
}
...
\renewenvironment{xltabular}[2]{%
	...
	\setlength{\arrayrulewidth}{1.5pt}%
	\rowcolors{1}{white}{\obsscurrentcolor!15}% Prima riga bianca, poi alterna
	\obssoriginalxltabular{#1}{#2}%
}{%
	\obssendoriginalxltabular%
}
