...
\usepackage{multicoltab/multicoltab}
...
\usepackage{wrapfig}
\usepackage{tikz}
\usetikzlibrary{shadows,shapes.misc,calc,shapes.geometric}
...
% Piè di pagina decorativo con ellisse
\fancyfoot[C]{
	\begin{tikzpicture}[baseline=-0.5ex]
		% Linea sinistra
		\draw[thick] (-4,0) -- (-1.7,0);
		% Ornamenti sinistri (simmetrici a quelli destri)
		\draw[thick] (-1.5,0) .. controls (-1.3,0.15) and (-1.1,0.15) .. (-0.9,0);
		\draw[thick] (-1.7,0) .. controls (-1.5,-0.15) and (-1.3,-0.15) .. (-1.1,0);
		% Ellisse con numero
		\node[ellipse, draw, thick, minimum width=1.8cm, minimum height=0.8cm, fill=white] at (0,0) {\textbf{\thepage}};
		% Ornamenti destri (baffo attaccato all'ellisse con punta verso l'alto)
		\draw[thick] (0.9,0) .. controls (1.1,0.15) and (1.3,0.15) .. (1.5,0);
		\draw[thick] (1.1,0) .. controls (1.3,-0.15) and (1.5,-0.15) .. (1.7,0);
		% Linea destra
...
\fancypagestyle{plain}{%
	...
	% Stesso piè di pagina decorativo anche per il pagestyle plain
	\fancyfoot[C]{
		\begin{tikzpicture}[baseline=-0.5ex]
			% Linea sinistra
			\draw[thick] (-4,0) -- (-1.7,0);
...
\NewDocumentCommand{\feat}{m}{
	...
	\index[Abilita]{#1}
	\hypertarget{#1}{}
	\StrSubstitute{#1}{à}{a'}[\tempspell]%
	\StrSubstitute{\tempspell}{è}{e'}[\tempspell]%
	\StrSubstitute{\tempspell}{é}{e'}[\tempspell]%
	\StrSubstitute{\tempspell}{ì}{i'}[\tempspell]%
	\StrSubstitute{\tempspell}{ò}{o'}[\tempspell]%
	\StrSubstitute{\tempspell}{ù}{u'}[\tempspell]%
	\hypertarget{\tempspell}{}%
	\label{#1}
	\vspace{-5.5mm}
	\begin{center}\textbf{\textcolor{OBSSprussia!90!black}{#1}}\end{center}
	\pdfbookmark[3]{\tempspell}{\tempspell}%
	\vspace{-1mm}\noindent
}
...
\NewDocumentCommand{\incantesimo}{m}{
	...
	\StrSubstitute{\tempspell}{ò}{o'}[\tempspell]%
	\StrSubstitute{\tempspell}{ù}{u'}[\tempspell]%
	\hypertarget{inc:\tempspell}{}%
	\label{#1}
	\vspace{-5.5mm}
	\begin{center}\textbf{\textcolor{OBSSprussia!90!black}{#1}}\end{center}
	\pdfbookmark[3]{\tempspell}{inc:\tempspell}%
	\vspace{-1mm}\noindent
}
