...
\usepackage{lmodern} % Latin Modern come font alternativo
\usepackage{textcomp}
...
]{AtkinsonHyperlegibleNext-Regular.ttf} % Carica Latin Modern separatamente
\newfontfamily\lmfont{Latin Modern Roman} % Ridefinisci il comando \textsc
