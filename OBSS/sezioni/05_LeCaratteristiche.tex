...
I mostri più \emph{istintivi} e aggressivi avranno probabilmente punteggi negativi di Intelligenza, ma non per questo sono \emph{stupidi}: semplicemente agiscono in base ai loro schemi naturali. Allo stesso modo, le creature con un basso valore di Costituzione non stanno per morire, ma sono solo \emph{fragili}.
...
Ogni punteggio di Caratteristica in genere va da 0 a 3: un punteggio di 1 è buono, 2 è ottimo, 0 è "normale" e 3 è giudicato \emph{eccezionale}.
...
\subsubsection{Opzionale - Età del personaggio}\index{Opzionale - Età del personaggio}\hypertarget{etadelpersonaggio}{} \label{etadelpersonaggio}
...
\textbf{\emph{I modificatori razziali o di background non possono alzare o abbassare i punteggi oltre +4/-4}}.

\subsubsection{Modalità base}\index{Caratteristiche - Modalità base}\label{modalitabase}
...
Il personaggio così generato acquisisce gratuitamente l'Abilità \hyperlink{Duro a morire}{Duro a morire} (pag. \pageref{Duro a morire}).

\subsubsection{Modalità della Tradizione}\index{Caratteristiche - Modalita' della tradizione}\label{modalitadellatradizione}
...
\subsubsection{Modalità opzionale (per i codardi!)}\index{Caratteristiche - Modalità opzionale per i codardi}\label{modalitapericodardi}
