...
\rowcolor{gray!20}21-23 & Il colore della pelle del personaggio cambia.\\
...
\rowcolor{gray!20}30-32 & Il sesso del Personaggio cambia ogni giorno all'alba.\\
33-34 & La razza o la specie del Personaggio cambiano.\\
\rowcolor{gray!20}35& Il PG viene colpito da una Malattia determinata casualmente, che non può essere curata.\\
...
\rowcolor{gray!20}46-49 & Il personaggio ha una paura incontrollabile di perdere l'oggetto o che venga danneggiato.\\
...
\rowcolor{gray!20}53-54 & Il personaggio deve attaccare la creatura a lui più vicina (probabilità del 5\% ogni giorno).\\
...
\rowcolor{gray!20}86-89& Il PG incomincia a parlare di sé in terza persona.\\
...
\rowcolor{gray!20}95& Il personaggio viene trasformato in una creatura a caso di una specie specifica (probabilità del 5\% ogni giorno).\\
96& Il personaggio viene trasformato in una creatura specifica (probabilità del 5\% ogni giorno).\\
\rowcolor{gray!20}97& Il personaggio non può più usare oggetti magici o Incantesimi con livello oltre 5\\
98& Il personaggio non può più usare oggetti magici o Incantesimi con livello oltre 3\\
\rowcolor{gray!20}99& Il personaggio non può più usare Incantesimi\\
100 & Tira due volte
\end{tabularx}
%}
...
\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
	...
	\item Può attaccare con artiglio o morso causando 1d6 + Forza. Usa la Lista d'Armi Accette e Scuri ed è competente nell'arma.
