...
\mostro{Aboleth}
\hspace{-0.2cm}\begin{tabularx}{\linewidth}{l@{\hspace{8pt}}X} % imposta spazio personalizzato
\rowcolor{gray!20}\textbf{Taglia/Tipo} & Grande aberrazione, malvagio\\
\textbf{Caratt.} & \resizebox{5.5cm}{!}{For 5 Des -1 Cos 2 Int 4 Sag 2 Car 4}\\
\rowcolor{gray!20}\textbf{Punti Ferita} & \resizebox{5.3cm}{!}{199, \textbf{Difesa:} 24, \textbf{Iniziativa:} +4}\\
\textbf{Movimento} & 3 m, nuoto 12 m\\
\rowcolor{gray!20}\textbf{Tiri Salvez.} & \resizebox{5.4cm}{!}{Tempra +12, Riflessi +9, Volontà +12}\\
\textbf{Incant.} & immune incantesimi di Illusione inferiori al 2 livello\\
\rowcolor{gray!20}\textbf{Comp.} & Consapevolezza +10, Storia +12\\
\textbf{Sensi} & Scurovisione 36 m\\
\rowcolor{gray!20}\textbf{Linguaggi} & Aquan, telepatia 36 m\\
...
\begin{description}[noitemsep, topsep=0pt, parsep=0pt, partopsep=0pt, leftmargin=0cm, labelwidth=2.2cm]
	...
	\item[\textbf{Caratt.:}] \resizebox{5.3cm}{!}{For -3 Des 1 Cos 3 Int -2 Sag 0 Car -1}
	\item[\textbf{Punti Ferita:}] 24,  \textbf{Difesa:} 13,  \textbf{Iniziativa:} +1
	\item[\textbf{Movimento:}] 3 m
	\item[\textbf{Tiri Salvez.:}] \resizebox{5.3cm}{!}{Tempra +3, Riflessi +3, Volontà +3}
...
\begin{description}[noitemsep, topsep=0pt, parsep=0pt, partopsep=0pt, leftmargin=0cm, labelwidth=2.2cm]
    ...
    \item[\textbf{Caratt.:}] \resizebox{5.3cm}{!}{For 4 Des 2 Cos 2 Int -3 Sag 1 Car 0}
    \item[\textbf{Punti Ferita:}] 51,  \textbf{Difesa:} 16,  \textbf{Iniziativa:} +2
    \item[\textbf{Tiri Salvez.:}] \resizebox{5.3cm}{!}{Tempra +4, Riflessi +4, Volontà +3}
