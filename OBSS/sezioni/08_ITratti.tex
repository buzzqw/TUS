...
\textbf{Ogni giocatore sceglie 5 Tratti per il proprio personaggio alla creazione del personaggio.} Questi guideranno il personaggio nell'agire e nelle scelte.

\begin{giocatore}[Scegliere i Tratti]
I Tratti non sono il personaggio, non lo bloccano né lo fissano per sempre nel tempo. Un personaggio è sempre in costante evoluzione, così come il suo carattere, la sua morale, il suo comportamento e i suoi desideri. Non essere rigido, ma usa i Tratti per avere suggerimenti da cui trarre ispirazione.
\end{giocatore}
...
Col passare del tempo e delle avventure, i Tratti aumenteranno di valore o potranno essere sostituiti, di concerto tra Narratore e giocatore in base a come viene giocato il personaggio, da altri Tratti. \textbf{Più è alto il valore di un Tratto, più questo è presente e permeante nelle scelte del personaggio}.
...
\item A \textbf{'15'} punti si è legati ad un Patrono
...
Per individuare il Patrono più affine, quello che vi darà i poteri, verificate il vostro Tratto di maggior valore sulla \hyperlink{tabellacollegamentopatronotratto}{Tabella Collegamento Patrono - Tratto} (pag. \pageref{tabellacollegamentopatronotratto}) e individuate il Patrono che ha quel Tratto come maggiormente caratterizzante. In caso il Tratto fosse condiviso tra più Patroni, verificate gli altri Tratti e, in base alla somiglianza, scegliete il Patrono.
...
\noindent\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
	...
	\item \textbf{Impulsivo}: Tende ad agire e reagire senza pensare troppo alle conseguenze.
        \item \textbf{Indeciso}: Non riesce rapidamente a prendere una decisione, soffermandosi troppo nel ponderare le scelte.
	...
	\item \textbf{Prudente}: Pondera attentamente le situazioni difficili o pericolose.
        \item \textbf{Sospettoso}: È convinto che tutti abbiano interesse a danneggiarlo.
	\item \textbf{Testardo}: Determinato e persistente nel raggiungere i propri obiettivi, nonostante le difficoltà.
        \item \textbf{Vanitoso}: È certo delle sue eccezionali qualità, capacità e aspetto.
...
\begin{center}
\includegraphics[height=0.25\linewidth]{immagini/troll.png}
\end{center}
