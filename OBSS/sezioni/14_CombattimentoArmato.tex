...
\hline
Attiv.: &Dispari.\\
\emph{Effetto}:& L'avversario subisce -4 al primo attacco contro di te entro la fine del prossimo round.\\
...
\textit{Saurovallo addestrato, senza Napoleone Bonaparte, con sella e finimenti, da qualche parte nella fu Italia (B.I.C.)}
	\end{minipage}
\end{figure}
