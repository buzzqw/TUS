...
\begin{itemize}[leftmargin=*]
	...
	\begin{itemize}[leftmargin=*]
		...
		\item \textbf{Valutazione Strategica} - Attiv.: \textbf{\emph{Pari}}. \emph{Effetto}: Il prossimo attacco a segno entro la fine del prossimo round infligge un danno critico in più. \emph{Critico}: Come sopra, ma infligge due danni critici; il round successivo esegui una Azione in meno.
	\end{itemize}
	...
	\begin{itemize}[leftmargin=*]
		...
		\item \textbf{Intuizione Letale} - Attiv.: \textbf{\emph{Pari}}. \emph{Effetto}: Il prossimo attacco andato a segno entro la fine del round successivo infligge danni critici massimizzati. \emph{Critico}: Come sopra, ma computi 2 danni critici massimizzati ed esegui una Azione in meno.
