\section{Combattimento Armato}\label{sec:combattimento-armato}\index{Combattimento Armato}
...
\begin{changemargin}{0.3cm}{0.3cm}\begin{enfasi}{L'esitazione è la morte del vantaggio (Magic, V.E. Schwab)} \end{enfasi}\end{changemargin}\medskip
...
Se ha ottenuto un \textbf{successo critico nel tiro dell'iniziativa} allora in quel round potrà usare una Azione di Reazione od Immediata in più, se ha tirato almeno \textbf{due successi critici} la sua grande reattività gli permette di eseguire una Azione in più.\index{Critico nell'Iniziativa} Se invece ha tirato un \textbf{fallimento critico} l'estrema lentezza gli impedirà di usare la Reazione o Azione Immediata, se tira tre 1 farà una Azione in meno.\index{Fallimento critico nell'iniziativa}\index{Iniziativa, tiro critico}
...
\subsection{Opzionale - Variante Iniziativa}\index{Opzionale - Variante Iniziativa}\hypertarget{varianteiniziativa}{}\label{varianteiniziativa}
...
Se colpisci, \textbf{ogni due 6 tirati} (contando quelli del Tiro per Colpire e quelli successivi scaturiti dal fatto di aver tirato 6), l'arma fa del danno in più ovvero un Tiro Critico. Tira nuovamente solo il dado del danno dell'arma, senza altri modificatori, ogni due 6 tirati nel Tiro per Colpire.\index{Tiro Critico}
...
\subsection{Tiro Critico Variante}\index{Tiro Critico Variante}\hypertarget{tirocriticovariante}{}\label{tirocriticovariante}
...
\subsubsection{Opzionale - Variante attacchi multipli}\index{Opzionale - Variante attacchi multipli}\label{varianteattacchimultipli}\hypertarget{varianteattacchimultipli}{}
...
l'avversario deve essere entro 2 Azioni di movimento (18 o 12 metri solitamente) ed a non meno di 3 metri, il terreno non deve essere difficile. Si deve correre fino ad essere a distanza di mischia.
...
In caso l'attacco manchi (di almeno 5) tirare un d8 e consultare questo schema per capire dove la fiala è caduta:
...
\begin{center}
	...
	\textit{Evoluzione delle armi ad asta}
\end{center}
...
Questa Opzione permette un combattimento meno incentrato sul danno ma più sulle manovre e la tattica. 
Il giocatore tiene conto dei Tiri Critici che tira e che non applica al danno, in tre round alla volta, ricominciando il conto al termine del terzo round o quando li usa e il conto è a zero.

Ogni round può scalare uno o più Tiri Critici accumulati per eseguire Azioni Critiche. L'uso delle Azioni Critiche deve essere contro l'avversario al quale si sono effettuati i Tiri Critici.

L'elenco propone l'elenco delle Azioni Critiche di Tiri Critici consumati. Non si può avere più di 6 Tiri Critici accumulati. L'attivazione di queste Azioni Critiche costa una Reazione.

Usate questo elenco come delle linee guida per stimolare il personaggio a creare un suo stile di combattimento.
...
\hline
\textbf{\#} & \textbf{Attacchi agli occhi}\\
\hline
\textbf{1} & Sabbia negli occhi. Entro la fine del tuo prossimo round l'avversario ha -2 al primo Tiro per Colpire\\
\textbf{2} & Graffio agli occhi. Entro la fine del tuo prossimo round l'avversario ha -4 al Tiro per Colpire\\
\textbf{3} & Bersaglio abbagliato. Tira 1d6, con 1-2-3 l'avversario ha mancato il suo attacco. Dura fino alla fine del prossimo round.\\
\textbf{4} & Bersaglio accecato. Per 1d6 round, l'avversario considera tutti come invisibili.\\
\textbf{5} & Orbo. L'avversario esegue un Tiro Salvezza su Tempra con DC pari al tuo ultimo Tiro per Colpire, se fallisce è accecato permanentemente, altrimenti subisce gli effetti del punto 4.\\
\hline
\textbf{\#} & \textbf{Attacchi all'arma}\\
\hline
\textbf{1} & Colpisci l'arma. L'avversario esegue un Tiro Salvezza su Tempra DC 15, $ \pm 2 $ per taglia dell'arma rispetto a media, oppure lascia cadere l'arma\\
\textbf{2} & Arma danneggiata. L'arma dell'avversario infligge una categoria di danno in meno\\
\textbf{3} & Colpo alla mano. A causa del dolore entro la fine del tuo prossimo round  l'avversario perde i primi due attacchi\\
\textbf{4} & Disarmi l'avversario. L'avversario lascia cadere l'arma\\
\textbf{5} & Mano compromessa. L'avversario fino all'alba del giorno successivo ha -4 al Tiro per Colpire\\
\hline
\textbf{\#} & \textbf{Spintoni e Slanci}\\
\hline
\textbf{1} & Allontani l'avversario di 3 metri, $ \pm 1$ per taglia di differenza\\
\textbf{1} & Ti puoi spostare di una Azione di Movimento come Reazione. Tratti il terreno come difficile\\
\textbf{2} & Come punto 1 ma la distanza iniziale è di 6 metri\\
\textbf{2} & Ti puoi spostare di una Azione di Movimento come Reazione\\
\textbf{3} & Come punto 1 ma la distanza iniziale è di 9 metri\\
\textbf{4} & Come punto 3 e puoi spostarti con l'avversario\\
\hline
\textbf{\#} & \textbf{Sgambetti}\\
\hline
\textbf{1} & Spallata. L'avversario esegue un Tiro Salvezza su Tempra DC 15, $ \pm 4 $ per taglia differenza o cadere prono\\
\end{tabularx}
\noindent\begin{tabularx}{0.5\textwidth}{lX}
\textbf{2} & Sgambetto. L'avversario esegue un Tiro Salvezza su Riflessi DC 19, $ \pm 2 $ per taglia differenza o cadere prono\\
\textbf{3} & Spinta. L'avversario esegue un Tiro Salvezza su Tempra DC 23, $ \pm 2 $ per taglia differenza o cadere prono. Se il Tiro Salvezza riesce viene allontanato di 1d6 metri\\
\textbf{4} & Urto. L'avversario esegue un Tiro Salvezza su Tempra con DC pari al tuo ultimo Tiro per Colpire, $ \pm 2 $ per taglia differenza o cadere prono. Se il Tiro Salvezza riesce viene allontanato di 1d10 metri\\
\hline
\textbf{\#} & \textbf{Proiettili}\\
\hline
\textbf{Vari} & Per ogni Tiro Critico usato aggiungi una ulteriore gittata alla tua arma\\
\textbf{Vari} & Per ogni due Tiro Critico usato aggiungi +4 al prossimo Tiro per Colpire entro la fine del round successivo\\
\textbf{5} & \emph{Freccia Kennedy}. Entro la fine del tuo prossimo round il primo proiettile ignora qualsiasi copertura o ostacolo e se fisicamente possibile colpisce l'avversario\\
\hline
\textbf{\#} & \textbf{Furia}\\
\hline
\textbf{1} & Incitare i compagni. I tuoi compagni entro 6 metri hanno al loro primo attacco +2 al Tiro per Colpire\\
\textbf{2} & Berserker. Un tuo compagno entro sei metri può eseguire una Azione di Attacco contro un avversario in mischia al costo di una Reazione\\
\end{tabularx}
\noindent\begin{tabularx}{0.5\textwidth}{lX}
\textbf{3} & Scossa. Un tuo compagno, entro 6 metri, può usare una Reazione per eseguire una Azione di Movimento trattando il terreno come difficile\\
\textbf{4} & Gloria. I tuoi compagni entro 6 metri hanno +2 al Tiro per Colpire entro la fine del loro prossimo round\\
\textbf{5} & Gloria!. I tuoi compagni entro 9 metri hanno +4 al Tiro per Colpire entro la fine del loro prossimo round\\
\hline
\textbf{\#} & \textbf{Difesa!}\\
\hline
\textbf{1} & Fino alla fine del tuo prossimo round hai +2 alla Difesa.\\
\textbf{2} & Fino alla fine del tuo prossimo round tutti i compagni nel tuo raggio di mischia hanno +2 alla Difesa\\
\textbf{3} & Fino alla fine del tuo prossimo round un compagno ha +8 alla Difesa.\\
\textbf{4} & Fino alla fine del tuo prossimo round tutti i compagni nel raggio di 9 metri hanno +4 alla Difesa\\
\textbf{5} & Per 1d6 round tutti i tuoi compagni hanno +4 alla Difesa
\end{tabularx}
...
\subsubsection{Opzionale - Effetti critici diversi}\index{Opzionale - Effetti critici diversi}\label{effetticriticidiversi}\hypertarget{effetticriticidiversi}{}
...
\subsection{Opzionale - Gestione Universale Manovre}\index{Opzionale - Gestione Universale Manovre}
...
\noindent\begin{tabularx}{0.5\textwidth}{lX}
\hline
\multicolumn{2}{c}{\textbf{Manovre livello 4}}\\
\hline
&\textbf{Schivata Acrobatica}\\
Attiv.:& Mancato con un dispari.\\
\emph{Effetto}:& +1 ai Tiri Salvezza sui Riflessi fino al prossimo turno.\\
\emph{Critico}:& +2 ai Tiri Salvezza sui Riflessi.\\
\hline
&\textbf{Finta e Riposizionamento}\\
Attiv.:& Mancato con un pari.\\
\emph{Effetto}:& Muovi 1 metro senza provocare attacchi di opportunità.\\
\emph{Critico}:& Come sopra ma di muovi 2 metri.\\
\hline
&\textbf{Colpo Distraente}\\
\hline
Attiv.&: Mancato.\\
\emph{Effetto}:& +1 alla Difesa contro l'avversario fino al fine del prossimo round.\\
\emph{Critico}:& L'avversario considera il personaggio come se avesse copertura leggera.\\
\hline
&\textbf{Intralcio Rapido}\\
\hline
Attiv.:& Mancato con un dispari.\\
\emph{Effetto}:& L'avversario riduce di 1 metro il suo movimento nel prossimo round.\\
\emph{Critico}:& il prossimo movimento entro il prossimo round dell'avversario lo considera come terreno difficile.\\
\hline
&\textbf{Apertura Tattica}\\
\hline
Attiv.:& Mancato con un pari.\\
\emph{Effetto}:& Un alleato ottiene +1 al prossimo Tiro per Colpire contro l'avversario.\\
\emph{Critico}:& L'alleato ottiene +2 al Tiro per Colpire.\\
\end{tabularx}
\noindent\begin{tabularx}{0.5\textwidth}{lX}
\hline
\multicolumn{2}{c}{\textbf{Manovre livello 6}}\\
\hline
&\textbf{Reazione Rapida}\\
Attiv.: &Mancato.\\
\emph{Effetto}:& il personaggio può bere una pozione.\\
\emph{Critico}:& Il personaggio può somministrare una pozione ad un alleato adiacente.\\
\hline
&\textbf{Finta Avanzata}\\
\hline
Attiv.&: Pari.\\
\emph{Effetto}:& Aggiungi il modificatore di Intelligenza o Saggezza alla Difesa contro l'avversario fino all'inizio del prossimo round.\\
\emph{Critico}:& Aggiungi il modificatore di Intelligenza e Saggezza al prossimo Tiro per Colpire contro l'avversario fino all'inizio del prossimo round.\\
\hline
&\textbf{Supporto Coordinato}\\
\hline
Attiv.&: Pari.\\
\emph{Effetto}:& Un alleato adiacente ottiene un bonus al Tiro per Colpire pari al modificatore di Intelligenza del personaggio.\\
\emph{Critico}:& Il bonus si applica a due alleati a te adiacenti.\\
\hline
&\textbf{Contrattacco Immediato}\\
\hline
Attiv.&: Dispari.\\
\emph{Effetto}:& Se il Tiro per Colpire del fallimento avrebbe colpito un avversario adiacente, infliggi danni pari al modificatore di Forza.\\
\emph{Critico}:& Infliggi danni pari al doppio del modificatore di Forza.\\
\hline
&\textbf{Distrazione Sonica}\\
\hline
Attiv.:& Dispari.\\
\emph{Effetto}:& Un alleato afferrato o bloccato può effettuare una prova per liberarsi.\\
\emph{Critico}:& Come sopra e può muoversi di 1 metro.\\
\hline
\multicolumn{2}{c}{\textbf{Manovre livello 8}}\\
\hline
&\textbf{Concentrazione guerriera}\\
\hline
Attiv.:& Mancato.\\
\emph{Effetto}:& +2 ai Tiri per Colpire in mischia fino alla fine del prossimo round.\\
\emph{Critico}:& Fino alla fine del prossimo round se colpisci causi un Danno Critico in più.\\
\hline
&\textbf{Elusione Perfetta}\\
\hline
Attiv.:& Dispari.\\
\emph{Effetto}:& +2 alla Difesa fino al prossimo turno.\\
\emph{Critico}:& Il prossimo attacco in mischia da quell'avversario manca automaticamente.\\
&\textbf{Analisi dell'Avversario}\\
\hline
Attiv.:& Dispari.\\
\hline
\emph{Effetto}:& Puoi effettuare una Prova di Conoscenze per ottenere informazioni sull'avversario.\\
\emph{Critico}:& Un alleato può effettuare la stessa prova.\\
\hline
&\textbf{Terreno Instabile}\\
\hline
Attiv.:& Pari.\\
\emph{Effetto}:& Fino alla fine del prossimo round consideri il terreno come difficile ed hai +4 al Tiro per Colpire\\
\emph{Critico}:& Non puoi muoverti entro la fine del prossimo round ma se colpisci causi due danni critici in più.\\
\end{tabularx}
\noindent\begin{tabularx}{0.5\textwidth}{lX}
\hline
&\textbf{Attacco a Sorpresa}\\
\hline
Attiv.:& Pari.\\
\emph{Effetto}: &Usando una Reazione puoi effettuare un Attacco con il medesimo Tiro per Colpire dell'ultimo attacco.\\
\emph{Critico}: &Se sufficiente il tuo Tiro per Colpire colpisce un altro avversario in mischia.\\
\hline
\multicolumn{2}{c}{\textbf{Manovre livello 10}}\\
\hline
&\textbf{Manovra Laterale}\\
\hline
Attiv.:& Mancato.\\
\emph{Effetto}: &Ti muovi di 1 metro.\\
\emph{Critico}: &Ti muovi fino a 4 metri, ma il prossimo round esegui una Azione in meno.\\
\hline
&\textbf{Apertura Devastante}\\
\hline
Attiv.:& Dispari.\\
\emph{Effetto}:& Un alleato ottiene +4 al Tiro per Colpire contro l'avversario fino alla fine del tuo prossimo round.\\
\emph{Critico}: &Due alleati ottengono il bonus, ma il personaggio subisce -4 al Tiro per Colpire fino alla fine del prossimo round.\\
\hline
&\textbf{Intimidazione Superiore}\\
\hline
Attiv.: &Dispari.\\
\emph{Effetto}:& L'avversario subisce -1d6 al primo attacco contro di te entro la fine del prossimo round.\\
\emph{Critico}:& Entro la fine del prossimo round l'avversario in mischia non può fare danno critico contro di te.\\
\hline
&\textbf{Ferita Sanguinante}\\
\hline
Attiv.: &Pari.\\
\emph{Effetto}: & L'avversario subisce +1 al sanguinamento.\\
\emph{Critico}: & +2 al sanguinamento e il personaggio subisce danni pari al modificatore di Forza.\\
\hline
&\textbf{Valutazione Strategica}\\
\hline
Attiv.: & Pari.\\
\emph{Effetto}:& Il prossimo attacco a segno entro fine del round prossimo infligge un danno critico in più.\\
\emph{Critico}:& Come sopra e due danni critici ma il round successivo esegui una Azione in meno.\\
\hline
\multicolumn{2}{c}{\textbf{Manovre livello 12}}\\
\hline
&\textbf{Assalto Incessante}\\
\hline
Attiv.:& Mancato.\\
\emph{Effetto}:& Il prossimo round hai un +1 cumulativo al Tiro per Colpire per volta che attacchi.\\
\emph{Critico}: &Il prossimo round hai solo 1 Azione. Se la usi per attaccare e colpisci causi 2 danni critici in più.\\
\hline
&\textbf{Attacco Predittivo}\\
\hline
Attiv.: &Dispari.\\
\emph{Effetto}: &Il prossimo round il primo attacco portato manca, se colpisci con un attacco successivo infliggi 2 danni critici aggiuntivi.\\
\emph{Critico}: &Come sopra ma 3 danni critici ed esegui 1 Azione in meno nel round.\\
\end{tabularx}
\noindent\begin{tabularx}{0.5\textwidth}{lX}
\hline
&\textbf{Grido di Guerra Potente}\\
\hline
Attiv.: &Dispari.\\
\emph{Effetto}: &Gli alleati entro 9 metri ottengono +1d6 al Tiro per Colpire entro la fine del tuo prossimo round.\\
\emph{Critico}: &Come sopra ma +2d6, e il personaggio esegue una sola Azione.\\
\hline
&\textbf{Intuizione Letale}\\
\hline
Attiv.:& Pari.\\
\emph{Effetto}:& Il prossimo attacco andato a segno entro la fine del round successivo infligge danni critici massimizzati.\\
\emph{Critico}: &Come sopra ma computi 2 danni critici massimizzati, ma esegui una Azione in meno.\\
\hline
&\textbf{Furia Incontenibile}\\
\hline
Attiv.:& Pari.\\
\emph{Effetto}: &Confronta il Tiro per Colpire con un avversario adiacente per capire se l'hai colpito, se si sommi anche un danno critico.\\
\emph{Critico}: &Fino alla fine del prossimo round hai -4 alla Difesa, +1d6 al Tiro per Colpire e ogni attacco andato a segno causa un danno critico aggiuntivo.
\end{tabularx}
...
%\textit{Saurovallo addestrato, senza Napoleone Bonaparte, con sella e finimenti, 105 mo (75+30) (B.I.C.)}
%	\end{minipage}
%\end{figure}
