...
Quando dovete stabilire una difficoltà, partite pensando che la prova debba essere affrontata da una persona \emph{normale}. Non pensate \emph{se la dovessi fare io allora la prova sarebbe impossibile}, \emph{se la prova la fa Arsenio Lupin la prova è facilissima}. Partite dal presupposto che la difficoltà debba racchiudere in sé tutti gli elementi circostanziali.
...
\item
I \textbf{6 esplodono}, ovvero se nella prova dei 3d6 un dado fa sei, somma il risultato e ritira; se fa 6 nuovamente, somma il risultato e ritira ancora e ancora...
\item
...
\item \textbf{Tirare 3 volte 6 con i primi tre dadi è un successo}, sia nelle Prove di Competenza, nei Tiri Salvezza e nei Tiri per Colpire, indipendentemente dal risultato finale.\index{Tirare tre volte 6}

\item \textbf{Tirare 3 volte 1 con i primi tre dadi è un fallimento}, sia nelle Prove di Competenza, nei Tiri Salvezza e nei Tiri per Colpire, indipendentemente dal risultato finale. \index{Tirare tre volte 1}
...
Una prova può essere ripetuta\index{Ripetere una prova}\index{Rifare una prova} finché non mutano le condizioni che permettono di ripeterla.

\subsubsection{Successo Critico - Fallimento Critico}\index{Successo Critico - Fallimento Critico}

Se la prova viene \textbf{superata almeno di 8} rispetto alla difficoltà stabilita, il Narratore la considererà un Successo Critico.
...
Viceversa, se la prova fallisce \textbf{di almeno 8 punti}, il Narratore potrebbe descrivere come è miseramente fallita e come il risultato pessimo influenzi l'Azione e quelle successive.
...
Non fate che siano le prove a governare il vostro gioco. \textbf{Fate giocare i giocatori}, fateli recitare, fateli partecipare e, in base a quanto dicono, stabilite se la prova è passata o meno.
...
In questo caso il personaggio effettua la prova indicata, la cui \textbf{difficoltà (DC) è pari a 10} + il punteggio della Caratteristica + Competenza oppure Tiro Salvezza (come indicato dalla prova) + modificatori (bonus/penalità) contingenti.

Chi ottiene il valore più alto vince; in caso di parità vince chi ha il valore più alto nella Competenza, poi nella Caratteristica e infine l'eventuale \emph{avversario}. \index{DC Statica nelle prove contrapposte}\index{Prova Contrapposte}
...
\item - \textbf{Intimidire}: Intimidire Vs Tiro Salvezza su Volontà (con modificatore di Carisma)
\item - \textbf{Rubare}: Mani di Fata Vs Consapevolezza, o Mani di Fata se posseduta
\item - \textbf{Slegarsi da delle corde}: Usare corda Vs Artista della fuga
...
Ogniqualvolta la \textbf{Prova} o \textbf{Prova Contrapposta} riguarda una \textbf{Caratteristica} e non anche una Competenza, fate la prova (3d6) sommando alla Caratteristica più adeguata il Tiro Salvezza più adatto.
...
Qualora la Prova sia contrapposta a un \textit{avversario statico}, ovvero non a una creatura dotata di Caratteristiche e Competenze, ma a una serratura o a un salto da compiere..., allora si esegue la prova confrontando 3d6 + la Caratteristica interessata + la Competenza Attiva (TS/CM/CA) o Competenza Base (Disattivare Congegni, Atletica...) più idonea con la difficoltà (\textbf{DC}) stabilita dal Narratore.
...
Il modificatore nelle \textbf{prove dinamiche}\index{Prove dinamiche} si usa quando la prova viene fatta tirando i 3d6. In questo caso si potranno sommare bonus o penalità (-1, +2...) o addirittura tirare dadi in più o in meno (+1d6, -2d6), fino a non tirare dadi (con 3d6 di penalità).
...
\textbf{Se il personaggio non ha impellenti limiti di tempo}, ovvero può dedicare almeno 10 minuti per lavorarci (60 round), può considerare di prendere 14, come se avesse fatto la prova e tirato 14 con i 3d6. \label{prendere14}

\textbf{Se il tempo diventa un fattore da non considerare}, ovvero il personaggio ha almeno 1 ora per pensare e lavorare e non ha alcuna penalità o rischio, può considerare di aver tirato 18 (ma non c'è nessuna esplosione di dadi o Successo Critico anche se il totale è 18).\label{prendere18}

\begin{narratore}[Consiglio di lettura]
Consiglio a tutti di leggere l'ottimo articolo di Lorenzo Bertini \href{https://dietroschermo.wordpress.com/2022/03/10/elogio-del-10-e-del-20}{Elogio del 10 e del 20} per una disamina critica e intelligente sul successo e fallimento delle prove.
\end{narratore}
...
Si può aiutare un amico in una prova dandogli supporto e suggerimenti. L'aiutante deve effettuare la \textbf{medesima prova} con un bonus di +1d6; se riesce, non ottiene effetti, ma concede un +1 alla prova del compagno. Se ottiene un Successo Critico, il bonus è di +2. L'aiutante esegue la prova come Reazione nel round in cui viene effettuata la prova effettiva. Effettuare questa \textit{prova} costa la Reazione a chi aiuta.

Più personaggi possono aiutare lo stesso personaggio; i bonus di questo tipo sono cumulabili fino a un bonus pari a un quarto della difficoltà da battere (es. +6 nel caso di difficoltà 25).\index{Aiutare un altro}
...
Non fate tirare dadi per prove che non hanno possibilità di fallire, che non generano \textbf{problemi} se falliscono o che possono essere ritentate senza problemi. Fate tirare i dadi ogniqualvolta la prova può avere un risultato \textbf{spettacoloso}, \textbf{fallimentare} o innesca ulteriori scene. Fate godere il giocatore del successo o temere il fallimento critico.
...
Una \textbf{Prova con Rischio} si richiede per prove di particolare tensione e urgenza, in cui è più importante il risultato finale del rischio che si corre. Questa richiesta va fatta prima di tirare i dadi.
...
Le Competenze che hanno un \textbf{*} a fianco al nome, come \textbf{Acrobatica*}, hanno le penalità alla prova dovute all'armatura portata.
...
Arrampicarsi, scalare o scendere da una superficie impervia equivale a muoversi in un \textbf{terreno doppiamente difficile}.
...
\noindent\begin{tabularx}{\linewidth}{Xl}
 ...
 \rowcolor{gray!20}Superficie scivolosa&+4\\
	{\resizedown{\linewidth}{Parete grezza con appigli, mattoni sporgenti}}&+12\\
...
Per riconoscere le capacità di un oggetto magico è necessaria una prova di \textbf{Arcana} a difficoltà 20 per avere indicazioni di massima sui poteri e sugli ambiti di utilizzo; solo con un risultato di almeno 25 nella prova è possibile apprenderne i dettagli, i bonus magici e le cariche. \textbf{10 minuti}. Con punteggio Arcana 6 impiega 5 minuti, con 12 impiega 1 minuto, con Arcana 18 impiega 1 Round per eseguire la prova.
...
Mentre viene lanciato è necessaria una prova di \textbf{Arcana} a DC pari a 10 + livello dell'incantesimo. Costa una \textbf{Reazione}. Se effettuata assieme al lancio di un \hyperlink{Controincantesimo}{Controincantesimo}, non costa Reazione.
...
In un \textbf{salto in lungo} la punta più alta del salto è pari a 1/3 della lunghezza saltata. Se esegui un salto in lungo di 3 metri, a metà salto sei in alto di 1 metro.
...
È possibile con una prova di \textbf{Erboristeria} a DC uguale al fattore di rarità della pianta, oppure al TS che questa concede in caso di Veleni.
...
Cercare di muoversi silenziosamente non costa Azioni, è \emph{compreso} nell'Azione di Movimento usata per spostarsi. Il terreno viene però trattato come difficile e, se già lo fosse, diviene doppiamente difficile. Muoversi a piena velocità cercando di non fare rumore impone alla prova di Furtività una penalità di 2d6.
...
È una prova di \textbf{Gestire Animali} a DC 12+2*GS dell'animale. Impiega 1 minuto ogni 3 di DC, con 6 punti il tempo è 1 minuto ogni 6 di DC, con 12 è 1 minuto ogni 10 DC per eseguire la prova. La creatura deve avere Intelligenza pari a -3 o superiore.

\titlespacing*{\subsubsection}{0pt}{0.5em}{0.5em}\subsubsection*{Nuotare*}\index{Nuotare}\label{compnuotare}

In acque calme DC 10, in acque mosse DC 15, in acque molto mosse DC 20, in acque tempestose DC 25. La prova è necessaria per stare a galla o nuotare. Nuotare in acqua si considera \textbf{terreno difficile}.
...
Una prova riuscita (DC 15) fa recuperare 1d4 Punti Ferita \textbf{dopo uno scontro}, se il personaggio non è morente, oppure concede un +2 a un Tiro Salvezza su Tempra per resistere a un veleno. Va effettuata entro 1 Turno dal termine del combattimento. Costo: \textbf{2 minuti}.
...
Una prova riuscita (base DC 13) per \textbf{prendersi cura per 8 ore} di un paziente fa recuperare a questo il doppio dei Punti Ferita, con un minimo di 4, e concede un nuovo Tiro Salvezza su Tempra per debellare Malattie naturali o Veleni già in corso.
