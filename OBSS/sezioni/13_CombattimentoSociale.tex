...
Il confronto avviene non tramite armi, ma cercando di \emph{convincere} l'avversario.
...
Il Narratore, in base al livello del PNG, stabilirà quanti successi consecutivi sono necessari per convincerlo. In linea di massima è necessario 1 + 1 successo ogni due livelli del PNG.\index{Successi necessari per convincere} Il numero di successi può essere modificato in base alle convinzioni, alle promesse, ai patti e ai rapporti interpersonali che l'avversario ha riguardo alla situazione.
