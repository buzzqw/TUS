...
\item Se non esplicitato diversamente, i Punti Ferita Temporanei scompaiono dopo un'ora da quando sono stati aggiunti.

\item I Punti Ferita Temporanei vanno tolti per primi quando si viene feriti.

\end{itemize}

Un'arma o un effetto che causa danni non letali infligge \hyperlink{recuperopuntiferitanonletali}{ferite temporanee}\label{feritetemporanee}.
