...
Lo stesso principio vale per la \textbf{Prova di Magia} che si esegue tirando 3d6 + Competenza Magica + modificatore di caratteristica per incantesimi + 1*Adepto della Magia ed il risultato deve superare una difficoltà pari 10 + Livello di Magia*x2 manifestata. L'armatura aggiunge +4 di difficoltà per grado (L/M/P) di \emph{pesantezza}. \index{Prova di magia alternativa}
