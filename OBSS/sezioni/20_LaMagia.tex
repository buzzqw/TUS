...
\subsubsection{Componenti}\index{Componenti}\label{magiecomponenti}\index{Incantesimi, Componenti}
...
\textbf{Verbale (V)}\index{Componenti Incantesimi}
...
\textbf{Materiale (M)}\index{Componenti Incantesimi}
...
\subsubsection{Opzionale - Componenti come Offerta}\index{Opzionale - Componenti come Offerta}\label{componenticomeofferta}\hypertarget{componenticomeofferta}{}
...
\textbf{Tabella: esempio Incantesimi Conosciuti ed Appresi}\index[Tabelle]{Tabella esempio Incantesimi Conosciuti ed Appresi}
...
\subsubsection{Massimo livello di incantesimo lanciabile}\hypertarget{scuoleelivelli}{}\index{Livello Incantesimi per Abilità}\label{magieaccessoallelistedimagia}\index{Incantesimi, Massimo livello di incantesimo lanciabile}\index{Massimo livello di incantesimi lanciabili}\label{scuoleelivelli}
...
Per ogni tiro critico o critico magico che si è subito nel round la Prova di Magia viene fatta con 1d6 aggiuntivo.\index{Danno critico se si lancia incantesimo}. Eventuali Fallimenti Critici o Successi Critici vengono presi in considerazione.
...
L'incantatore può \textbf{ignorare un dado tirato} nella Prova di Magia per \textbf{ogni due volte} che ha preso \textbf{Adepto della Magia}.\index{Scartare dadi nella Prova di Magia}

Se nell'insieme di dadi lanciati ci sono \textbf{almeno due 1} oppure \textbf{un 1 e due 2} saranno successe brutte cose, questo caso viene chiamato \textbf{Fallimento Critico Magico}\index{Fallimento Critico Magico}, l'incantesimo non si manifesta ed \textbf{i Punti Magia sono spesi}.
...
%\subsubsection{Opzionale - Magia Suprema}\index{It's over 9000!}\index{Opzionale - Magia Suprema}
%\label{opzionalemagiasuprema}\hypertarget{opzionalemagiasuprema}{}

%- \textbf{Magia Suprema}\index{Magia suprema}\hypertarget{magiasuprema}{}: se si vuole che gli incantatori di alto livello dominino la magia fate che ogni 4 punti di Competenza Magica il giocatore aggiunga 1d6 alla Prova di Magia ed allo stesso tempo possa ignorare un dado tirato nella prova.

%Questa opzione rende la Prova di Magia più vantaggiosa più si sale di esperienza e Competenza Magica.

\subsubsection{Fallimento Critico nella Prova di Magia}\index{Fallimento Critico nella Prova di Magia}\label{magiefallimentocriticonellaprovadimagia}\index{Incantesimi, Fallimento Prova di Magia}\hypertarget{magiefallimentocriticonellaprovadimagia}{}
...
\subsubsection{I Punti Magia}\index{I Punti Magia}\label{magiepuntimagia}\index{Incantesimi, Punti Magia}\hypertarget{magiepuntimagia}{}
...
\subsubsection{Opzionale - Il vero costo della Magia}\index{Opzionale - Il vero costo della Magia}
...
\subsubsection{Studiare gli incantesimi}\index{Studiare gli incantesimi}\label{magiestudiareincantesimi}\index{Incantesimi, Studiare}
...
\subsubsection{Cambiare gli Incantesimi}\index{Cambiare gli Incantesimi}\label{Cambiare gli Incantesimi}
...
\subsubsection{Tiro per Colpire con le Magie}\index{Tiro per Colpire con Incantesimi}\label{magietiropercolpireconlemagie}\index{Incantesimi, Tiro per Colpire}\hypertarget{magietiropercolpireconlemagie}{}
...
\subsubsection{Opzionale - Tiro per Colpire con Incantesimi}\index{Opzionale - Tiro per Colpire con Incantesimi}
...
\subsubsection{Tiro Salvezza - Resistere all'incantesimo}\index{Tiro Salvezza - Resistere all'Incantesimo}\index{Tiro Salvezza Incantesimi}\label{magietirosalvezza}\hypertarget{magietirosalvezza}{}
...
\item
Se il Tiro Salvezza riesce e tiri almeno due 6 nel lancio dei dadi ottieni un \textbf{Successo Critico Salvezza}\index{Successo Critico Incantesimi}.
...
\item
Se il Tiro Salvezza fallisce e tiri almeno due 1 oppure un 1 e due 2 nel lancio dei dadi ottieni un \textbf{Fallimento Critico Salvezza}\index{Fallimento Critico Incantesimi}. \index{Due 1 nei Tiri Salvezza magici}
...
\subsubsection{Contrastare gli Incantesimi}\index{Contrastare gli incantesimi}\label{contrastareincantesimi}\hypertarget{contrastareincantesimi}{}
...
\subsubsection{Concentrazione}\index{Colpito mentre concentrato}\index{Concentrazione}\label{magieconcentrazione}\hypertarget{magieconcentrazione}{}
...
Se vieni colpito\index{Colpito mentre tieni la concentrazione} mentre sei concentrato su un incantesimo devi effettuare una Prova di Magia ed ottenere almeno 1 Successo Critico Magico, +1 per ogni critico subito oppure perdere la concentrazione.
...
\subsubsection{Conservare la magia}\index{Conservare la magia}\label{magieconservare}
...
\subsubsection{Regole per le creature evocate}\index{Regole per le creature evocate}\index{Evocazione creature}
...
\subsubsection{Tentare più Magie nello stesso round}\index{Tentare più Magie nello stesso round}\index{Magie multiple nello stesso round}\hypertarget{piumagieround}{}\label{piumagieround}
...
\subsubsection{Alterare le Magie}\index{Alterare le Magie}\label{magiealteraremagie}
...
\subsubsection{Tentare Incantesimi con impedimenti}\index{Tentare Incantesimi con impedimenti} \index{Impedimenti}\label{magieconimpedimenti}\hypertarget{magieconimpedimenti}{}
