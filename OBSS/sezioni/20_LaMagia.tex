...
L'incantatore tira \textbf{3d6 + 1d6 ogni tre punti di Competenza Magica + Modificatore di caratteristica per incantesimo} più eventuali bonus, Abilità o penalità (armatura, scudi, critici subiti).
