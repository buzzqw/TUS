...
\item \textbf{Tirare due volte 6} è presagio di buona ventura (Successo Critico) se riesci nella prova \index{Successo Critico}

\item\textbf{Tirare 2 volte 1 oppure 1 volta 1 e due volte 2} è presagio di sventura (Fallimento Critico) se non riesci nella prova \index{Fallimento Critico}
...
Ogni qual volta la prova è \textbf{superata con un critico}, ovvero la prova è riuscita e si sono tirati almeno due 6 il Narratore può decidere di dare maggiori informazioni, concedere un bonus alle azioni successive (+1).. qualsiasi cosa possa valorizzare quanto agevolmente la prova è stata superata.\index{Superare la prova con un Critico}
...
I modificatori indicati si sommano.
...
In caso di Successo Critico scali o ti arrampichi come fosse terreno difficile. Usare una corda consente di trattare l'arrampicata come terreno difficile.
...
Le creature extraplanari come Celestiali, Demoni, Diavoli, Draghi, Elfi, Nani, Gnomi ... parlano di base le proprie lingue.
...
Creature marine senzienti & Aquan& Elfico\\
Creature marine senzienti* & Aquan& - \\
Uccelli senzienti& Ictun & -\\
Abitanti senzienti dei boschi& Silvano& - \\
...
Lingua dei Segni*& dei Segni & dei Segni\\
\end{tabularx}}
...
%\begin{changemargin}{0.3cm}{0.3cm}\begin{narratore}
%Come eseguire le Prove, come gestire i risultati, al pari degli incontri, determina la tipologia di gioco. Ascoltate il giocatore e percepite il suo entusiasmo, cercate di capire le intenzioni finali, l'obiettivo e lo scopo della prova. Un giocatore coinvolto e partecipativo contagia con il suo entusiasmo anche agli altri giocatori! 

%Ascoltate attentamente le proposte che vi fanno anche se vi sembrano \emph{poco assennate} o \emph{semplicemente folli}, nulla vi vieta di avvertire della potenziale pericolosità delle scelte ma non tarpate l'entusiasmo!. 

%Se poi i giocatori vi dicono semplicemente faccio una \emph{prova Consapevolezza} oppure \emph{convinco la guardia} seguiteli nei loro propositi, fategli fare pure la semplice prova, ma allo stesso tempo fate di tutto per coinvolgerli ulteriormente.
