...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\textbf{Gittata}: & 9 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 2 ore per CM (massimo 24 ore) \\
\end{tabularx}\smallskip
...
\incantesimo{Alterare Sé Stesso}
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
...
\incantesimo{Animale Messaggero}
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Animali e Piante \\
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\textbf{Gittata}: & Contatto \\
	\rowcolor{gray!20}\textbf{Durata}: & 6 round, Concentrazione \\
\end{tabularx}\smallskip
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia il danno aumenta di +1d6.
...
\index{Cannone a onde moventi Yamato}Un fascio di luce brillante esplode dalla tua mano in una linea larga 1 metro e lunga 18 metri. Ogni creatura sulla linea deve effettuare un Tiro Salvezza su Tempra. Se fallisce il Tiro Salvezza, la creatura subisce 6d8 danni da Luce e rimane accecata fino al tuo prossimo round. Se supera il Tiro Salvezza, subisce la metà dei danni e non è accecata. I non morti e le melme hanno -1d6 su questo Tiro Salvezza. Puoi creare una nuova linea di luminosità spendendo 3 Azioni durante qualsiasi tuo round fino al termine dell'incantesimo.
...
\textbf{In caso di due Successi Critici Magici ottenuti} l'incantesimo termina dopo il primo raggio ma la linea è larga 6 metri, lunga 108 metri, il danno da Luce diviene 12d8.
...
\textbf{In caso di due Successi Critici Magici ottenuti} nella Prova di Magia la ciotola non è consumata.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & 18 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & Concentrazione fino ad 1 minuto \\
\end{tabularx}\smallskip
...
\textbf{Ogni 2 Successi Critici Magici ottenuti} nella Prova di Magia influenzi un'altra creatura.
...
\textbf{Se ottieni 2 Successi Critici Magici e sei un Devoto o Seguace di un Patrono buono} ogni round le creature scelte recuperano 2 Punti Ferita in più.
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia puoi influenzare un'altra creatura.

\incantesimo{Benedizioni di Efrem}
...
\incantesimo{Benedizione di Ledyal}
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Necromanzia \\
	\textbf{Livello}: & 3, Molto Raro \\
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
...
\label{Aura of Vitality}Un aura sacra si irradia da te. Qualsiasi creatura che incominci il round entro 9 metri da te viene curata di 1d6 Punti Ferita. Una creatura non viene curata per più di 3 round per incantesimo.
...
\incantesimo{Caduta Piuma}
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Aria \\
	\textbf{Livello}: & 1, Comune \\
	\rowcolor{gray!20}\textbf{Lancio}: & 1 Reazione, che effettui quando tu o una creatura entro 18 metri da te cade \\
	\textbf{Gittata}: & 18 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 1 minuto \\
\end{tabularx}\smallskip


\label{cadutapiuma}\hypertarget{cadutapiuma}Scegli fino a 2 creature a gittata. La velocità di discesa di una creatura che cade diminuisce a 18 metri per round fino al termine dell'incantesimo. Se la creatura atterra prima del termine dell'incantesimo, non subisce danni da caduta e può atterrare sui suoi piedi; per quella creatura l'incantesimo ha termine.
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia puoi aggiungere una creatura come bersaglio. Quando lanci l'incantesimo, le creature bersaglio devono trovarsi entro 9 metri l'una dall'altra.
...
\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
	\item \emph{Astuzia della Volpe}. Il bersaglio ha +1d6 alle Competenze base basate su Intelligenza e Forza
	...
	\item \emph{Grazia dell'Energia Luminosa}. Il bersaglio ha +1d6 alle Competenze base basate su Destrezza. Inoltre, qualora non sia inabile, non subisce danni dalle cadute di 6 metri o meno.
	...
	\item \emph{Splendore del Topo}. Il bersaglio ha +1d6 alle Competenze base basate su  Carisma.
\end{itemize}
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia puoi aggiungere un altro bersaglio in gittata. Se fai 3 Successi Critici Magici il bersaglio è influenzato dall'incantesimo per tutto il giorno.
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia puoi agire su di un'ulteriore creatura. Nel momento in cui lanci l'incantesimo le creature bersaglio devono trovarsi entro 9 metri l'una dall'altra ed eseguono il medesimo comando.
...
\textbf{Per due Successi Critici Magici} ottenuti nella Prova di Magia puoi analizzare un'altra creatura.
...
\textbf{NOTA}: se sei un Devoto di Nethergal l'incantesimo dura 2 ore per CM.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Abiurazione \\
	\textbf{Livello}: & 3, Comune \\
	\rowcolor{gray!20}\textbf{Lancio}: & 1 Reazione, che effettui quando vedi una creatura/oggetto entro 18 metri manifestare un incantesimo \\
	\textbf{Gittata}: & 18 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & Istantanea \\
\end{tabularx}\smallskip
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia puoi annullare un incantesimo di un livello superiore.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 1 minuto \\
	\textbf{Gittata}: & 18 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 30 giorni \\
\end{tabularx}\smallskip
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & variabile \\
	\textbf{Gittata}: & 9 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 1 ora \\
\end{tabularx}\smallskip
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Animali e Piante \\
	\textbf{Livello}: & 3, Non Comune \\
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni o 8 ore \\
	\textbf{Gittata}: & 45 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & Istantanea \\
\end{tabularx}\smallskip
...
\textbf{Se ottieni due Successi Critici Magici} ottieni gli effetti delle 8 ore di lancio anche se l'incantesimo è stato lanciato con 2 Azioni.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & 18 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 2 ore \\
\end{tabularx}\smallskip
...
\textbf{Se ottiene due Successi Critici Magici} il Cuoco viene evocato con cibo necessario a sfamare 2 persone
...
\textbf{Se ottieni 2 Successi Critici Magici} la durata aumenta di 1 ora
...
\textbf{In caso di 2 Successi Critici Magici ottenuti} non subisci effetti collaterali dal lancio di Desiderio.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 1 minuto \\
	\textbf{Gittata}: & 9 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 1 ora per CM, massimo 24 ore \\
\end{tabularx}\smallskip
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia la durata aumenta di un'ora, fino ad un massimo di 24 ore, oppure crei una cavalcatura in più.
...
\incantesimo{Dissolvi Magie Avanzato}
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Abiurazione \\
	\textbf{Livello}: & 5, Raro \\
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia puoi influenzare un'altra creatura che possa vedere il gesto.
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia puoi estinguere un'area aggiuntiva di 3 metri di cubo, oppure il fuoco magico si estingue permanentemente.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 1 minuto \\
	\textbf{Gittata}: & 27 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & Concentrazione, 1 Turno \\
\end{tabularx}\smallskip
...
\textbf{Ogni due Successi Critici Magici ottenuti} nella Prova di Magia il grado di sfida dell'elementale evocato aumenta di 1
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia appariranno due elementali in più di grado inferiore o 1 elementale in più di grado superiore a quello inizialmente scelto.
...
\textbf{Per due Successi Critici Magici} ottenuti nella Prova di Magia il danno aumenta di 4d10.
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia la durata aumenta di 1 round. In caso di due Successi Magici Critici puoi escludere un'altra creatura dal fermarsi del tempo.
...
\textbf{Per ogni due Successi Critici Magici} ottenuto nella Prova di Magia è possibile inserire un incantesimo di livello superiore nel Glifo Incantesimo.
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia puoi bloccare un livello superiore di incantesimo.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Animali e Piante, Terra \\
	\textbf{Livello}: & 3, Raro \\
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & 30 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 1 round per CM, Concentrazione \\
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & variabile \\
	\textbf{Gittata}: & Contatto \\
	\rowcolor{gray!20}\textbf{Durata}: & Variabile \\
\end{tabularx}\smallskip
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & 36 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & Concentrazione, massimo 3 minuti per CM \\
\end{tabularx}\smallskip
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia crei un'immagine duplicata in più fino ad un massimo totale di 8 immagini.
...
\index{Occhi della Magia}Per la durata, percepisci la presenza della magia entro 9 metri da te. Puoi usare 1 Azione per vedere una flebile aura che si estende intorno a qualsiasi creatura o oggetto visibile nell'area che rechi magia. Con due Azioni ne apprendi anche la Lista di Magia, se ce l'ha.
...
\textbf{Per ogni due Critici ottenuti} nella Prova di Magia la creatura aumenta di un'altra taglia, oppure influenzi un'altra creatura entro 6 metri dalla prima.
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia l'incantesimo protegge una volta in più o protegge un'altra creatura.
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia puoi scegliere un'ulteriore creatura bersaglio o aumenti di 1 minuto la durata.
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia la durata aumenta di 10 minuti. Con due Successi Critici Magici puoi influenzare un'altra creatura.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 1 Azione \\
	\textbf{Gittata}: & Personale \\
	\rowcolor{gray!20}\textbf{Durata}: & 10 round \\
\end{tabularx}\smallskip
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia puoi spostarti di 1 metro lateralmente o influenzare un'altra creatura.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 1 Azione \\
	\textbf{Gittata}: & Contatto \\
	\rowcolor{gray!20}\textbf{Durata}: & 1 minuto, finché usato \\
\end{tabularx}\smallskip
...
\textbf{Per due Successi Critici Magici ottenuti} nella Prova di Magia puoi influenzare un'altra creatura.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & 18 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 1 minuto di tempo reale di gioco \\
\end{tabularx}\smallskip
...
\textbf{Con tre Successi Critici Magici ottenuti} nella Prova di Magia la durata è permanente.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 1 Reazione \\
	\textbf{Gittata}: & 18 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 6 round più 1 round per CM \\
\end{tabularx}\smallskip
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & 36 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & Concentrazione, massimo 2 ore \\
\end{tabularx}\smallskip
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Animali e Piante, Divinazione \\
	\textbf{Livello}: & 6, Raro \\
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & 9 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 1 ora \\
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Terra, Animali e Piante \\
	\textbf{Livello}: & 2, Comune \\
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
...
\textbf{Se ottieni due Successi Critici Magici ottenuto} nella Prova di Magia puoi scambiarti di posto con una creatura consenziente.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Terra, Divinazione \\
	\textbf{Livello}: & 6, Raro \\
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & Tocco \\
	\rowcolor{gray!20}\textbf{Durata}: & 1 turno \\
...
\incantesimo{Pioggia di Meteore}
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
...
\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
	\item \emph{Fuochi d'Artificio}. Il fuoco bersaglio esplode in uno spettacolo luminoso di fiamme e colori. Ogni creatura entro 3 metri dal bersaglio deve superare un Tiro Salvezza su Tempra oppure diventa accecata fino alla fine del round successivo.
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia puoi portare una ulteriore creatura.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & Personale \\
	\rowcolor{gray!20}\textbf{Durata}: & 3 round + 1 round ogni 3 CM, massimo 10 round, Concentrazione \\
\end{tabularx}\smallskip
...
\incantesimo{Profumo di Atherim}
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Cura \\
	\textbf{Livello}: & 4, Raro \\
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & Personale \\
	\rowcolor{gray!20}\textbf{Durata}: & Concentrazione, fino a 10 minuti\\
\end{tabularx}\smallskip
...
\textbf{In caso di due Successi Critici Magici ottenuto} nella Prova di Magia puoi annullare un veleno in circolo sul bersaglio.
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia crei un fascio gelato aggiuntivo.
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia aumenti di 1 il livello di Affaticamento del bersaglio.
...
\textbf{Questo incantesimo non è disponibile se non ai Devoti e Seguaci di Shayalia o Efrem}
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia la creatura resuscitata non subisce alcuna penalità, oppure può essere riportata in vita anche se morta da più tempo (fino a 1000 anni per critico).

\textbf{NOTA}: solo un Patrono o un incantatore di altissimo livello e punteggio Tratti possono lanciare questo incantesimo.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 1 Azione \\
	\textbf{Gittata}: & Tocco \\
	\rowcolor{gray!20}\textbf{Durata}: & 2 turni \\
\end{tabularx}\smallskip
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia aggiungi +4 alla propria DC per capire se ha superato quella del veleno.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Animali e Piante \\
	\textbf{Livello}: & 5, Raro \\
	\rowcolor{gray!20}\textbf{Lancio}: & 8 ore \\
	\textbf{Gittata}: & Contatto \\
	\rowcolor{gray!20}\textbf{Durata}: & Istantanea \\
\end{tabularx}\smallskip
...
\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
	...
	\item Nulla può teletrasportarsi dentro o fuori dall'area protetta.
...
\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
	\item Scegli un punteggio di caratteristica. Mentre è maledetto, il bersaglio ha -1d6 alle prove di competenza base basate su quella caratteristica ed i Tiri Salvezza basati su quella caratteristica.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Evocazione \\
	\textbf{Livello}: & 1, Non Comune \\
	\rowcolor{gray!20}\textbf{Lancio}: & 1 Reazione, che puoi effettuare in risposta al danno arrecatoti da una creatura entro 18 metri da te che puoi vedere \\
	\textbf{Gittata}: & 18 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & Istantanea \\
\end{tabularx}\smallskip
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & 36 metri \\
	\rowcolor{gray!20}\textbf{Durata}: & 10 minuti di tempo reale \\
\end{tabularx}\smallskip
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Fuoco, Acqua \\
	\textbf{Livello}: & 4, Non Comune \\
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & Personale \\
	\rowcolor{gray!20}\textbf{Durata}: & 10 minuti \\
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & Contatto \\
	\rowcolor{gray!20}\textbf{Durata}: & 1 ora per CM di tempo reale di gioco \\
\end{tabularx}\smallskip
...
\textbf{Con due Successi Critici Magici} puoi lanciare l'incantesimo su un oggetto o creatura che diventa il centro della sfera. In caso di creature è concesso un Tiro Salvezza su Volontà.
...
\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
	...
	\item \emph{Paura}. Ogni bersaglio deve effettuare un Tiro Salvezza su Volontà e, se lo fallisce, restare spaventato per 1 minuto. Mentre è spaventato, il bersaglio getta qualsiasi cosa stesse tenendo e deve muoversi almeno 9 metri lontano dal glifo durante ciascun suo round, se in grado.
...
\textbf{Per ogni due Successi Critici Magici} ottenuti nella Prova di Magia puoi influenzare creature 1 Grado Sfida più alto.
...
\incantesimo{Spostamento Planare}\label{spostamentoplanare}
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Invocazione \\
	\textbf{Livello}: & 7, Leggendario \\
	\rowcolor{gray!20}\textbf{Lancio}: & 1 Azione \\
	\textbf{Gittata}: & Tocco \\
	\rowcolor{gray!20}\textbf{Durata}: & Istantanea \\
	\textbf{Materiale}: & Una bacchetta di metallo biforcuta armonizzata al piano di destinazione (valore 250 mo) \\
\end{tabularx}\smallskip
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia puoi trasportare due creature aggiuntive o aumentare la precisione dell'arrivo.

\textbf{NOTA}: questo incantesimo è monitorato da Lynx che darà attivamente la caccia a qualsiasi incantatore abusi dei viaggi planari.
...
Se il Tiro Salvezza riesce non si subisce alcun effetto, se fallisce la creatura diventa \hyperlink{confusionecondizione}{confusa} per 1 round.
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia influenzi un'altra creatura entro gittata.


\incantesimo{Statua}
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	\rowcolor{gray!20}\textbf{Lista}: & Terra, Trasmutazione \\
	\textbf{Livello}: & 7, Raro \\
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & Tocco \\
	\rowcolor{gray!20}\textbf{Durata}: & 1 ora per CM, massimo 24 ore \\
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia raddoppi la durata, fino ad un massimo di 24 ore, o influenzi un'altra creatura.
...
\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
	...
	\item \emph{Oggetto associato} indica che possiedi un oggetto preso negli ultimi sei mesi dalla destinazione desiderata, come il libro della biblioteca di un mago, biancheria della suite reale, o un pezzo di marmo della tomba segreta di un lich.
...
\textbf{Per ogni due Successi Critici Magici ottenuti} nella Prova di Magia crei una mano scheletrica aggiuntiva che deve attaccare una creatura diversa entro gittata.
...
\textbf{Per ogni tre Successi Critici Magici ottenuti} nella Prova di Magia puoi aumentare di un ulteriore 1 le Azioni a round ad una creatura.
...
\noindent\begin{tabularx}{\linewidth}{p{1.3cm}X}
	...
	\rowcolor{gray!20}\textbf{Lancio}: & 2 Azioni \\
	\textbf{Gittata}: & Contatto \\
	\rowcolor{gray!20}\textbf{Durata}: & 10 minuti per CM, massimo 1 ora \\
\end{tabularx}\smallskip
...
\textbf{Per ogni Successo Critico Magico} ottenuto nella Prova di Magia puoi prendere come bersaglio un'ulteriore creatura oppure aumentare la durata di 10 minuti, fino ad un massimo di 1 ora.
...
\subsection{Incantesimi per Lista con Livello e Rarità}\hypertarget{elencoscuole}{}\index{Incantesimi elenco}
...
\hyperlink{Pietra in Fango}{Pietra in Fango - Fango in Pietra}, Non Comune - Molto Raro, 5\\
\hyperlink{Carne in Pietra}{Carne in Pietra - Pietra in Carne}, Non Comune - Raro, 6\\
...
\stepcounter{inclvcinque}\hyperlink{Pietra in Fango}{Pietra in Fango - Fango in Pietra}, Non Comune - Molto Raro, 5\\
...
\stepcounter{inclvsei}\hyperlink{Carne in Pietra}{Carne in Pietra - Pietra in Carne}, Non Comune - Raro, 6\\
