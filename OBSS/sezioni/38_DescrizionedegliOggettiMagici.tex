...
\begin{multicoltab}{ll}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{d100} &\textbf{Contiene}} \\
1-50 &Vuota\\
...
\textbf{Requisiti:} Creare Oggetti Magici 3, \hyperlink{Scudo Mentale}{Scudo Mentale}; \textbf{Rarità:} Molto Raro
...
\textbf{Requisiti:} Creare Oggetti Magici 3, \hyperlink{Scudo Mentale}{Scudo Mentale}; \textbf{Rarità:} Raro
...
\begin{multicoltab}{ll}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}d\% &Nemico prescelto} \\
01-05 &Aberrazioni\\
...
\begin{multicoltab}{lX|lX}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{1d100} & \textbf{Talento} & \textbf{1d100} & \textbf{Talento}} \\
...
\smallskip- Puoi respirare sott'acqua e hai velocità di nuoto pari alla tua velocità di movimento.
...
Mentre indossi quest'\textbf{anello}, puoi pronunciarne la parola di comando, con due azioni, per evocare uno specifico djinni del Piano Elementale dell'Aria. Il djinni compare in uno spazio non occupato a tua scelta, entro 36 metri da te. Resta finché rimani concentrato (come se ti concentrassi su di un incantesimo), per un massimo di 1 ora, o finché non scende a 0 Punti Ferita. Poi ritorna al suo piano natio.
...
\oggettomagico{Anello di Invisibilità}
...
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{d10} & \textbf{Tipo di Danno} & \textbf{Gemma}} \\
1 &Acido &Perla\\
...
\oggettomagico{Arma maledetta}

\textbf{Aura:} Trasmutazione debole; \textbf{Costo:} variabile

\textbf{Rarità:} Non Comune

Questa \textbf{arma} appare come un'arma magica con bonus al Tiro per Colpire e ai danni. Tuttavia, una volta impugnata in combattimento, la sua vera natura si rivela: impone una penalità al colpire ed ai danni. Questa maledizione persiste finché l'arma non viene rimossa tramite l'incantesimo \hyperlink{Rimuovi Maledizione}{Rimuovi Maledizione}. L'arma non può essere lasciata o scartata volontariamente.

\oggettomagico{Armatura maledetta}

\textbf{Aura:} Abiurazione debole; \textbf{Costo:} variabile

\textbf{Rarità:} Non Comune

Questa \textbf{armatura} sembra un'armatura magica che conferisce bonus alla Difesa. Tuttavia, una volta indossata, la sua vera natura si manifesta: impone una penalità alla Difesa invece di un bonus. L'armatura si attacca al corpo del portatore e non può essere rimossa senza l'uso dell'incantesimo \hyperlink{Rimuovi Maledizione}{Rimuovi Maledizione}. Indossare l'armatura maledetta può anche causare altri effetti negativi a discrezione del Narratore.
...
Mentre impugni questa \textbf{bacchetta}, puoi usare due azioni per spendere 1 carica per lanciare tramite essa l'incantesimo fulmine (DC del Tiro Salvezza 18).
...
Mentre impugni questa \textbf{bacchetta}, puoi usare l'Azione di Reazione e spendere 1 carica per ottenere +1d6 ai Tiri Salvezza che effettui per evitare di restare paralizzato o intralciato, o puoi spendere 1 carica per ottenere +1d6 su qualsiasi prova effettuata per sfuggire un tentativo di afferrare.
...
\oggettomagico{Bacchetta delle Comodità}
...
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{d100}& \textbf{Contenuti}} \\
...
Mentre indossi questa \textbf{bandana} la tua Intelligenza è +4. La bandana non ha effetto se la tua Intelligenza è già +4 o più alta.
...
- \emph{Incantesimi}. Mentre impugni questo bastone, puoi usare due azioni per spendere le sue cariche e lanciare uno dei seguenti incantesimi: insetto gigante (4 cariche, DC 19) o piaga degli insetti (5 cariche, DC 21).

- \emph{Nube di Insetti}. Mentre impugni questo bastone, puoi usare due azioni e spendere 1 carica per far sì che uno sciame di insetti innocui si diffonda in un raggio di 9 metri intorno a te. Gli insetti rimangono per 10 minuti, rendendo l'area oscurata pesantemente per tutti tranne te. Lo sciame si muove assieme a te, rimanendo centrato su di te. Un vento di almeno 15 chilometri all'ora disperde lo sciame e termina l'effetto.
...
\begin{multicoltab}{ll}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{Distanza dall'origine} &\textbf{Danno}} \\
...
\begin{multicoltab}{lX}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{d100} & \textbf{Effetto}} \\
...
\begin{multicoltab}{lX}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{3d6} &\textbf{Effetto}} \\
...
\textbf{Aura:} Abiurazione; \textbf{Costo:} +6000 mo, 15000 mo, 30000 mo, 45000 mo, 60000 mo.
...
12000 mo. Quest'\textbf{ampolla} tappata emette un suono di liquido quando viene smossa, come se contenesse acqua. La brocca pesa 1 chilo, ingombro 2. Puoi usare due azioni per rimuovere il tappo e pronunciare una delle tre parole di comando, e a quel punto un ammontare di acqua fresca o acqua salata (a tua scelta) si riverserà fuori dall'ampolla, fino all'inizio del tuo prossimo round. Scegli una delle opzioni seguenti:
...
\textbf{Requisiti:} Creare Oggetti Magici 1, \hyperlink{Raggio Rovente}{Raggio Rovente}; \textbf{Rarità:} Raro
...
\begin{multicoltab}{lll}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{Tipo di Gigante}& \textbf{Forza} &\textbf{Rarità}} \\
...
\begin{multicoltab}{llX}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{3d6} &\textbf{Sfera di...} &\textbf{Incantesimo}} \\
...
\textbf{Requisiti:} Creare Oggetti Magici 1, \hyperlink{Resistenza}{Resistenza}; \textbf{Rarità:} Non Comune
...
\textbf{Requisiti:} Creare Oggetti Magici 2, \hyperlink{Crescita di Spuntoni}{Crescita Spuntoni}; \textbf{Rarità:} Raro
...
\begin{multicoltab}{ll}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{Incantesimo o Oggetto} &\textbf{Cariche Perse}} \\
...
\begin{multicoltab}{ccX}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{Faccia} & \textbf{Costo}& \textbf{Effetto}} \\
...
Uno \textbf{scudo} o un'\textbf{armatura} concede la capacità di combattere in circostanze apparentemente impossibili. Una volta al giorno, quando il possessore raggiunge 0 o meno Punti Ferita, l'oggetto attiva automaticamente l'incantesimo Cure ferite 2.
...
Questa capacità speciale può essere aggiunta solo a \textbf{proiettili}. Un proiettile della Distanza ignora la penalità al colpire fino al triplo della gittata. Il costo si intende per 20 proiettili.
...
Un'\textbf{arma} della Distruzione è la rovina di tutti i Non Morti. Ogni creatura Non Morta colpita in combattimento deve superare un Tiro Salvezza su Volontà con DC 14 o viene distrutta o subisce 2d8 di danni aggiuntivi da Luce. Un'arma della Distruzione deve essere un'arma da mischia contundente.
...
Finché hai addosso l'\textbf{arma} ricevi anche un bonus di +1 ai Tiri Salvezza.
...
\oggettomagico{Gemma della Luminosità}
...
Con due azioni, puoi pronunciare la parola di comando della \textbf{gemma} e spendere 1 carica. Per i successivi 10 minuti, quando guardi attraverso la gemma possiedi la visione del vero fino a 36 metri di distanza. La gemma ha 3 cariche, e recupera 1 carica spesa ogni giorno all'alba.
...
\begin{multicoltab}{ll}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{Gemma} &\textbf{Elementale evocato}} \\
...
Un'\textbf{arma} Gloriosa illumina con una luce abbagliante pari a quella di un incantesimo Luce Diurna quando viene estratta. Chi la impugna non può sopprimere questa luce, anche se può essere soppressa temporaneamente da qualsiasi effetto che può sopprimere Luce Diurna.
...
Questi \textbf{guanti} sembrano quasi fondersi con la tua pelle quando li indossi. Quando un attacco con arma a distanza ti colpisce mentre li indossi, puoi usare un'Azione di Reazione per ridurre il danno di 1d10 + Destrezza, purché tu abbia una mano libera. Se riduci il danno a 0 ed il proiettile è piccolo a sufficienza da essere tenuto in mano, puoi afferrarlo.
...
Mentre l'\textbf{incenso} brucia all'interno di questo incensiere, puoi usare due azioni per pronunciare la parola di comando dell'incensiere ed evocare un elementale dell'aria, come se avessi lanciato l'incantesimo \hyperlink{Evoca Elementale}{Evoca Elementale}. L'incensiere non può di nuovo essere usato a questo modo fino alla prossima alba. Questo incensiere largo 15 centimetri e alto 30 centimetri assomiglia a un calice dalla copertura decorata. Pesa 0,5 chili, ingombro L.
...
\item
Puoi usare due azioni per lanciare l'incantesimo \emph{ragnatela} (DC del Tiro Salvezza 15). La ragnatela creata dall'incantesimo riempie il doppio della sua normale area. Una volta usata, questa proprietà del Mantello non può essere usata di nuovo fino alla prossima alba.
\end{itemize}
...
Mentre indossi questo \textbf{Mantello} con il cappuccio tirato su, puoi respirare sott'acqua e hai velocità di nuoto 18 metri. Tirare su o giù il cappuccio richiede 2 Azioni.
...
\oggettomagico{Mantello della velenosità}
...
Mentre indossi questo \textbf{mantello}, ottieni un bonus di +1 (non comune, 3500 mo),+2 (raro, 6000 mo),+3 (molto raro, 15000 mo) alla Difesa e ai Tiri Salvezza.
...
\begin{multicoltab}{llll}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}3d6 &Golem &Tempo &Costo} \\
...
Questo \textbf{tomo} funziona esattamente come il manuale della salute, ma conferisce al lettore un punto di Forza. La \emph{versione maledetta} di questo manuale pur sembrando assolutamente identico a quello originale al termine delle 4 settimane fa perdere un punto di Forza.

\oggettomagico{Manuale della Buona salute}

\textbf{Rarità:} Molto Raro; \textbf{Costo:} 15000 mo

Questo \textbf{tomo} contiene istruzioni per rafforzare il corpo e la salute. Per leggere il libro occorrono 24 ore in un minimo di 3 giorni. Le sue istruzioni andranno seguite per 4 settimane, al termine delle quali il lettore guadagnerà permanentemente un punto di Costituzione. Una volta letto il manuale perde la sua magia, per recuperarla dopo un secolo. La \emph{versione maledetta} di questo manuale pur sembrando assolutamente identico a quello originale al termine delle 4 settimane fa perdere un punto di Costituzione.

\oggettomagico{Manuale della Velocita' di azione}

\textbf{Rarità:} Molto Raro; \textbf{Costo:} 15000 mo

Questo \textbf{tomo} contiene esercizi per l'equilibrio e la coordinazione. Funziona come un manuale della buona salute, ma fa ottenere un punto di Destrezza. La \emph{versione maledetta} di questo manuale pur sembrando assolutamente identico a quello originale al termine delle 4 settimane fa perdere un punto di Destrezza.
...
\begin{multicoltab}{ll}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{Carta da Gioco} & \textbf{Illusione}} \\
...
\begin{multicoltab}{ll}
\mchead[\toprule][\midrule]{\rowcolor{gray!20}\textbf{Carta da Gioco} & \textbf{Carta}} \\
...
\item \textbf{Bilancia}: La mente del personaggio è sottoposta a una sofferta alterazione che modifica i suoi tratti.
\item \textbf{Cavaliere}: Il personaggio ottiene i servigi di un combattente con CA 4 che appare in uno spazio a sua scelta entro 9 metri da lui. Il guerriero è della stessa razza del personaggio e lo serve fedelmente fino alla morte, convinto che sia stato il destino a condurlo da lui. Il personaggio ha il controllo del guerriero.
...
Questo \textbf{medaglione} attiva in automatico l'incantesimo Caduta Piuma quando il possessore cade da un'altezza di 2 metri o più.
...
\oggettomagico{Olio di Scivolosità}
...
\oggettomagico{Polvere dell'Aridità}
...
\oggettomagico{Pozione dell'invulnerabilità}
...
\oggettomagico{Pozione della Longevità}
...
Chiunque beva questa \textbf{pozione} è come se avesse lanciato Dominare Bestie.

\oggettomagico{Pozione di Controllo dei draghi}

\textbf{Rarità:} Leggendaria; \textbf{Costo:} 5000 mo

Questa \textbf{pozione} conferisce un potere equivalente all'incantesimo dominare mostri su un singolo tipo di drago. È possibile controllare un drago entro 18 metri per 5d4 round.
...
Quando bevi questa \textbf{pozione}, per 1 ora o finché non terminerai l'effetto con due azioni ottieni l'effetto dell'incantesimo \hyperlink{Forma Gassosa}{forma gassosa} (non richiede concentrazione).
...
\oggettomagico{Pozione di Invisibilità}
...
Quando bevi questa \textbf{pozione} per 1d4 ore ottieni l'effetto ridurre dell'incantesimo (non richiede concentrazione).
...
\oggettomagico{Pozione di Velocità}
...
Leggendario, questo \textbf{specchio} è alto un po' più di un metro e largo un po' di meno. Quando una creatura si riflette sulla superficie dello specchio, la sua immagine riflessa (un duplicato identico in tutto e per tutto) esce per attaccare l'originale. Il duplicato ha tutto l'equipaggiamento e i poteri dell'originale, compresa la magia. Il duplicato sparisce immediatamente, assieme a tutti i suoi oggetti, alla morte sua o dell'originale.
...
\oggettomagico{Stivali della Velocità}
...
\begin{multicoltab}{cccc}
\mchead[\toprule][\midrule]{\textbf{d100} & \multicolumn{1}{c}{\textbf{Taglia}} & \textbf{Capacità} & \multicolumn{1}{c}{\textbf{Velocità}} \\
...
Quest'\textbf{arma} gigante è lunga 3 m e pesa quasi 40 kg (8 Ingombro). Se usata come un'arma ha un bonus +2 al colpire e infligge 2 categorie di dado superiore di danno. Può essere usato anche per piantare rapidamente pali grossi come tronchi d'albero e per divellere con pochi colpi porte e cancelli. A causa della fatica nell'usarla non può essere brandita per più di 10 round al giorno.
...
Un'\textbf{arma} del Tocco Fantasma infligge un danno critico aggiuntivo quando colpisce le creature con Movimento Incorporeo. Finché imbracci un'arma Tocco Fantasma puoi vedere le creature invisibili.
...
\rowcolor{gray!20}52-59 & Fossa (un cubo di 3 metri di spigolo), che puoi piazzare sul terreno entro 3 metri da te.\\
...
Questo \textbf{abito} apparentemente normale può essere giallo (01-45 su 1d100), grigio (46-75) o nero (76-00). Può essere indossato solo da un incantatore con Competenza Magica 2 o superiore. Conferisce i seguenti bonus:
...
\oggettomagico{Arma della Velocità}
...
\emph{Incantesimi}. Mentre impugni questa verga, puoi usare due azioni per lanciare tramite essa uno dei seguenti incantesimi: \hyperlink{Individuazione del Magico}{Individuazione del Magico}, \hyperlink{Individuazione delle Malattie e dei Veleni}{Individuazione delle Malattie e dei Veleni} o \hyperlink{Vedere l'invisibile}{Vedere l'invisibile}.
...
\oggettomagico{Verga della Sovranità}
...
\oggettomagico{Zoccoli della Velocità}
...
\vfill
\begin{center}
\includegraphics[width=0.8\linewidth]{immagini/borsetta.png}
