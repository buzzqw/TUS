\section{Lista d'Armi per Tipologia Omogenea}\index{Lista d'Armi}\index{Tipologia Omogenea}\hypertarget{lista.armi}{}\label{lista.armi}
...
\item 9 punti: ti è possibile con il primo Tiro per Colpire che esegui nel round scagliare due frecce. Il Tiro per Colpire parte da una penalità di -5.
...
\item 4 punti: la penalità al Movimento diminuisce di 1 metro, il bonus alla Difesa concessa dall'armatura aumenta di 1 punto. Diminuisci di ulteriori 2 la penalità alla Prova di Magia.
\item 5 punti: diminuisci di 1 i Tiri Critici subiti per attacco in mischia, la Penalità alla Competenza diminuisce di 1 punto, la penalità al Movimento diminuisce di 1 metro. Diminuisci di ulteriori 2 la penalità alla Prova di Magia.
...
\item 11 punti: usando un'Azione di Reazione puoi cercare di intercettare gli attacchi dell'avversario, aggiungi +2 alla Difesa fino all'inizio del tuo round successivo.
...
\item 9 punti: il primo colpo critico che esegui sull'avversario somma 2 colpi critici aggiuntivi.
...
\item 5 punti: per ogni Tiro Critico l'avversario deve fare un Tiro Salvezza su Tempra a DC 13 o essere Rallentato 1/1r.
...
\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
\item 4 punti: usata contro una carica o in carica, purché abbia l'abilità Controcarica, il danno critico aggiuntivo fa il massimo valore.
\item 5 punti: puoi usarla anche contro avversari a distanza di 1 metro senza penalità.
\item 7 punti: usata contro una carica o in carica, purché abbia l'abilità Controcarica fa un danno critico aggiuntivo.
...
\item 7 punti: l'impatto dei tuoi colpi è tale da stordire i nemici. Se colpisci l'avversario con un Tiro Critico questo subirà Rallentato 1/1r.
\item 9 punti: puoi usare un'Azione Immediata ed usare la tua arma per cercare di deviare un Tiro per Colpire a te indirizzato su una creatura a distanza di mischia dall'avversario. Effettua un Tiro per Colpire, la manovra riesce solo se è superiore al Tiro per Colpire che vuoi deviare.
...
\item 16 punti: puoi usare un'Azione di Reazione ed usare la tua arma per cercare di proteggere una creatura in mischia con te fino all'inizio del tuo prossimo round. La creatura prende +4 alla Difesa.
\end{itemize}
...
\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
\item 1 punto: I tuoi pugni fanno danno letale (1d4). Puoi usare il valore di Forza o Destrezza al Tiro per Colpire ed al danno.
...
\begin{itemize}[leftmargin=*] \setlength{\itemsep}{0pt}
\item 4 punti: sei diventato così abile che puoi controllare la forza dei tuoi colpi, puoi fare danno non letale senza penalità al colpire.
...
\item 16 punti: usando una Reazione, ogni volta che colpisci con un Tiro Critico, puoi effettuare un altro Tiro per Colpire con lo stesso punteggio contro un diverso avversario purché in distanza di mischia.
...
\item 16 punti: se un avversario esegue almeno due tiri per colpire mancandoti entrambi puoi effettuare come Reazione un attacco di scudo contro di lui.
...
\item 7 punti: le ferite che provochi sono così profonde che causi Sanguinamento. Ogni tuo attacco andato a segno aumenta di 1 il sanguinamento fino ad un massimo di Sanguinamento 5.
...
\item 11 punti: le ferite che provochi sono così profonde che causi molto Sanguinamento. Il valore di Sanguinamento massimo sale a 15.
...
\item 12 punti: hai raggiunto l'apice della maestria con la spada i tuoi colpi sono precisi e difficili da prevedere ottieni +1 a danno, Tiro per Colpire e Difesa. L'EDX della spada se presente si abbassa di 1.
