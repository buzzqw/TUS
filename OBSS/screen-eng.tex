...
\textbf{Magic test}\\
3d6 + 1d6 and ignore one die for each Adept of Magic in the magic list of spell\\
...
DC = 10 + Magic Competence/2 + ability modifier per spell + 1 x Adept of Magic feat taken in that Magic List +1 x Critical in Magic Test
