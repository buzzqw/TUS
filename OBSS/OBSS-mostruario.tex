...
\medskip\textbf{Scimmia}\index[Mostruario]{Scimmia}
...
\textbf{Tiri Salvezza}: Tempra +0, Riflessi +3, Volontà +1

\textbf{Competenze} Acrobatica +6, Consapevolezza +3

\textbf{Lingue} -

\textbf{Sfida} 1/4 (10 PX)

\textbf{Azioni}

\textit{\textbf{Graffio.} Attacco con arma da Mischia}: +1 a colpire, portata 1 m, un bersaglio.

\textit{Colpisce:} 1 (1d4 - 1) danni da taglio.

\textit{\textbf{Morso.} Attacco con Arma da Mischia}: +1 a colpire, portata 1 metro, un bersaglio.
