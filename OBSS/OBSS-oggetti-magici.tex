...
\begin{multicols}{2}
	...
	\begin{itemize}
		...
		\item
		Un oggetto magico che \textbf{manifesta incantesimi} non esegue alcuna Prova di Magia. Il Tiro Salvezza che impone, se non specificato, è pari a 10 + livello*2 dell'incantesimo che manifesta.\index{Tiro Salvezza per incantesimi da oggetto}
		\item
