...
0.83b l'orchetto ha il naso da maiale, migliorie codice latex, layout, corretto esempio finta, corretto numero azioni cavalcatura, mettere uno scudo da arma improvvisata a difesa costa una reazione, corretta proiezione luce della candela, aggiornato screen, chiarimenti su abilita' supremo, 
...
> valutare:
- togliere abilta' supremo, aggiungere un attributo (relativa ad una caratteristica) alle abilita', ogni tot abilita' (5?) con quella caratteristica aumenta di uno. le abilita' sono 1,1,2,3,5,7,9,11,13,15,17,19,20
