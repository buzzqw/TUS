...
0.99.59 allineato uso \emph{} in didascalie immagini, aggiunto export in markdown automatizzato (molto beta), migliorato codice latex per ottimizzare export in md, creato script per caricare il markdown come wiki, migliorata tabella professioni nel manuale inglese, migliorato export in markdown, 
