...
*0.7* pubblicata versione 0.6, aggiornata copertina, ulteriori chiarimenti su identificare oggetti maledetti, corretta immagine braille, le liste di magia sono collegate a delle statistiche per determinare il livello  massimo, aggiunto l'abilita' tutt'uno con la magia , 
