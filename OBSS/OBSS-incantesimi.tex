...
\medskip\textbf{Gragnola di Limoni Kyrin}\index[Incantesimi]{Gragnola di Limoni  di Kyrin}\\
\textbf{Scuola}: Animali e Piante, Terra\\
\textbf{Livello}: 3, Raro\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 30 metri\\
\textbf{Componenti}: V, S, M (almeno 9 gocce di limone, una boccetta)\\
\textbf{Durata}: 1 round per Competenza Magica, Concentrazione\\
Incanti una boccetta con dentro almeno 9 gocce di limone.
Ogni round, spendendo 1 Azione, puoi spruzzare fino a 2 gocce di limone, delle 9 totali, contro uno o più bersagli entro 30 metri. Esegui un solo Tiro per Colpire con incantesimi da distanza, con un bonus pari alle volte che hai preso Liste Animali e Piante o Terra, per bersaglio indipendentemente dal numero di gocce che gli tiri. Ogni goccia se colpisce fa 1d4+2 danni da acido.\\
...
\textbf{Durata}: 1 minuto, Concentrazione\\
Modifichi lo scorrere del tempo intorno a un massimo di 1d4 creature di tua scelta in un cubo di 6 metri di spigolo a gittata. Ciascun bersaglio deve superare un Tiro Salvezza su Volontà od eseguire una Azione in meno a round.\\
\textbf{Per ogni Successo Critico magico ottenuto} nella Prova di Magia puoi influenzare una creatura in più.\\
\textbf{Per ogni due Successo Critico magico ottenuto} nella Prova di Magia puoi ridurre di un ulteriore 1 le Azioni a round.

\medskip\textbf{Lettura della terra di Kyrin}\index[Incantesimi]{Lettura della terra di Kyrin}\index{Ecolocazione}\\
\textbf{Scuola}: Terra\\
\textbf{Livello}: 2, Non Comune\\
\textbf{Tempo di Lancio}: 1 Round\\
...
\textbf{Durata}: 1 minuto\\
Modifichi lo scorrere del tempo velocizzandolo intorno a un massimo di 1d4 creature in un cubo di 6 metri di spigolo a gittata. Fino al termine dell'incantesimo i bersagli possono eseguire una Azione aggiuntiva di Attacco o Movimento.
...
\textbf{Per ogni Successo Critico magico ottenuto} nella Prova di Magia puoi influenzare una creature in più.\\
\textbf{Per ogni due Successo Critico magico ottenuto} nella Prova di Magia puoi aumentare di un ulteriore 1 le Azioni a round.
...
\flushleft{\textbf{Lista dell'Acqua - Destrezza}}
...
\flushleft{\medskip\textbf{Lista dell'Aria - Carisma}}
...
\flushleft{\medskip\textbf{Lista del Fuoco - Forza}}
...
\flushleft{\medskip\textbf{Lista della Terra - Costituzione}}
...
\flushleft{\medskip\textbf{Abiurazione - Intelligenza}}
...
\flushleft{\medskip\textbf{Animali e Piante - Saggezza}}
...
\flushleft{\medskip\textbf{Ammaliamento - Carisma}}
...
\flushleft{\medskip\textbf{Cura - Saggezza}}
...
\flushleft{\medskip\textbf{Divinazione - Saggezza}}
...
\flushleft{\medskip\textbf{Evocazione - Intelligenza}}
...
\flushleft{\medskip\textbf{Illusione - Intelligenza}}
...
\flushleft{\medskip\textbf{Invocazione - Costituzione}}
...
\flushleft{\medskip\textbf{Necromanzia - Costituzione}}
...
\flushleft{\medskip\textbf{Trasmutazione - Destrezza}}
...
\flushleft{\medskip\textbf{Universale - qualsiasi}}
