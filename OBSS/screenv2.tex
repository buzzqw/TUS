...
\begin{dmbox}[title=Arrampicarsi/Scalare]
...
\begin{dmbox}[title=Sfondare le Porte]
\noindent\begin{tabular}{llllll}
\textbf{Tipo di porta} & \textbf{Spessore} & \textbf{Durezza} & \textbf{PF} & \multicolumn{2}{c}{\textbf{DC}} \\

&\textbf{(cm)}&&& \textbf{Bloccata} & \textbf{a Chiave}\\
\toprule
...
\begin{dmbox}[title=Modificatori d'Attacco e Difesa]
...
\begin{dmbox}[title=Armi]
{\scriptsize 
%\begin{tabularx}{1\linewidth}{lll>{\scriptsize}X}
\begin{tabularx}{1\linewidth}{llX}
...
\begin{dmbox}[title=Prova di Magia]
...
\begin{dmbox}[title=Tiro Salvezza Incantesimo]
...
\begin{dmbox}[title=Tiro Salvezza Magia da Oggetto]
DC = 10 + 2 x livello incantesimo manifestato
\end{dmbox}

\begin{dmbox}[title=Tiro Salvezza Incantesimo Mostro]
DC è 10 + 2 x livello incantesimo + Intelligenza o modificatore indicato
\end{dmbox}

\begin{dmbox}[title=Successo Critico Auto Magico]
...
\begin{dmbox}[title=Leggere una Pergamena]
...
\begin{dmbox}[title=Massimo Livello Incantesimo lanciabile]
...
\begin{dmbox}[title=Fallimento Critico Prova di Magia]
...
\begin{dmbox}[title=Alterare la Magia]
\begin{itemize}[leftmargin=0.5cm,itemsep=-1pt,parsep=0pt]
...
\begin{dmbox}[title=Tentare Incantesimi con impedimenti]
