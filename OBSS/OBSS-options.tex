...
{\normalfont\Huge\bfseries\sffamily\color{OBSSnavyblue}}
{\textcolor{OBSSnavyblue}{\chaptertitlename\ \thechapter}}
{2ex}
{\centering}

\titleformat{\section}
{\normalfont\Large\bfseries\sffamily\color{OBSSnavyblue}}
{\thesection}
{1em}
{}
...
\NewDocumentCommand{\feat}{m}{
	...
	\index[Abilita]{#1}\hypertarget{#1}{}\label{#1}
	\vspace{-5.5mm}
	\begin{center}\textbf{\textcolor{OBSSprussia!90!black}{#1}}\end{center}
	\pdfbookmark[3]{#1}{#1}
	\vspace{-1mm}\noindent
}
...
%\newcolumntype{L}{>{\raggedright\arraybackslash}l<{\hspace{0.5cm}}}
...
% per resizedown
\newlength{\mytemptextwidth}
\newcommand{\resizedown}[2]{%
	\settowidth{\mytemptextwidth}{#2}%
	\ifdim\mytemptextwidth>#1%
	\resizebox{#1}{!}{#2}%
	\else%
	#2%
	\fi%
...
\section{Opzionale - Variante Iniziativa}\index{Opzionale - Variante Iniziativa}\hypertarget{varianteiniziativa}{}\label{varianteiniziativa}
...
\noindent\begin{tabularx}{1\linewidth}{Xc}
	...
	%	\rowcolor{gray!20}Scatto (doppio movimento) & 1\\
	...
	%	\rowcolor{gray!20}Attacco totale (sacrifica difesa per + attacchi)& 8\\
	%	Ritirata combattuta& 6\\
	%	\rowcolor{gray!20}Cambiare postura di combattimento& 2\\
	%	Puntare con arma da tiro& 2\\
	%	\rowcolor{gray!20}Ricaricare arma da tiro (balestra/arco)& 4\\
	Applicare veleno all'arma& 7\\
	%	\rowcolor{gray!20}Curare ferite base (primo soccorso)& 9\\
...
\smallskip\noindent\rule{\linewidth}{2pt} \index[Incantesimi]{Rianimare Morti}\hypertarget{Rianimare Morti}{}\medskip\noindent{\textbf{Rianimare Morti}}\pdfbookmark[2]{Rianimare Morti}{Rianimare Morti}
\noindent
...
\smallskip\noindent\rule{\linewidth}{2pt} \index[Incantesimi]{Sfera Elastica}\hypertarget{Sfera Elastica}{}\medskip\noindent{\textbf{Sfera Elastica}}\pdfbookmark[2]{Sfera Elastica}{Sfera Elastica}
\noindent
\begin{description}[noitemsep, topsep=0pt, parsep=0pt, partopsep=0pt, leftmargin=0cm, labelwidth=2.8cm]
...
\subsection{Conversione Mostri}\index{Conversione Mostri}
...
\begin{enumerate}[leftmargin=*] \setlength{\itemsep}{0pt}
	...
	%\textit{Esempio:} Un gruppo di 5 personaggi di livello 6 ha un APL di 6 (somma dei livelli = 30, 30/5 = 6)
...
\end{itemize}
	...
	Il Narratore stabilisce che il gruppo di 6 personaggi di livello 5 (APL 6) debba incontrare un gruppo di creature mannare.
...
\toprule
Burthelas \index{Burthelas} & I& 1 Turno & 32& Rigenera le mani& HD23 & 410\\
\toprule
Febfendi \index{Febfendi}& C& 1 Turno & 25& Rigenera orecchie& CF20 & 75 \\
\toprule
Musekiss\index{Musekiss} & C& 1 ora& 30& Rigenera arti inferiori & TH30 & 550\\
\toprule
Siranmuse\index{Siranmuse}& I& 1 giorno& 30& Rigenera organi interni & SS26 & 850\\
\toprule
Ucsaboo \index{Ucsaboo}& C& 1 Turno & 30& Rigenera occhi& MO25 & 400\\
\end{xltabular}}\normalsize
...
\smallskip* \textbf{Conduttiva}\index[OggettiMagici]{Armi Magiche!Conduttiva}\hypertarget{Conduttiva}{}
...
\index[OggettiMagici]{Armi Magiche!Terrore}\smallskip* \textbf{Terrore}\hypertarget{Terrore}{}
...
\smallskip* \textbf{Estingui Fuoco}\index[OggettiMagici]{Armi Magiche!Estingui Fuoco}\hypertarget{Estingui Fuoco}{}
...
\smallskip* \textbf{Marina}\index[OggettiMagici]{Armi Magiche!Marina}\hypertarget{Marina}{}
...
\smallskip* \textbf{Mutaforma}\index[OggettiMagici]{Armi Magiche!Mutaforma}\hypertarget{Armi Mutaforma}{}
...
\smallskip* \textbf{Planare}\index[OggettiMagici]{Armi Magiche!Planare}\hypertarget{Planare}{}
...
\smallskip* \textbf{Prensile}\index[OggettiMagici]{Armi Magiche!Prensile}\hypertarget{Prensile}{}
...
\smallskip* \textbf{Cacciatore}\index[OggettiMagici]{Armi Magiche!Cacciatore}\hypertarget{Cacciatore}{}
...
\smallskip* \textbf{Crudele}\index[OggettiMagici]{Armi Magiche!Crudele}\hypertarget{Crudele}{}
...
\smallskip* \textbf{Duello}\index[OggettiMagici]{Armi Magiche!Duello}\hypertarget{Duello}{}
...
\smallskip* \textbf{Tenace}\index[OggettiMagici]{Armi Magiche!Tenace}\hypertarget{Tenace}{}
...
\smallskip* \textbf{Designante}\index[OggettiMagici]{Armi Magiche!Designante}\hypertarget{Designante}{}
...
\smallskip\noindent\rule{\linewidth}{2pt} \index[OggettiMagici]{Letale} \hypertarget{Letale}{}\medskip\noindent{\textbf{Letale}}\pdfbookmark[3]{Letale}{Letale}\noindent\label{Letale}
...
\smallskip* \textbf{Amorfa}\index[OggettiMagici]{Armature e Scudi!Amorfa}\hypertarget{Amorfa}{}
...
\smallskip\noindent\rule{\linewidth}{2pt} \index[OggettiMagici]{Attaccabrighe} \hypertarget{Attaccabrighe}{}\medskip\noindent{\textbf{Attaccabrighe}}\pdfbookmark[3]{Attaccabrighe}{Attaccabrighe}\noindent\label{Attaccabrighe}

\textbf{Aura:} Trasmutazione debole; \textbf{Costo:} 15000 mo

\textbf{Requisiti:} Creare Oggetti Magici, Forza del Toro

\index[OggettiMagici]{Armature e Scudi!Attaccabrighe}
...
\smallskip\noindent\rule{\linewidth}{2pt} \index[OggettiMagici]{Bilanciata} \hypertarget{Bilanciata}{}\medskip\noindent{\textbf{Bilanciata}}\pdfbookmark[3]{Bilanciata}{Bilanciata}\noindent\label{Bilanciata}

\textbf{Aura:} Trasmutazione debole; \textbf{Costo:} 3000 mo

\textbf{Requisiti:} Creare Oggetti Magici,

\index[OggettiMagici]{Armature e Scudi!Bilanciata}
...
\smallskip\noindent\rule{\linewidth}{2pt} \index[OggettiMagici]{Carico} \hypertarget{Carico}{}\medskip\noindent{\textbf{Carico}}\pdfbookmark[3]{Carico}{Carico}\noindent\label{Carico}

\textbf{Aura:} Trasmutazione debole; \textbf{Costo:} 2000 mo

\textbf{Requisiti:} Creare Oggetti Magici, Armatura Passiva

\index[OggettiMagici]{Armature e Scudi!Carico}
...
\smallskip\noindent\rule{\linewidth}{2pt} \index[OggettiMagici]{Percettiva} \hypertarget{Percettiva}{}\medskip\noindent{\textbf{Percettiva}}\pdfbookmark[3]{Percettiva}{Percettiva}\noindent\label{Percettiva}

\textbf{Aura:} Divinazione forte; \textbf{Costo:} 15000 mo

\textbf{Requisiti:} Creare Oggetti Magici 3, Visione del Vero

\index[OggettiMagici]{Armature e Scudi!Percettiva}
...
\smallskip* \textbf{Selvatica}\index[OggettiMagici]{Armature e Scudi!Selvatica}\hypertarget{Selvatica}{}
...
\index[OggettiMagici]{Armature e Scudi!Tocco Fantasma}
...
\index[OggettiMagici]{Amuleto dei Piani}

\smallskip\noindent\rule{\linewidth}{2pt} \index[OggettiMagici]{Amuleto dei Piani} \hypertarget{AmuletodeiPiani}{}\medskip\noindent{\textbf{Amuleto dei Piani}}\pdfbookmark[3]{Amuleto dei Piani}{AmuletodeiPiani}\noindent\label{AmuletodeiPiani}
...
\index[OggettiMagici]{Amuleto di Protezione dalla Individuazione e Localizzazione}
...
\incantesimo{Dispel Evil and Good}
\begin{description}[noitemsep, topsep=0pt, parsep=0pt, partopsep=0pt, leftmargin=0cm, labelwidth=2.8cm]
