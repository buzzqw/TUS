...
\tikz[remember picture,overlay]  \node[opacity=1, xshift=(\paperwidth)*0.5+3.6cm,yshift=0.35cm,inner sep=0pt] at (current page.east){\includegraphics[width=21.8cm,height=\pdfpageheight]{copertina.png}};
