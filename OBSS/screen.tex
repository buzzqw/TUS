...
due volte 1, un 1 e due 2\\
	\end{textblock*}

\begin{textblock*}{5cm}(1cm,3.2cm) % larghezza box, coord X, coord Y
	\textbf{Distratto}\\
...
\begin{textblock*}{5cm}(1cm,7.9cm) % larghezza box, coord X, coord Y
\textbf{Punti Magia}\\
\begin{tabular}{ll|ll}
...
\textbf{Adepto della Magia - Competenza Magica - Livello Incantesimo}\index{Tabella Adepto della Magia - Competenza Magica - Livello Incantesimo}

\medskip
\begin{tabular}{ll|l|l|l|l}
	\hline
Abilità&0&1&2&3&Livello\\
	&&&&&Incantesimo\\
	CM&&&&&\\
