...
\begin{textblock*}{9cm}(1cm,22.8cm) % larghezza box, coord X, coord Y
...
\end{textblock*}
	...
	\begin{textblock*}{8cm}(10.5cm,22.8cm) % larghezza box, coord X, coord Y
\textbf{Sopravvivenza}
\begin{tabular}{ll}
...
3d6 + 1d6*(1/6 Comp. Magica)\\
Fallimento Critico: due volte 1, un 1 e due 2\\
	\end{textblock*}

\begin{textblock*}{5cm}(1cm,3.6cm) % larghezza box, coord X, coord Y
	\textbf{Distratto}\\
Prova di Magia. No perdita Punti Magia. No effetti negativi.\\
-- Nascondere il lancio di incantesimi \\
-- Impedito, disturbato, sanguinante, sotto attacco (-4 Difesa)\\
\end{textblock*}
...
\begin{tabularx}{0.95\textwidth}{lX}
	...
	9 & Il battito del tuo cuore e' come il battito di un tamburo, si puo sentire entro 50 metri\\
	...
	13 & Perdi 10 Punti Magia\\
	14 & Perdi 10 Punti Ferita\\
	15 & Ogni oggetto che tieni in mano ti cade a terra\\
	16 & I tuoi vestiti non magici scompaiono\\
...
\begin{textblock*}{5cm}(1cm,8.3cm) % larghezza box, coord X, coord Y
\textbf{Punti Magia}\\
\begin{tabular}{ll|ll}
...
\begin{textblock*}{5cm}(1cm,15.1cm) % larghezza box, coord X, coord Y
...
\begin{textblock*}{5cm}(1cm,19.4cm) % larghezza box, coord X, coord Y
\textbf{Tiro Salvezza Magia Oggetto}\\
DC = 10 + 2 x livello incantesimo manifestato
\end{textblock*}


\begin{textblock*}{13.5cm}(6.5cm,20.6cm) % larghezza box, coord X, coord Y
