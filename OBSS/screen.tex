...
\begin{textblock*}{5cm}(1cm,21.5cm) % larghezza box, coord X, coord Y
	\textbf{Tiro Salvezza Incantesimo Mostro}\\
Se non indicato la DC di un incantesimo lanciato da un mostro è 10 + livello incantesimo + 2 x Intelligenza
\end{textblock*}
