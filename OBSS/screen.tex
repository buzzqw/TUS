...
\begin{textblock*}{4cm}(16cm,23.5cm) % larghezza box, coord X, coord Y
...
\begin{textblock*}{5cm}(1cm,23.1cm) % larghezza box, coord X, coord Y
{\small
\textbf{Quando si hanno < 50\& Punti Magia} ogni incantesimo deve essere fatto con una Prova di Magia.}
\end{textblock*}

\begin{textblock*}{5cm}(1cm,25.1cm) % larghezza box, coord X, coord Y
{\small
\textbf{Successo Critico Automatico}:  x2 costo Punti Magia cumulativo. Es. 4,8,16,32..}
\end{textblock*}

\begin{textblock*}{5cm}(1cm,27.1cm) % larghezza box, coord X, coord Y
