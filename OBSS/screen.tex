...
-- Nascondere il lancio di incantesimi, Impedito, disturbato, sanguinante, sotto attacco (-4 Difesa)\\
\end{textblock*}
...
\begin{textblock*}{5cm}(1cm,13.6cm) % larghezza box, coord X, coord Y
...
\begin{textblock*}{5cm}(1cm,17.9cm) % larghezza box, coord X, coord Y
\textbf{Tiro Salvezza Magia da Oggetto}\\
DC = 10 + 2 x livello incantesimo manifestato
\end{textblock*}

\begin{textblock*}{5cm}(1cm,20cm) % larghezza box, coord X, coord Y
...
\begin{textblock*}{13.5cm}(6.5cm,15.8cm) % larghezza box, coord X, coord Y
...
\end{textblock*}
{\small
\begin{textblock*}{19cm}(1cm,23.2cm) % larghezza box, coord X, coord Y
\textbf{Alterare la Magia}

	\textbf{Magia efficace}: Incantatore o compagno Ignora un 1 tirato nella Prova di Magia ogni 4 punti ferita sacrificati.
