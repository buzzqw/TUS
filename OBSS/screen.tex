...
\textbf{Prono}\index{Prono}: chi è prono ha un -1d6 ad attaccare ed un -4 alla Difesa. Costa due Azioni alzarsi. Il personaggio può eseguire una prova di Acrobatica se fai 13 o più costa 1 Azione alzarsi. Se tiri tre 1 nella prova prova non puoi fare altre azioni quel round e rimani  prono.
...
\textbf{Azioni per Round}
	...
	\begin{textblock*}{4cm}(16cm,7.5cm) % larghezza box, coord X, coord Y
