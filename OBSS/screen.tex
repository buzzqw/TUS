...
\textbf{Aumento Categoria di danno} 1d4 > 1d6 > 1d8 > 1d10/1d12 > 2d6 > 2d8 > 2d10 > 3d6 > 3d8 > 3d10
...
\textbf{Afferrato}\index{Afferrato}: No movimento. Puo' Spingere. 2 Azioni TS Tempra contrapposto con bonus Forza +1d6 per Taglia di differenza per liberarsi. -2 Difesa. Si attacco armi piccole.
...
\textbf{Prono}\index{Prono}: -4 TC, -4 Difesa. 2 Azioni o 1 AZ + Acrobatica 13
...
\hline
\textbf{-2}& Affaticato (2), Abbagliato, Intralciato & Affaticato (2), Afferrato, Lanci un incantesimo mentre sei sotto attacco\\
\hline
\textbf{-4}& Affaticato (3), Prono, Arma Lunga a corta distanza, attacco non letale con arma letale& Affaticato (3), Sorpreso, Prono, In ginocchio, Seduto, Ristretto, Stordito, Afferrato ad una parete, Bloccato\\
\hline
...
\textbf{Riposare 8 ore} \\fa recuperare CA o CM x COS, minimo 1.
...
\begin{textblock*}{12cm}(1cm,13.6cm) % larghezza box, coord X, coord Y
...
\begin{textblock*}{6cm}(13.4cm,13.6cm) % larghezza box, coord X, coord Y
