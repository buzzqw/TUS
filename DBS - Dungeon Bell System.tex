...
\item
Una creatura che non sia sotto l'incantesimo \emph{Libertà di movimento} o una velocità di Nuotare effettua i Tiri per Colpire con un -2d6. Armi come Tridente, Lancia corta o molte armi da punta riducono la penalita' a -1d6.
\item
Se non si ha una movimento di tipo Nuotare ci si può muovere a un quarto del movimento per Azione di Movimento.
\item
Le creature dotate di appoggio solido, es. che stanno camminando sul fondo, hanno movimento dimezzato (terreno difficile)
\end{itemize}
\medskip
