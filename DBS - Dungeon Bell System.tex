...
E' importante che tu abbia una buona conoscenza delle regole base e che, soprattutto, sappia dove cercare quando ti servira'!
...
\textbf{Difesa:} \index{Difesa}per Difesa si intende il valore totale ottenuto da 10 + Scudo + Armatura + Agilità + vari ed eventuali bonus. Rappresenta la difficolta' nel colpire, piu' alto e' piu' e' difficile colpire.
...
Ha la possibilita' di cambiare energia negli incantesimi da danno, ha il Vantaggio offerto dal Patrono ed un +2 ad una Scuola di Magia. Vedi anche Seguace
...
I Tiri Salvezza riguardano i riflessi e lo schivare (Agilità), resistere a veleni/malattie o cambiamenti del corpo (Potenza) oppure per resistere ad attacchi mentali ed effetti che agiscano sull'arbitrio (Volonta').
...
Anche se raramente un personaggio effettua una prova usando soltanto una sua Caratteristica, i punteggi di Caratteristica influiscono praticamente su ogni aspetto delle capacità e delle competenze del personaggio.
...
\textbf{Arcano}(Intelletto):\index{Arcano} Conoscenza arcana, piani, occulta, incantesimi, creature magiche

\textbf{Consapevolezza} (Volonta'):\index{Consapevolezza} percezione, percepire inganni, nascondersi nelle ombre

\textbf{Cultura} (Intelletto): \index{Cultura}geografia, creature e piante naturali, erboristeria, storia, religione, tradizioni e storia locale, dungeon, ingegneria, falsificare, lingue

\textbf{Criminalità} (Agilità):\index{Criminalita} travestirsi, disattivare congegni, artista della fuga, mani di fata, muoversi silenziosamente
...
\begin{note}
Non fate che siano le prova a governare il vostro gioco. Fate giocare i giocatori, fateli recitare, fateli partecipare ed in base a quanto dicono stabilite se la prova e' passata o meno. \\
...
Il \textbf{valore nelle prove dinamiche} è da usarsi quando la prova viene fatta tirando i 3d6, in questo caso si potranno sommare bonus (+2) o addirittura tirare dadi in più (+2d6) o se in svantaggio dadi in meno, fino a tirare solo 1d6 (con 2d6 di penalita')

Si intendono prove a valore fisso quando non è necessario tirare dei dadi (es. Difesa), in questo caso il punteggio si alza/abbassa del punteggio indicato.
...
Sapere la geografia astrale dei piani, sapere usare un oggetto magico intuendone le funzioni, riconoscere creauture magiche (la DC è il grado di Sfida della creatura modificato dalla rarità della stessa). Riconoscere o sapere formulare rituali non standard.
...
\begin{tabularx}{1\textwidth}{XXl|XXl}
	\toprule
	\textbf{Razza}& \textbf{Linguaggio Parlato} & \textbf{Scritto}&	\textbf{Razza}& \textbf{Linguaggio Parlato} & \textbf{Scritto}\\
	...
	Linguaggi Speciali*		  & Linguaggio dei Segni& -&Linguaggi Speciali*		  & Linguaggio Druidico			& Druidico\\ 
...
Il giocatore sceglie la caratteristica che preferisce. Se viene scelta Agilità saranno i riflessi a determinare la reazione del personaggio, mentre Intelletto guiderà la capacità di cogliere le tattiche dell'avversario ed anticiparle.
...
Se un personaggio dichiara di fare una certa Azione in conseguenza di un'altra vuol dire che ritarda la propria azione, ciò gli sarà possibile solo se ha ancora Azioni da spendere nel round. La sua Azione potra' arrivare prima o dopo l'Azione scatenante a  ed è più veloce di colui che deve compiere l'azione che scatena l'Azione (Es. se il mago incomincia a formulare un incantesimo gli tiro una freccia)
...
Nella tabella sottostante sono indicate le Azioni principali che un personaggio può eseguire, sono linee guida da seguire. Nel capitolo dedicato al combattimento vengono elencate altre Azioni ed i loro costi, in Azioni, relativi.
...
La Difesa è un valore fisso e come tale non è soggetta a modifiche causate dalle regole base delle Competenze.
...
Usare un'Arma senza l'adeguata competenza impone un -2d6 al Tiro per Colpire (quindi il TC diventa 1d6+Potenza+abilità..)
...
\subsubsection{Magia in combattimento}\index{Magia in combattimento} l'incantatore che lancia una magia mentre è in combattimento prende un -4 alla Difesa. Se viene colpito prima di formulare l'magia la prova di competenza magica deve superare la Difficoltà dell'incantesimo + il danno subito.\\
...
\begin{itemize}
	...
	\item 4 punti: La tua maestria nella tecnica della spada ti conferisce +1 a danno, Tiro per Colpire e CA
...
Se colpisci 3 volte consecutivamente (fino a 3 round distinti ma consecutivi) un avversario questo deve fare una Tiro Salvezza su Tempra DC 10+1/CA + Potenza o cadere prono.
...
Quanto un compagno (o te stesso) scende sotto meta'’ dei punti ferita guadagni un +1 a CA e Tiro per Colpire e Tiri Salvezza. La durata massima dell’effetto e’ 1 minuto (10 round) al giorno e deve essere consecutiva. Il giocatore sceglie se attivare o meno l’abilita’.
...
\textbf{Ira} \index{Ira}5: sei capace di infuriarti. +2 POT -1 CA. Ogni altri 5 punti +2 POT -1 a CA Max 20 punti. Durata 4 (anche non consecutivi)round ogni 5 punti. Si attiva come Azione a costo 1.
...
\textbf{Senso delle vibrazioni} \index{Senso delle vibrazioni} \index{Senso Tellurico} (Senso Tellurico) 30: tutto emette vibrazioni, o quasi, raggio di 18 metri intorno a te
...
I \textbf{Vantaggi} indicati sono applicati al Seguace e Devoto. \index{Vantaggi}

Infine ogni Patrono concede l'accesso a tutte le scuole di magia pero' tra tutte ne predilige una, su questa, indicata nella descrizione del Patrono il mago ha un +2 alle prove di CM.
...
\textbf{Scuole Privilegiate}: Universale, Invocazione, Abiurazione (+2 alle prove di CM)\\
...
Tratto in comune a 20 punti: Crei una zona di energia protettiva attorno a te nel raggio di 3 metri, dimezzi tutto il danno che ricevi, non puoi curarti nel mentre. Durata 10 minuti consecutivi, 1 volta al giorno.
...
\textbf{Scuole Privilegiate}: Invocazione, Negromanzia (+2 alle prove di CM)\\
...
Tratto in comune a 20 punti: Sei in grado di animare una creatura morta da non più di un giorno come non morto da 1 grado di Sfida (tipo zombi/scheletro a secondo dello stato). Una volta al giorno. Costo 2 Azioni.
...
Scuole Privilegiate: una a scelta (+2 alle prove di CM)\\
...
Bolas& 4& P/1d3 B&\textbf{Intralcianti}, intralciato& L\\
...
\begin{tabularx}{0.95\textwidth}{lccXc}
	...
	Rete& 8& M-&\textbf{Bloccanti}, intralciato& 1\\
...
Un Armatura o Scudo magico aggiunge un +20 alla resistenza totale per ogni +1 magico posseduto, oltre ad eventuali bonus aggiuntivi alla Difesa
...
\textbf{Combattimento sott'acqua}	
...
\begin{itemize}
\item
Una creatura sott'acqua perde il bonus di Agilita' alla Difesa.
\item
Una creatura che non sia sotto l'incantesimo \emph{Libertà di movimento} o una velocità di Nuotare effettua i Tiri per Colpire con un -1d6
\item
Se non si ha una movimento di tipo Nuotare ci si può muovere a un quarto del movimento per Azione di Movimento.
\item
Le creature dotate di appoggio solido che stanno camminando sul fondo hanno movimento dimezzato (terreno difficile)
\end{itemize}
\medskip

\textit{Attacchi a distanza sott’acqua}\\
Le armi da lancio sono inefficaci sott’acqua, anche quando vengono lanciate da terra. Gli attacchi con le armi a distanza subiscono penalità –2 ai tiri per colpire per ogni 1,5 metri d’acqua che attraversano\\

\textit{Attacchi dalla terraferma}\\
...
\textbf{Fuoco}: Il fuoco non magico (incluso il fuoco dell’alchimista) non brucia sott’acqua. Gli incantesimi o gli effetti magici di fuoco sono inefficaci sott’acqua.

\textit{Lanciare incantesimi sott’acqua}\\
...
\textbf{Tabella: Modificatori al grado di Sfida delle Trappole Meccaniche}
...
Per esempio, volete che il vostro gruppo di sei personaggi di 8° livello affronti alcuni Gargoyle (CR 4 ciascuno) e il loro capo, un Gigante delle Rocce (CR 8). I personaggi hanno APL 9 e la Tabella: Determinare gli Incontri stabilisce che unasfida Alta per un APL 9 è un incontro di grado di Sfida 10.
...
Nel nostro esempio un Gigante delle Rocce ha grado di Sfida 8, ovvero un grado di Sfida -2 rispetto al nostro obiettivo di difficoltà grado di Sfida 10, ed i Gargoyle hanno grado di Sfida 4 ovvero -6 rispetto al grado di Sfida 10.

Un nemico con grado di Sfida -2 ha peso 50, un grado di Sfida -6 ha un peso di 10, per raggiungere l'obiettivo di un grado di Sfida 10 metterò 1 grado di Sfida -2 ( ovvero UNO gigante delle rocce) e 5 grado di Sfida -6 (ovvero CINQUE gargoyle) perché 50 + 10{*}5 = 100

Se avessi avuto come obiettivo un grado di Sfida 8, avrei potuto mettere 3 grado di Sfida 5 (CR -3 = 30) ed un grado di Sfida 2 (CR -6 = 10), oppure 5 grado di Sfida 4 (CR +4 = 20)
...
Quindi una Pergamena con Invisibilita' costa 15*15*5=675 mo\\
...
{*} Armature e scudi non possono avere bonus alla Difesa superiore a +5. Usate queste indicazioni per determinarne il prezzo quando vengono aggiunte delle Capacità Speciali.
...
Aura Invocazione moderata; CM 8; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Luce Incandescente; Costo bonus +1.
...
Aura Invocazione forte;CM 12; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, creatore di almeno 12° livello; Costo bonus +1.
...
Aura Trasmutazione moderata;CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Forza del Toro, Movimenti del Ragno; Costo +3.500 mo.
...
Aura Trasmutazione moderata;CM 9; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Forma Fluida; Costo +2.250 mo.
...
Aura Trasmutazione forte;CM 12; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Animare Oggetti; Costo bonus +2.
...
Aura Trasmutazione moderata;CM 8; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Cura Ferite Critiche, Ristorare Inferiore o Stabilizzare; Costo bonus +1.
...
Aura Invocazione debole;CM 5; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Pugno di Forza; Costo bonus +1.
...
Aura Abiurazione moderata;CM 9; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Pelle di Pietra; Costo bonus +1.
...
Aura Trasmutazione debole;CM 4; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Forza del Toro; Costo bonus +3.
...
Aura Abiurazione moderata;CM 8; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Scudo Entropico; Costo bonus +1.
...
Aura Ammaliamento debole;CM 5; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Aiuto; Costo bonus +1.
...
Aura Trasmutazione debole;CM 5; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Grazia del Gatto; Costo bonus +1.
...
Aura Invocazione moderata;CM 6; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Luce Diurna; Costo +3.750 mo.
...
Aura Ammaliamento debole;CM 5; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Calmare Emozioni; Costo bonus +1.
...
Aura Abiurazione debole;CM 5; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Protezione dal Bene o Protezione dal Male; Costo bonus +1.
...
Aura Trasmutazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Armatura Passiva; Costo +2.000 mo.
...
Aura Trasmutazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Estremità Affilata; Costo bonus +1.
...
Aura Evocazione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Respiro di Vita; Costo +15.000 mo.
...
Aura Abiurazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Scudo; Costo bonus +2.
...
Aura Trasmutazione forte; CM 13; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Transizione Eterea; Costo +24.500 mo.

\textbf{Fortificazione}
Questa armatura o scudo genera una forza magica che protegge con più efficacia le parti vitali di chi li indossa. Quando un Colpo Critico o un Attacco Furtivo vanno a segno su chi li indossa, c'è una probabilità che vengano negati e che il danno venga invece tirato normalmente. La probabilità è del 25\% per la Fortificazione Leggera, del 50\% per la Fortificazione Moderata e del 75\% per la Fortificazione Pesante. Aura Abiurazione forte; CM 13; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Desiderio Limitato o Miracolo; Costo bonus +1 (leggera), bonus +3 (moderata), bonus +5 (pesante).
...
Aura Trasmutazione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Giusto Potere; Costo +13.500 mo.
...
Aura Abiurazione moderata; CM 8; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Scudo su Altri; Costo bonus +1.
...
Aura Abiurazione forte; CM 12; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Scudo su Altri; Costo bonus +2.
...
Aura Abiurazione moderata; CM 7; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Interdizione alla Morte; Costo bonus +1.
...
Aura Abiurazione forte; CM 12; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Espiazione; Costo bonus +1.
...
Aura Abiurazione forte (Invocazione se viene usato Miracolo); CM 18; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Desiderio, Miracolo o Pelle di Pietra; Costo bonus +3.
...
Aura Trasmutazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Passare Senza Tracce; Costo +3.750 mo.
...
Aura Evocazione moderata; Difficoltà 30; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Cura Ferite Leggere di Massa; Costo +9.000 mo.
...
Aura Illusione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Camuffare Se Stesso; Costo +1.350 mo.
...
Aura Abiurazione e Invocazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere; Resistere all'Energia, Stretta Folgorante; Costo + 2.500 mo.
...
Aura Illusione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Invisibilità, Silenzio; Costo +1.875 mo.
...
Aura Illusione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Invisibilità, Silenzio; Costo +7.500 mo.
...
Aura Illusione forte; CM 15; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Invisibilità, Silenzio; Costo +16.875 mo.
...
Aura Evocazione moderata; Difficoltà 33; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Scrigno Segreto; Costo +3.750 mo.
...
Aura Divinazione forte; CM 14; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Visione del Vero; Costo bonus +3.
...
Aura Evocazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Nube Maleodorante; Costo +5.000 mo.
...
Aura Trasmutazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Ritirata Rapida; Costo +2.000 mo.
...
Aura Abiurazione forte; CM 15; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Resistenza agli Incantesimi; Costo bonus +2 (RI 13), bonus +3 (RI 15), bonus +4 (RI 17) o bonus +5 (RI 19).
...
Aura Trasmutazione debole; CM 7; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Neutralizza Veleno; Costo +1.125 mo.
...
Aura Abiurazione debole; Difficoltà 18; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Resistere all'Energia; Costo +9.000 mo.

\textbf{Resistenza all'Energia Migliorata}
Questo tipo di armatura o scudo protegge contro un tipo di energia (acido, freddo, elettricità, fuoco o sonoro) ed è decorata da disegni che raffigurano l'elemento dal quale protegge. L'armatura o lo scudo assorbono i primi 20 danni di energia per attacco che verrebbero subiti normalmente da chi li indossa (come l'incantesimo Resistere all'Energia).

Aura Abiurazione moderata; CM 7; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Resistere all'Energia; Costo +21.000 mo.

\textbf{Resistenza all'Energia Superiore}
Questo tipo di armatura o scudo protegge contro un tipo di energia (acido, freddo, elettricità, fuoco o sonoro) ed è decorata da disegni che raffigurano l'elemento dal quale protegge. L'armatura o lo scudo assorbono i primi 30 danni di energia per attacco che verrebbero subiti normalmente da chi li indossa (come l'incantesimo Resistere all'Energia).

Aura Abiurazione moderata; CM 11; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Resistere all'Energia; Costo +33.000 mo.
...
Aura Abiurazione forte; CM 14; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Riflettere Incantesimo; Costo bonus +5.
...
Aura Abiurazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Rimuovi Paura; Costo +2.500 mo.
...
Aura Negromanzia debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Sonnellino; Costo +2.250 mo.
...
Aura Trasmutazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Ammorbidire Terra e Pietra; Costo +5.000 mo.
...
Aura Ammaliamento debole; Difficoltà 20; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Armatura Magica; Costo bonus +2.
...
Aura Evocazione debole; Difficoltà 20; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Unto; Costo +1.875 mo.
...
Aura Evocazione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Unto; Costo +7.500 mo.
...
Aura Evocazione forte; CM 15; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Unto; Costo +16.875 mo.
...
Aura Trasmutazione moderata; Difficoltà 33; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Metamorfosi Funesta; Costo bonus +3.
...
Aura Trasmutazione moderata; CM 8; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Forza del Toro; Costo bonus +1.
...
Aura Invocazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Mani Brucianti; Costo +2.500 mo.
...
Aura Ammaliamento debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Eroismo; Costo bonus +1.
...
Aura Trasmutazione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Giusto Potere, il creatore deve essere caotico; Costo +13.500 mo.
...
Aura Abiurazione moderata; CM 8; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Riflettere Incantesimo; Costo bonus +1.
...
Aura Evocazione moderata; CM 8; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Evoca Mostri I; Costo bonus +1.
...
Aura Illusione e Trasmutazione moderata; CM 7; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Grazia del Gatto, Invisibilità; Costo +2.500 mo.
...
Aura Invocazione moderata; Difficoltà 25; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Frantumare; Costo bonus +2.
...
Aura Trasmutazione moderata; CM 7; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Ingrandire Persone; Costo bonus +3.
...
Aura Trasmutazione forte; CM 15; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Forma Eterea; Costo bonus +3.
...
Aura Trasmutazione debole; CM 5;  Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, il creatore deve avere almeno 5 gradi in Cavalcare; Costo +1.875 mo.
...
Aura Trasmutazione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Giusto Potere, il creatore deve essere legale; Costo +13.500 mo.
...
Aura Trasmutazione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Estremità Affilata; Costo bonus +1
...
Aura Invocazione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Freccia Acida; Costo bonus +1.
...
Aura Trasmutazione forte; CM 15; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Animare Oggetti; Costo bonus +4.
...
Aura Abiurazione moderata; CM 8; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Scudo o Scudo della Fede; Costo bonus +1.
...
Aura Divinazione moderata; CM 6; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Chiaroudienza/Chiaroveggenza; Costo bonus +1.
...
Aura Evocazione forte; CM 14; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Guarigione; Costo bonus +2.
...
Aura Trasmutazione forte; CM 16; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Fiamma Perenne, Forma Gassosa; Costo bonus +4.
...
Il Sanguinamento può essere fermato con una prova di Guarire con DC 15 o con un'incantesimo di cura ferite. Un colpo critico non aggiunge ulteriore danno da Sanguinamento.

Le creature immuni ai colpi critici sono immuni ai danni da Sanguinamento inflitti da quest'arma.

Aura Invocazione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Dissanguare; Costo bonus +2.
...
Aura Trasmutazione moderata; CM 6; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Incanalare Punizione, Allineare Arma; Costo bonus +1.
...
Aura Invocazione moderata; CM 8; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Fulmine o Invocare il Fulmine; Costo bonus +1.
...
Aura Invocazione moderata; CM 8; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Gelare il Metallo o Tempesta di Ghiaccio; Costo bonus +1.
...
Aura Invocazione forte; CM 12; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Colpo Infuocato, Lama Infuocata o Palla di Fuoco; Costo bonus +2.
...
Aura Invocazione moderata; CM 10; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Colpo Infuocato, Lama Infuocata o Palla di Fuoco; Costo bonus +1.
...
Aura Trasmutazione debole; CM 5°; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Pietra Magica; Costo bonus +1.
...
Aura Ammaliamento moderato; CM 7; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Ira; Costo bonus +2.
...
Aura Evocazione debole; CM 5; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Cura Ferite Leggere; Costo bonus +1.
...
Aura Ammaliamento moderato; CM 7; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Trucco della Corda; Costo +2.500.
...
Aura Trasmutazione moderata; CM 7; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Telecinesi; Costo bonus +1.
...
Aura Evocazione moderata; CM 9; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Spostamento Planare; Costo bonus +1.
...
Aura Negromanzia debole; CM 5; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Cecità/Sordità; Costo bonus +1.
...
Aura Trasmutazione moderata; CM 10°; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Creazione Maggiore; Costo +5.000 mo.
...
Aura Trasmutazione forte; CM 16; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Animare Oggetti; Costo bonus +5.
...
Aura Negromanzia e Trasmutazione forte; CM 18; Requisiti base Creare Oggetti Magici appropriato alla Difficoltà degli Incantesimi da infondere, Cerchio di Morte, Estremità Affilata; Costo bonus +5.
...
\begin{tabular}{lllll}
	...
	99-100           & 62-66              & - & Anello di camminare sull'acqua\index{Anello di camminare sull'acqua}     & 18000\\
	...
	-& -  & 66-70             & Anello delle stelle cadenti \index{Anello delle stelle cadenti}          & 50000\\
...
\textbf{Esausto}:\index{Esausto} Un personaggio esausto si muove a velocità dimezzata e subisce penalità -3 a Potenza e Agilità. Dopo 1 ora di completo riposo (o Ristorare Inferiore), un personaggio esausto diventa solo Affaticato. Un personaggio Affaticato diventa esausto compiendo un'azione che normalmente lo affaticherebbe.
...
\textbf{In Lotta}:\index{Lotta} Una creatura in lotta è trattenuta da una creatura, da una trappola o da un effetto. Le creature in lotta non possono muoversi e subiscono penalità -2 a Agilità. Una creatura in lotta subisce penalità -2 a Tiro per Colpire e Difesa. Inoltre, le creature in lotta non possono compiere azioni che richiedano due mani per essere effettuate.
...
{\footnotesize
    ...
    1.0.0 DBS aggiunta scurovisione, dettagli su statistiche basse, aggiunte scuole di magia agli incantesimi ed ai patroni e divinita',modificata la prova di concentrazione resa piu' lineare, chiarimenti su elementi e patroni ed incantesimi, associato ad ogni patrono un vantaggio, primo approccio all'associazione patrono scuole di magia, punti fato da usare prima del tiro e non dopo,  rimossi riferimenti a CR e messo grado di Sfida, indicazioni su taglia arma, terminato lavoro su mostri sicuramente ci sono molte correzioni per non parlare di allineare ulteriormente DC, TC, Difesa
}
