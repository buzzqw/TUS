...
\emph{Media non morto, qualsiasi Tratti}\\
\textbf{Forza}: -2\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +0\\
\textbf{Intelligenza}: +0\\
...
\emph{Media non morto, qualsiasi Tratti malvagio}
\textbf{Forza}: +1\\
\textbf{Destrezza}: +3\\
\textbf{Costituzione}: +1\\
\textbf{Intelligenza}: +5\\
...
\emph{Media umanoide (qualsiasi razza), qualsiasi Tratti}\\
\textbf{Forza}: +2\\
\textbf{Destrezza}: +1\\
\textbf{Costituzione}: +2\\
\textbf{Intelligenza}: +0\\
...
\emph{Media umanoide (qualsiasi razza), qualsiasi Tratti non buono}\\
\textbf{Forza}: +3\\
\textbf{Destrezza}: +0\\
\textbf{Costituzione}: +3\\
\textbf{Intelligenza}: +0\\
