...
In un punto nella gittata, crei un’arma spettrale fluttuante, che resta per la durata o finché non lanci di nuovo questo incantesimo. Quando lanci l’incantesimo, puoi effettuare un attacco da mischia con incantesimo contro una creatura entro 1 metro dall’arma. Se colpisci, il bersaglio subisce danni da forza pari a 1d8 + il tuo valore di caratteristica da incantatore. Durante il tuo turno, con un’azione bonus, puoi spostare l’arma di 6 metri e ripetere l’attacco contro una creatura entro 1 metro dall’arma. L’arma può assumere qualsiasi forma tu voglia, magari affine al Patrono.\\
...
Tramite il contatto puoi infliggere malattie. Effettua un attacco da mischia con incantesimo contro una creatura a portata. Se colpisci, infetti la creatura con una malattia a tua scelta tra quelle descritte di seguito. Al termine di ciascun turno del bersaglio, esso deve effettuare un tiro salvezza su Tempra. Dopo aver fallito tre di questi tiri salvezza, gli effetti della malattia permangono per la durata, e la creatura non effettua più tiri salvezza. Dopo aver superato tre di questi tiri salvezza, la creatura recupera dalla malattia, e l’incantesimo ha termine. \\
...
\textbf{Componenti}: V, S\\
\textbf{Durata}: Concentrazione, massimo 1 minuto\\
Questo incantesimo conferisce speranza e vitalità. Scegli un qualsiasi numero di creature a gittata. Per la durata, ciascun bersaglio ha +1d6 ai tiri salvezza su Saggezza e ai tiri salvezza da morte, e da ogni cura ottiene il massimo numero di punti ferita possibili.
...
\textbf{Durata}: Concentrazione, massimo 1 ora \\
Questo incantesimo trasforma una creatura a gittata, che puoi vedere, in una nuova forma. Una creatura non consenziente deve superare un tiro salvezza su Saggezza per evitare l’effetto. I mutaforma superano automaticamente il tiro salvezza. L’incantesimo non ha effetto su di un bersaglio con 0 punti ferita. \\
...
I mutaforma ignorano questo incantesimo. Una creatura non consenziente può effettuare un tiro salvezza su Saggezza e, se lo supera, ignora l’effetto di questo incantesimo.\\
...
Al termine di ciascun suo round, e ogni volta che subisce danni, il bersaglio può effettuare un altro tiro salvezza su Saggezza. Il bersaglio ha +1d6 al tiro salvezza se questo è stato provocato dai danni. Se lo supera, l’incantesimo termina.
...
Potenza 2 e non può attaccare. Se scende a 0 punti ferita,
...
prova di Potenza contro la DC del tiro salvezza
...
Qualsiasi creatura che termini il suo round entro 1,5
...
creature hanno ha -1d6 ai tiri per colpire contro di
...
dal sonno.
Ammalato. Il bersaglio ha ha -1d6 ai tiri per colpire
...
ciascun suo round, la creatura spaventata deve
...
su Costituzione, subendo 10d10 danni da Vuoto se lo
...
lontano dal glifo durante ciascuno suo round, se in
grado.
...
Costituzione all’inizio di ciascun suo round. Se supera il
...
contesa da una prova di Potenza della creatura. Se vinci
...
Potenza della creatura. Se vinci la contesa, trascini via
...
subisce 2d8 danni da botta e 4d6 danni da freddo
...
turno o inizia il suo round lì, deve effettuare un tiro
...
creatura sotto la nube subisce 2d6 danni da botta.
...
prima volta in un turno o comincia qui il suo round, la
creatura deve superare un tiro salvezza su Agilità o
subire 3d6 danni da botta e rimanere intralciata dai
tentacoli fino al termine dell’incantesimo. Una creatura
che inizia il suo round nell’area ed è già intralciata dai
tentacoli, subisce 3d6 danni da botta.
Una creatura intralciata dai tentacoli può usare la sua
azione per effettuare una prova di Potenza o Agilita' (a
...
un tiro salvezza su Tempra. Se lo fallisce, la sua
...
Strutture. Il tremore infligge 50 danni da botta a
...
fallisce, la creatura subisce 5d6 danni da botta,
cade prona ed è sommersa dalle macerie. Dovrà poi
impiegare un’azione riuscendo una prova di Potenza
...
danni da Vuoto, e non può recuperare punti ferita fino
...
3d6 danni da Vuoto, e tu recuperi un numero di punti
...
celestiale, fatato o demone (a tua scelta) invece del
...
demone (a tua scelta) invece di una bestia.
...
nell’area o termina il suo round lì, deve superare un tiro
...
ha +1d6 ai tiri salvezza su Agilità, e ottiene
un’azione aggiuntiva durante ciascun suo round.
...
prima volta durante un turno, o inizia il suo round al suo
