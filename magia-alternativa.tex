...
%volare, invisibilita togliere concentrazione

%controllare presenza parole:  , saggezza, intelligenza .., radiosa radiante
...
Quando l'incantesimo ti dice di fare un tiro per colpire se e' un incantesimo a distanza devi effettuare un TC contro la Difesa a Tocco dell'avversario (tranne se sorpreso che allora perde anche il bonus di Agilità). Questo Tiro per Colpire e' effettuato con 3d6+CA+Agilita' più Abilita' e modificatori vari.

Se il tiro per colpire e' a tocco la Difesa del bersaglio e' sempre a Tocco ma il bonus applicato è Potenza invece di Agilità.
...
\textbf{Durata}: Concentrazione, massimo 1 minuto\\
Una fascio di luce brillante esplode dalla tua mano in una linea larga 1 metri e lunga 18 metri. Ogni creatura sulla linea deve effettuare un tiro salvezza su Tempra. Se fallisce il tiro salvezza, la creatura subisce 6d8 danni da Luce e rimane accecata fino al tuo prossimo turno. Se supera il tiro salvezza, subisce la metà dei danni e non è accecata. I non morti e le melme hanno svantaggio su questo tiro salvezza. Puoi creare una nuova linea di luminosità con un’azione durante qualsiasi tuo turno fino al termine dell’incantesimo.\\
...
Quando una creatura entra nel vortice per la prima volta durante un turno o inizia lì il suo round, deve effettuare un tiro salvezza su Tempra. Se lo fallisce, la creatura subisce 2d8 danni da botta e viene catturata dal vortice fino al termine dell’incantesimo. Se supera il tiro salvezza, la creatura subisce la metà di questi danni, e non è catturata dal vortice. Una creatura catturata dal vortice può usare la sua azione per cercare di nuotare via dal vortice come descritto sopra, ma ha svantaggio alle prove di Potenza (Atletica) per farlo. La prima volta durante ciascun turno in un cui un oggetto entra nel vortice, l’oggetto subisce 2d8 danni da botta; questo danno viene subito ogni round in cui l’oggetto rimane nel vortice.
\end{itemize}
...
\medskip\textbf{Mani Brucianti}\index{Mani Brucianti}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
...
\medskip\textbf{Mano Arcana}\index{Mano Arcana}\\
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
...
\begin{itemize}
\item
\textit{Mano Afferrante}. La mano cerca di afferrare una creatura di taglia Enorme o più piccola che si trovi entro  1 metro da essa. Per risolvere l’azione di lottare usi la Forza della mano. Se il bersaglio è di taglia Media o inferiore, hai vantaggio alla prova. Mentre la mano tiene afferrato il bersaglio, puoi usare un’azione bonus per fare stritolare il bersaglio dalla mano. Quando lo fai, il bersaglio subisce danni da botta pari a  2d6 + il tuo valore di Intelletto o Volontà
\item
...
\medskip\textbf{Mano Magica}\index{Mano Magica}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Marchio del Cacciatore}\index{Marchio del Cacciatore}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: 27 metri\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Messaggio}\index{Messaggio}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
\textbf{Componenti}: V, S, M (un piccolo pezzo di cavo di rame)\\
...
\medskip\textbf{Metamorfosi}\index{Metamorfosi}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
...
\medskip\textbf{Metamorfosi Pura}\index{Metamorfosi Pura}\\
\textbf{Difficolta'}: 33\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
...
\medskip\textbf{Miraggio Arcano}\index{Miraggio Arcano}\\
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 10 minuti\\
\textbf{Gittata}: Vista\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Modificare Memoria}\index{Modificare Memoria}
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
\textbf{Componenti}: V, S\\
\textbf{Durata}: Concentrazione, massimo 1 minuto\\
Tenti di rimodellare i ricordi di un’altra creatura. Una creatura che puoi vedere deve effettuare un tiro salvezza su Arbitrio. Se la stai combattendo, la creatura ha vantaggio sul tiro salvezza. Se fallisce il tiro salvezza, il bersaglio diventa affascinato da te per la durata dell’incantesimo. Il bersaglio affascinato è inabile e inconsapevole dell’ambiente circostante, sebbene sia ancora ingrado di udirti. Se subisce danni o diviene  bersaglio di un altro incantesimo, questo incantesimo  termina, e nessuno dei ricordi del bersaglio viene modificato.\\
...
\medskip\textbf{Movimenti del Ragno}\index{Movimenti del Ragno}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Muovere il Terreno}\index{Muovere il Terreno}
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
...
\medskip\textbf{Muro di Forza}\index{Muro di Forza}\\
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
...
\medskip\textbf{Muro di Fuoco}\index{Muro di Fuoco}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
...
\medskip\textbf{Muro di Ghiaccio}\index{Muro di Ghiaccio}\\
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
...
Se, quando compare, il muro attraversa lo spazio di una creatura, la creatura viene spinta da una parte del muro (a tua scelta) e deve effettuare un tiro salvezza su Agilita'. Se fallisce il tiro salvezza, la creatura subisce 10d6 danni da freddo, o la metà di questi danni se lo supera.\\
...
\medskip\textbf{Muro di Pietra}\index{Muro di Pietra}\\
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
...
\medskip\textbf{Muro Prismatico}\index{Muro Prismatico}\\
\textbf{Difficolta'}: 33\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Muro di Spine}\index{Muro di Spine}\\
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
...
Quando il muro compare, ogni creatura nella sua area deve effettuare un tiro salvezza su Agilità. Se fallisce il tiro salvezza, una creatura subisce 7d8 danni perforanti, o la metà di questi danni se lo supera. Una creatura può muoversi attraverso il muro, seppure in maniera lenta e dolorosa. Per ogni 1 metro che la creatura si muove attraverso il muro, deve spendere 6 metri di movimento. Inoltre, la prima volta che una creatura entra nel muro durante un turno o vi termina il suo round dentro, la creatura deve effettuare un tiro salvezza su Agilita'. Subisce 7d8 danni taglienti se fallisce il tiro salvezza, o la metà di questi danni se lo supera.\\
\textbf{Per ogni critico ottenuto} nella prova di magia il danno aumenta di 1d8.

\medskip\textbf{Muro di Vento}\index{Muro di Vento}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
...
\medskip\textbf{Nube Incendiaria}\index{Nube Incendiaria}\\
\textbf{Difficolta'}: 30\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 45 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Nube Maleodorante}\index{Nube Maleodorante}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 27 metri\\
...
\medskip\textbf{Nube Mortale}\index{Nube Mortale}\\
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Nube di Nebbia}\index{Nube di Nebbia}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Occhio Arcano}\index{Occhio Arcano}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
...
\medskip\textbf{Onda Tonante}\index{Onda Tonante}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
...
\medskip\textbf{Oscurità}\index{Oscurità}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
...
\medskip\textbf{Palla di Fuoco}\index{Palla di Fuoco}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 45 metri\\
...
Ogni creatura in una sfera di 6 metri di raggio centrata in quel punto deve effettuare un tiro salvezza su Agilita'. Una creatura subisce 8d6 danni da fuoco se fallisce il tiro salvezza, o la metà di questi danni se lo supera.\\
...
\medskip\textbf{Parlare con gli Animali}\index{Parlare con gli Animali}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Parlare con i Morti}\index{Parlare con i Morti}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 3 metri\\
...
\medskip\textbf{Parlare con le Piante}\index{Parlare con le Piante}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
...
\medskip\textbf{Parola Divina}\index{Parola Divina}\\
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: 9 metri\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Parola Guaritrice}\index{Parola Guaritrice}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Parola Guaritrice di Massa}\index{Parola Guaritrice di Massa}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Parola del Potere Stordire}\index{Parola del Potere Stordire}\\
\textbf{Difficolta'}: 30\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Parola del Potere Uccidere}\index{Parola del Potere Uccidere}\\
\textbf{Difficolta'}: 33\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Parola del Ritiro}\index{Parola del Ritiro}\\
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 2 Azioni\\
...
\medskip\textbf{Passapareti}\index{Passapareti}
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
...
\medskip\textbf{Passare Senza Tracce}\index{Passare Senza Tracce}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
...
\medskip\textbf{Passo Velato}\index{Passo Velato}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: Personale\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Passo Veloce}\index{Passo Veloce}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Paura}\index{Paura}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
...
\medskip\textbf{Pelle di Corteccia}\index{Pelle di Corteccia}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Pelle di Pietra}\index{Pelle di Pietra}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Piaga degli Insetti}\index{Piaga degli Insetti}
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 90 metri\\
...
\medskip\textbf{Porta Dimensionale}\index{Porta Dimensionale}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
...
\medskip\textbf{Portale}\index{Portale}\\
\textbf{Difficolta'}: 33\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
...
\medskip\textbf{Preghiera di Guarigione}\index{Preghiera di Guarigione}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 10 minuti\\
\textbf{Gittata}: 9 metri\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Presagio}\index{Presagio}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 1 minuto\\
\textbf{Gittata}: Personale\\
...
\medskip\textbf{Prestidigitazione}\index{Prestidigitazione}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 3 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Previsione}\index{Previsione}\\
\textbf{Difficolta'}: 33\\
\textbf{Tempo di Lancio}: 1 minuto\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Produrre Fiamma}\index{Produrre Fiamma}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Proibizione}\index{Proibizione}\\
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 10 minuti\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Proiezione Astrale}\index{Proiezione Astrale}
\textbf{Difficolta'}: 33\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 3 metri\\
...
\medskip\textbf{Protezione dal Bene e dal Male}\index{Protezione dal Bene e dal Male}
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Protezione dall’Energia}\index{Protezione dall’Energia}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Protezione dai Veleni}\index{Protezione dai Veleni}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Punizione Marchiante}\index{Punizione Marchiante}
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: Personale\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Purificare Cibo e Bevande}\index{Purificare Cibo e Bevande}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 3 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Raggio di Gelo}\index{Raggio di Gelo}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Raggio di Affaticamento}\index{Raggio di Affaticamento}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Raggio Rovente}\index{Raggio Rovente}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Ragnatela}\index{Ragnatela}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
...
\medskip\textbf{Randello Incantato}\index{Randello Incantato}
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Reggia Meravigliosa}\index{Reggia Meravigliosa}\\
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 1 minuto\\
\textbf{Gittata}: 90 metri\\
...
\medskip\textbf{Resistenza}\index{Resistenza}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Respirare Sott’Acqua}\index{Respirare Sott’Acqua}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
...
\medskip\textbf{Resurrezione}\index{Resurrezione}\\
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 1 ora\\
\textbf{Gittata}: Contatto\\
...
Lanciare questo incantesimo per riportare in vita una creatura che è morta da un anno o più ti sfianca. Fino al termine di un riposo lungo, non potrai più lanciare incantesimi e avrai svantaggio su tutti i tiri per colpire, prove di caratteristica e tiri salvezza.\\
\textbf{Con il sistema dei Patroni questo incantesimo non e' disponibile}

\medskip\textbf{Resurrezione Pura}\index{Resurrezione Pura}\\
\textbf{Difficolta'}: 33\\
\textbf{Tempo di Lancio}: 1 ora\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Rianimare Morti}\index{Rianimare Morti}\\
\textbf{Difficolta'}: 23\\
...
\medskip\textbf{Rigenerazione}\index{Rigenerazione}\\
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 1 minuto\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Rimuovi Maledizione}\index{Rimuovi Maledizione}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Rinascita}\index{Rinascita}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Riparare}\index{Riparare}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 1 minuto\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Riposo Inviolato}\index{Riposo Inviolato}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Risata Incontenibile}\index{Risata Incontenibile}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
...
\medskip\textbf{Riscaldare il Metallo}\index{entry}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
...
\medskip\textbf{Ristorare Inferiore}\index{Ristorare Inferiore}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Ristorare Superiore}\index{Ristorare Superiore}\\
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Risveglio}\index{Risveglio}\\
\textbf{Difficolta'}: 23\\
...
\medskip\textbf{Ritirata Rapida}\index{Ritirata Rapida}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: Personale\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Saltare}\index{Saltare}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Salvare i Morenti}\index{Salvare i Morenti}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Santificare}\index{Santificare}\\
\textbf{Difficolta'}: 23\\
...
\medskip\textbf{Santuario}\index{Santuario}
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: 9 metri\\
...
\medskip\textbf{Santuario Privato}\index{Santuario Privato}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 10 minuti\\
\textbf{Gittata}: 36 metri\\
...
\medskip\textbf{Scagliare Maledizione}\index{Scagliare Maledizione}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
\textbf{Componenti}: V, S\\
...
svantaggio sui tiri per colpire
\item
...
\medskip\textbf{Scassinare}\index{Scassinare}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Scopri il Percorso}\index{Scopri il Percorso}\\
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 1 minuto\\
\textbf{Gittata}: Personale\\
...
\medskip\textbf{Scopri Trappole}\index{Scopri Trappole}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Scrigno Segreto}\index{Scrigno Segreto}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Scritto Illusorio}\index{Scritto Illusorio}
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 1 minuto\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Scrutare}\index{Scrutare}\\
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 10 minuti\\
\textbf{Gittata}: Personale\\
...
\medskip\textbf{Scudo}\index{Scudo}
\textbf{Difficolta'}: 13\\
...
\medskip\textbf{Scudo della Fede}\index{Scudo della Fede}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 1 Azione Immediata\\
\textbf{Gittata}: 18 metri\\
...
\medskip\textbf{Scudo di Fuoco}\index{Scudo di Fuoco}
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
...
\medskip\textbf{Scurovisione}\index{Scurovisione}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Segugio Fedele}\index{Segugio Fedele}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
...
\medskip\textbf{Sembrare}\index{Sembrare}\\
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Semipiano}\index{Semipiano}\\
\textbf{Difficolta'}: 30\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: S\\
...
\medskip\textbf{Serratura Arcana}\index{Serratura Arcana}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Servitore Inosservato}\index{Servitore Inosservato}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
...
\medskip\textbf{Sfera Congelante}\index{Sfera Congelante}\\
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 90 metri\\
...
\medskip\textbf{Sfera Elastica}\index{Sfera Elastica}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 90 metri\\
...
Quando muovi la sfera, la puoi spostare oltre barriere alte fino a 1 metro, e farle saltare spazi larghi fino a 3 metri. La sfera incendia gli oggetti infiammabili non indossati o trasportati, e irradia una luce intensa in un  raggio di 6 metri e una luce fioca per ulteriori 6 metri.Ai  \\
\textbf{Per ogni critico ottenuto} nella prova di magia il danno aumenta di 1d6.

\medskip\textbf{Sfocatura}\index{Sfocatura}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Sguardo Penetrante}\index{Sguardo Penetrante}\\
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Silenzio}\index{Silenzio}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Simbolo}\index{Simbolo}
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\item
\textit{Discordia}. Ogni bersaglio deve effettuare un tiro salvezza su Tempra. Se lo fallisce, il bersaglio inizia a bisticciare e discutere con un’altra creatura per 1 minuto. In questo periodo, è incapace di effettuare qualsiasi comunicazione significativa e ha svantaggio ai tiri per colpire e le prove di caratteristica. Dolore. Ogni bersaglio deve effettuare un tiro salvezza su Tempra. Se lo fallisce, il bersaglio diventa inabile a causa del dolore lacerante.
\item
...
\item\
\textit{Sfiducia}. Ogni bersaglio deve effettuare un tiro salvezza su Carisma. Se fallisce il tiro salvezza, il bersaglio è sopraffatto dalla disperazione per 1 minuto. Durante questo periodo, non può attaccare o prendere come bersaglio nessuna creatura con capacità, incantesimi o altri effetti magici nocivi.
\item\
...
\medskip\textbf{Simulacro}\index{Simulacro}\\
\textbf{Difficolta'}: 28\\
...
\medskip\textbf{Sogno}\index{Sogno}\\
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
...
Se possiedi una ciocca di capelli, delle unghie tagliate, o simile porzione del corpo del bersaglio, egli effettuerà il suo tiro salvezza con svantaggio.

\medskip\textbf{Sonno}\index{Sonno}
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 27 metri\\
...
\medskip\textbf{Spada Arcana}\index{Spada Arcana}\\
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
...
\medskip\textbf{Spostamento Planare}\index{Spostamento Planare}\\
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Spruzzo Colorato}\index{Spruzzo Colorato}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale (cono di 4,5 metri)\\
...
\medskip\textbf{Spruzzo Prismatico}\index{Spruzzo Prismatico}\\
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale (cono di 18 metri)\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Spruzzo Velenoso}\index{Spruzzo Velenoso}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 3 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Stretta Folgorante}\index{Stretta Folgorante}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Suggestione}\index{Suggestione}\\
\textbf{Difficolta'}: 15\\
...
\medskip\textbf{Suggestione di Massa}\index{Suggestione di Massa}
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V, M (la lingua di un serpente e un pezzo di favo o un goccio di olio dolce)\\
...
\medskip\textbf{Taumaturgia}\index{Taumaturgia}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Telecinesi}\index{Telecinesi}\\
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Teletrasporto}\index{Teletrasporto}\\
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 3 metri\\
\textbf{Componenti}: V\\
...
\medskip\textbf{Tempesta di Fuoco}\index{Tempesta di Fuoco}\\
\textbf{Difficolta'}: 28\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 45 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Tempesta di Ghiaccio}\index{Tempesta di Ghiaccio}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 90 metri\\
...
\medskip\textbf{Tentacoli Neri}\index{Tentacoli Neri}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 27 metri\\
...
\medskip\textbf{Terremoto}\index{Terremoto}\\
\textbf{Difficolta'}: 30\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 150 metri\\
...
\medskip\textbf{Terreno Illusorio}\index{Terreno Illusorio}\\
\textbf{Difficolta'}: 20\\
\textbf{Tempo di Lancio}: 10 minuti\\
\textbf{Gittata}: 90 metri\\
...
\medskip\textbf{Tocco Gelido}\index{Tocco Gelido}\\
\textbf{Difficolta'}: 11\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
\textbf{Componenti}: V, S\\
\textbf{Durata}: 1 round\\
Crei una scheletrica mano spettrale nello spazio di una creatura a gittata. Effettua un attacco a distanza con incantesimo contro la creatura, per aggredirla con ilgelo della morte. Se colpisci, il  bersaglio subisce 1d8 danni da Vuoto, e non può recuperare punti ferita fino all’inizio del tuo prossimo turno. Fino ad allora, la mano resterà serrata sul bersaglio. Se colpisci un bersaglio non morto, esso avrà anche svantaggio ai tiri per colpire contro di te fino alla fine del suo prossimo turno.\\
Il danno dell’incantesimo aumenta di 1d8 quando raggiungi CM 5, CM 11 e CM 17.

\medskip\textbf{Tocco Vampirico}\index{Tocco Vampirico}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Trama Ipnotica}\index{Trama Ipnotica}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 36 metri\\
...
\medskip\textbf{Trasformazione}\index{Trasformazione}
\textbf{Difficolta'}: 33\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
...
\medskip\textbf{Traslazione Arborea}\index{Traslazione Arborea}\\
\textbf{Difficolta'}: 23\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Trasporto Vegetale}\index{Trasporto Vegetale}\\
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 3 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Trova Cavalcatura}\index{Trova Cavalcatura}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 10 minuti\\
\textbf{Gittata}: 9 metri\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Trova Famiglio}\index{Trova Famiglio}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 1 ora\\
\textbf{Gittata}: 3 metri\\
...
\medskip\textbf{Trucco della Corda}\index{Trucco della Corda}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 1 minuto\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Unto}\index{Unto}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V, S, M (un pezzo di cotenna di maiale o burro)\\
\textbf{Durata}: 1 minuto\\
...
Quando compare il grasso, ciascun bersaglio che si trova in piedi nell’area deve superare un tiro salvezza su Agilita' o cadere prono. Una creatura che entra nell’area o termina il suo round lì, deve superare un tiro salvezza su Agilita' o cadere prona.\\

\medskip\textbf{Vedere Invisibilità}\index{Vedere Invisibilità}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
...
\medskip\textbf{Velocità}\index{Velocità}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 9 metri\\
...
\medskip\textbf{Vigilanza e Interdizione}\index{Vigilanza e Interdizione}\\
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 10 minuti\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Vincolo di Interdizione}\index{Vincolo di Interdizione}\\
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Visione del Vero}\index{entry}\\
\textbf{Difficolta'}: 25\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Vita Falsata}\index{Vita Falsata}\\
\textbf{Difficolta'}: 13\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Personale\\
...
\medskip\textbf{Volare}\index{Volare}\\
\textbf{Difficolta'}: 18\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
...
\medskip\textbf{Vuoto Mentale}\index{Vuoto Mentale}\\
\textbf{Difficolta'}: 30\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: Contatto\\
\textbf{Componenti}: V, S\\
...
\medskip\textbf{Zona di Verità}\index{Zona di Verità}
\textbf{Difficolta'}: 15\\
\textbf{Tempo di Lancio}: 2 Azioni\\
\textbf{Gittata}: 18 metri\\
\textbf{Componenti}: V, S\\
