...
\textbf{Durata}: Istantanea\\
Una sfera di energia negativa del raggio di 18 metri, erutta in un punto a gittata. Ogni creatura in quell’area deve effettuare un tiro salvezza su Tempra. Un  ersaglio subisce 8d6 danni necrotici se fallisce il tiro salvezza, o la metà di questi danni se lo supera. \\
...
all’inizio di ciascun suo round (10 punti ferita al minuto).
...
ignorano l’effetto.
Al termine di ciascun suo round, e ogni volta che
...
tiro salvezza su Tempra o gettare l’oggetto se ne è
...
seguenti effetti.
Per prima cosa, celestiali, elementali, fatati, demoni e
...
seguono una specifica Patrono o capo, o le creature di
un tipo specifico, come orchi o troll. Quando una
creatura soggetta all’incantesimo entra in quest’area
per la prima volta durante un turno o inizia il suo round
...
eccezione dei danni da botta, perforanti o taglienti),
